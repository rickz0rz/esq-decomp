...
BASE="newgrid2_jmptbl_bevel_drawhorizontalbevel"
ENTRY_ORIG="NEWGRID2_JMPTBL_BEVEL_DrawHorizontalBevel"
ENTRY_SASC="NEWGRID2_JMPTBL_BEVEL_DrawHorizo"
TARGET="BEVEL_DrawHorizontalBevel"
mkdir -p "$OUT_DIR"
