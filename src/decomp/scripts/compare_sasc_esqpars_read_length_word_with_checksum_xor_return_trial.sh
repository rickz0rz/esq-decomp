...
SASC_SRC="esqpars_return_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqpars.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqpars_read_length_word_with_checksum_xor_return"
ENTRY="ESQPARS_ReadLengthWordWithChecksumXor_Return"
ENTRY_SASC_REGEX="^ESQPARS_ReadLengthWordWithChecks[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQPARS_READLENGTHWORDWITHCHECKSUMXOR_RETURN:"
ENTRY_ALT_SEM="ESQPARS_READLENGTHWORDWITHCHECKS:"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_esqpars_return_stub.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_esqpars_return_stub.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
