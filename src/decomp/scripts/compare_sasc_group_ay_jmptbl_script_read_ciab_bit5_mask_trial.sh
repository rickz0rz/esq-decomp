...
BASE="group_ay_jmptbl_script_read_ciab_bit5_mask"
ENTRY_ORIG="GROUP_AY_JMPTBL_SCRIPT_ReadCiaBBit5Mask"
ENTRY_SASC="GROUP_AY_JMPTBL_SCRIPT_ReadCiaBB"
TARGET="SCRIPT_ReadHandshakeBit5Mask"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AY_JMPTBL_DISKIO_OpenFileW:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
