    ...
    XDEF    Global_STR_CHIP_PLACEHOLDER
    XDEF    Global_STR_FAST_PLACEHOLDER
    XDEF    Global_STR_MAX_PLACEHOLDER
    XDEF    Global_STR_MEMORY_TYPES_DISABLED
    XDEF    Global_STR_DATA_OVERRUNS_FORMATTED
    XDEF    Global_STR_DATA_H_T_C_MAX_FORMATTED
    XDEF    Global_STR_CTRL_H_T_C_MAX_FORMATTED
    XDEF    Global_STR_JULIAN_DAY_NEXT_FORMATTED
    XDEF    Global_STR_JDAY1_JDAY2_FORMATTED
    XDEF    Global_STR_CURCLU_NXTCLU_FORMATTED
    XDEF    Global_STR_C_DATE_C_MONTH_LP_YR_FORMATTED
    XDEF    Global_STR_B_DATE_B_MONTH_LP_YR_FORMATTED
    XDEF    Global_STR_C_DST_B_DST_PSHIFT_FORMATTED
    XDEF    Global_STR_C_HOUR_B_HOUR_CS_FORMATTED
    XDEF    ESQFUNC_DiagRowCounter
    XDEF    ESQFUNC_VideoInsertionStateStrings
    XDEF    ESQFUNC_FMT_CARTSW_COLON_PCT_S_CARTREL_COLON_PCT
    XDEF    ESQFUNC_STR_CLOSED_ENABLED
    XDEF    ESQFUNC_STR_OPEN_DISABLED
    XDEF    ESQFUNC_TAG_CLOSED
    XDEF    ESQFUNC_TAG_OPEN
    XDEF    ESQFUNC_STR_CLOSED_ON_AIR
    XDEF    ESQFUNC_STR_OPEN_OFF_AIR
    XDEF    ESQFUNC_STR_ON_AIR
    XDEF    ESQFUNC_STR_OFF_AIR
    XDEF    ESQFUNC_STR_NO_DETECT
    XDEF    ESQFUNC_FMT_INSERTIME_PCT_S_WINIT_0X_PCT_04X
    XDEF    ESQFUNC_FMT_LOCAL_MODE_PCT_LD_LOCAL_UPDATE_PCT_L
    XDEF    ESQFUNC_FMT_CTIME_PCT_02D_SLASH_PCT_02D_SLASH_PC
    XDEF    ESQFUNC_STR_PM
    XDEF    ESQFUNC_STR_AM
    XDEF    ESQFUNC_FMT_L_CHIP_COLON_PCT_07LD_FAST_COLON_PCT
    XDEF    ESQFUNC_FMT_DATA_COLON_CMD_CNT_COLON_PCT_08LD_CR
    XDEF    ESQFUNC_FMT_CTRL_COLON_CMD_CNT_COLON_PCT_08LD_CR
