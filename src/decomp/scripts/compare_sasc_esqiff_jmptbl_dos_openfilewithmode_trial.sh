...
BASE="esqiff_jmptbl_dos_openfilewithmode"
ENTRY_ORIG="ESQIFF_JMPTBL_DOS_OpenFileWithMode"
ENTRY_SASC="ESQIFF_JMPTBL_DOS_OpenFileWithMo"
TARGET="DOS_OpenFileWithMode"
mkdir -p "$OUT_DIR"
