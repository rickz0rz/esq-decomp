    ...
    XDEF    _GCOMMAND_FMT_PCT_S_COLON
    XDEF    _GCOMMAND_STR_GRADIENT
    XDEF    _GCOMMAND_FMT_COLOR_PCT_D_PCT_D
    XDEF    _GCOMMAND_FMT_PCT_D_PCT_03X
    XDEF    _GCOMMAND_FMT_TABLE_DONE_WITH_LEADING_BLANK_LINE
    XDEF    _GCOMMAND_BannerFadeResetPendingFlag
    XDEF    _GCOMMAND_DriveProbeRequestedFlag
    XDEF    _Global_STR_INPUTDEVICE
    XDEF    _Global_STR_CONSOLEDEVICE
; ========== GCOMMAND.c ==========
...
_Global_STR_GCOMMAND_C_2:
    NStr    "GCOMMAND.c"
_GCOMMAND_FMT_PCT_T_MplexTemplateLoad:
    NStr    "%T"
_GCOMMAND_PATH_DF0_COLON_DIGITAL_MPLEX_DOT_DAT_TemplateSave:
    NStr    "DF0:Digital_Mplex.dat"
;------------------------------------------------------------------------------
; SYM: _GCOMMAND_MplexTemplateFieldSeparatorByteStorage/_GCOMMAND_PpvTemplateFieldSeparatorByteStorage   (template field separator byte storage)
...
; USED BY: _GCOMMAND_LoadMplexFile, _GCOMMAND_LoadPPVTemplate
; NOTES:
...
_GCOMMAND_STR_NO_FREE_STORE:
    NStr    "NO_FREE_STORE"
_GCOMMAND_STR_TASK_TABLE_FULL:
    NStr    "TASK_TABLE_FULL"
_GCOMMAND_STR_BAD_TEMPLATE:
    NStr    "BAD_TEMPLATE"
_GCOMMAND_STR_BAD_NUMBER:
    NStr    "BAD_NUMBER"
_GCOMMAND_STR_REQUIRED_ARG_MISSING:
    NStr    "REQUIRED_ARG_MISSING"
_GCOMMAND_STR_KEY_NEEDS_ARG:
    NStr    "KEY_NEEDS_ARG"
_GCOMMAND_STR_TOO_MANY_ARGS:
    NStr    "TOO_MANY_ARGS"
_GCOMMAND_STR_UNMATCHED_QUOTES:
    NStr    "UNMATCHED_QUOTES"
_GCOMMAND_STR_LINE_TOO_LONG:
    NStr    "LINE_TOO_LONG"
_GCOMMAND_STR_FILE_NOT_OBJECT:
    NStr    "FILE_NOT_OBJECT"
_GCOMMAND_STR_INVALID_RESIDENT_LIBRARY:
    NStr    "INVALID_RESIDENT_LIBRARY"
_GCOMMAND_STR_NO_DEFAULT_DIR:
    NStr    "NO_DEFAULT_DIR"
_GCOMMAND_STR_OBJECT_IN_USE:
    NStr    "OBJECT_IN_USE"
_GCOMMAND_STR_OBJECT_EXISTS:
    NStr    "OBJECT_EXISTS"
_GCOMMAND_STR_DIR_NOT_FOUND:
    NStr    "DIR_NOT_FOUND"
_GCOMMAND_STR_OBJECT_NOT_FOUND:
    NStr    "OBJECT_NOT_FOUND"
_GCOMMAND_STR_BAD_STREAM_NAME:
    NStr    "BAD_STREAM_NAME"
_GCOMMAND_STR_OBJECT_TOO_LARGE:
    NStr    "OBJECT_TOO_LARGE"
_GCOMMAND_STR_ACTION_NOT_KNOWN:
    NStr    "ACTION_NOT_KNOWN"
_GCOMMAND_STR_INVALID_COMPONENT_NAME:
    NStr    "INVALID_COMPONENT_NAME"
_GCOMMAND_STR_INVALID_LOCK:
    NStr    "INVALID_LOCK"
_GCOMMAND_STR_OBJECT_WRONG_TYPE:
    NStr    "OBJECT_WRONG_TYPE"
_GCOMMAND_STR_DISK_NOT_VALIDATED:
    NStr    "DISK_NOT_VALIDATED"
_GCOMMAND_STR_DISK_WRITE_PROTECTED:
    NStr    "DISK_WRITE_PROTECTED"
_GCOMMAND_STR_RENAME_ACROSS_DEVICES:
    NStr    "RENAME_ACROSS_DEVICES"
_GCOMMAND_STR_DIRECTORY_NOT_EMPTY:
    NStr    "DIRECTORY_NOT_EMPTY"
_GCOMMAND_STR_TOO_MANY_LEVELS:
    NStr    "TOO_MANY_LEVELS"
_GCOMMAND_STR_DEVICE_NOT_MOUNTED:
    NStr    "DEVICE_NOT_MOUNTED"
_GCOMMAND_STR_SEEK_ERROR:
    NStr    "SEEK_ERROR"
_GCOMMAND_STR_COMMENT_TOO_BIG:
    NStr    "COMMENT_TOO_BIG"
_GCOMMAND_STR_DISK_FULL:
    NStr    "DISK_FULL"
_GCOMMAND_STR_DELETE_PROTECTED:
    NStr    "DELETE_PROTECTED"
_GCOMMAND_STR_WRITE_PROTECTED:
    NStr    "WRITE_PROTECTED"
_GCOMMAND_STR_READ_PROTECTED:
    NStr    "READ_PROTECTED"
_GCOMMAND_STR_NOT_A_DOS_DISK:
    NStr    "NOT_A_DOS_DISK"
_GCOMMAND_STR_NO_DISK:
    NStr    "NO_DISK"
_GCOMMAND_STR_NO_MORE_ENTRIES:
    NStr    "NO_MORE_ENTRIES"
_GCOMMAND_STR_UNKNOWN:
    NStr    "UNKNOWN!"

    DC.L    _GCOMMAND_STR_NO_FREE_STORE
    DC.L    _GCOMMAND_STR_TASK_TABLE_FULL
    DC.L    _GCOMMAND_STR_BAD_TEMPLATE
    DC.L    _GCOMMAND_STR_BAD_NUMBER
    DC.L    _GCOMMAND_STR_REQUIRED_ARG_MISSING
    DC.L    _GCOMMAND_STR_KEY_NEEDS_ARG
    DC.L    _GCOMMAND_STR_TOO_MANY_ARGS
    DC.L    _GCOMMAND_STR_UNMATCHED_QUOTES
    DC.L    _GCOMMAND_STR_LINE_TOO_LONG
    DC.L    _GCOMMAND_STR_FILE_NOT_OBJECT
    DC.L    _GCOMMAND_STR_INVALID_RESIDENT_LIBRARY
    DC.L    _GCOMMAND_STR_NO_DEFAULT_DIR
    DC.L    _GCOMMAND_STR_OBJECT_IN_USE
    DC.L    _GCOMMAND_STR_OBJECT_EXISTS
    DC.L    _GCOMMAND_STR_DIR_NOT_FOUND
    DC.L    _GCOMMAND_STR_OBJECT_NOT_FOUND
    DC.L    _GCOMMAND_STR_BAD_STREAM_NAME
    DC.L    _GCOMMAND_STR_OBJECT_TOO_LARGE
    DC.L    _GCOMMAND_STR_ACTION_NOT_KNOWN
    DC.L    _GCOMMAND_STR_INVALID_COMPONENT_NAME
    DC.L    _GCOMMAND_STR_INVALID_LOCK
    DC.L    _GCOMMAND_STR_OBJECT_WRONG_TYPE
    DC.L    _GCOMMAND_STR_DISK_NOT_VALIDATED
    DC.L    _GCOMMAND_STR_DISK_WRITE_PROTECTED
    DC.L    _GCOMMAND_STR_RENAME_ACROSS_DEVICES
    DC.L    _GCOMMAND_STR_DIRECTORY_NOT_EMPTY
    DC.L    _GCOMMAND_STR_TOO_MANY_LEVELS
    DC.L    _GCOMMAND_STR_DEVICE_NOT_MOUNTED
    DC.L    _GCOMMAND_STR_SEEK_ERROR
    DC.L    _GCOMMAND_STR_COMMENT_TOO_BIG
    DC.L    _GCOMMAND_STR_DISK_FULL
    DC.L    _GCOMMAND_STR_DELETE_PROTECTED
    DC.L    _GCOMMAND_STR_WRITE_PROTECTED
    DC.L    _GCOMMAND_STR_READ_PROTECTED
    DC.L    _GCOMMAND_STR_NOT_A_DOS_DISK
    DC.L    _GCOMMAND_STR_NO_DISK
    DC.L    _GCOMMAND_STR_NO_MORE_ENTRIES
    DC.L    _GCOMMAND_STR_UNKNOWN

_GCOMMAND_PATH_GFX_COLON:
    NStr    "GFX:"
_GCOMMAND_STR_WORK_COLON:
    NStr    "WORK:"
_GCOMMAND_CMD_COPY_NIL_COLON_GFX_COLON_LOGO_DOT_LS:
...
_GCOMMAND_HighlightHoldoffTickCount:
    DS.W    1
_GCOMMAND_FMT_PCT_S_COLON:
    NStr2   "%s:",TextLineFeed
_GCOMMAND_STR_GRADIENT:
    NStr2   "[GRADIENT]",TextLineFeed
_GCOMMAND_FMT_COLOR_PCT_D_PCT_D:
    NStr3   TextLineFeed,"COLOR%d = %d",TextLineFeed
_GCOMMAND_FMT_PCT_D_PCT_03X:
    NStr2   "   %d = %03X",TextLineFeed
;------------------------------------------------------------------------------
; SYM: _GCOMMAND_FMT_TABLE_DONE_WITH_LEADING_BLANK_LINE   (gradient table dump footer)
; TYPE: cstr
; PURPOSE: Footer text emitted after gradient/preset table debug dump output.
; USED BY: _GCOMMAND_DisableHighlight debug formatter path
; NOTES:
;   Begins with byte value 10 (LF), so output starts with a blank line before
;   "TABLE = DONE".
;------------------------------------------------------------------------------
_GCOMMAND_FMT_TABLE_DONE_WITH_LEADING_BLANK_LINE:
    DC.B    10
...
_GCOMMAND_DriveProbeRequestedFlag:
    DC.W    $0001
_Global_STR_INPUTDEVICE:
    NStr    "inputdevice"
_Global_STR_CONSOLEDEVICE:
    NStr    "consoledevice"