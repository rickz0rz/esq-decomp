...
SRC_C="src/decomp/c/replacements/dos_read_by_index_gcc.c"
ORIG_ASM="src/modules/submodules/unknown34.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/dos_read_by_index.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/dos_read_by_index.original_slice.s"
GEN_SLICE="${OUT_DIR}/dos_read_by_index.generated_slice.s"
ORIG_NORM="${OUT_DIR}/dos_read_by_index.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/dos_read_by_index.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_dos_read_idx.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_dos_read_idx.awk "$GEN_NORM" > "$GEN_SEM"
