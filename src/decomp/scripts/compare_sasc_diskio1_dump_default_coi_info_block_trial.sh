...
SASC_SRC="diskio1_dump_default_coi_info_block.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/g/diskio1.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio1_dump_default_coi_info_block"
ENTRY="DISKIO1_DumpDefaultCoiInfoBlock"
ENTRY_SASC_REGEX="^DISKIO1_DumpDefaultCoiInfoB[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_DUMPDEFAULTCOIINFOBLOCK:"
ENTRY_ALT_SEM="DISKIO1_DUMPDEFAULTCOIINFOB"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio1_dump_default_coi_info_block.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio1_dump_default_coi_info_block.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
