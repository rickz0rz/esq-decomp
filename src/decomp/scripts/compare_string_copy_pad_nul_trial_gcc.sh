...
SRC_C="src/decomp/c/replacements/string_copy_pad_nul_gcc.c"
ORIG_ASM="src/modules/submodules/unknown5.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/string_copy_pad_nul.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/string_copy_pad_nul.original_slice.s"
GEN_SLICE="${OUT_DIR}/string_copy_pad_nul.generated_slice.s"
ORIG_NORM="${OUT_DIR}/string_copy_pad_nul.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/string_copy_pad_nul.generated_slice.norm.s"
...
awk '
$0 ~ /^_?STRING_CopyPadNul:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_str_copy_pad.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_str_copy_pad.awk "$GEN_NORM" > "$GEN_SEM"
