...
SASC_SRC="diskio_ensure_pc1_mounted_and_gfx_assigned.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/g/diskio.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio_ensure_pc1_mounted_and_gfx_assigned"
ENTRY="DISKIO_EnsurePc1MountedAndGfxAssigned"
ENTRY_SASC_REGEX="^DISKIO_EnsurePc1MountedAndGfxAss[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_ensure_pc1_mounted_and_gfx_assigned.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_ensure_pc1_mounted_and_gfx_assigned.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
