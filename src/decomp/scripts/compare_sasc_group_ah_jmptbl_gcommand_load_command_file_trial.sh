...
BASE="group_ah_jmptbl_gcommand_load_command_file"
ENTRY_ORIG="GROUP_AH_JMPTBL_GCOMMAND_LoadCommandFile"
ENTRY_SASC="GROUP_AH_JMPTBL_GCOMMAND_LoadCom"
TARGET="GCOMMAND_LoadCommandFile"
mkdir -p "$OUT_DIR"
