...
BASE="esqshared_parse_compact_entry_record"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared_parse_compact_entry_record.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared_parse_compact_entry_record.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
