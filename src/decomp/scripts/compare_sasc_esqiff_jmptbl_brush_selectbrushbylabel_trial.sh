...
BASE="esqiff_jmptbl_brush_selectbrushbylabel"
ENTRY_ORIG="ESQIFF_JMPTBL_BRUSH_SelectBrushByLabel"
ENTRY_SASC="ESQIFF_JMPTBL_BRUSH_SelectBrushB"
TARGET="BRUSH_SelectBrushByLabel"
mkdir -p "$OUT_DIR"
