...
SASC_SRC="ladfunc_parse_banner_entry_data.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_parse_banner_entry_data_state_flow"
ENTRY="LADFUNC_ParseBannerEntryData"
ENTRY_SASC_REGEX="^LADFUNC_ParseBannerEntryData[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_parse_banner_entry_data_state_flow.awk \
