...
BASE="esqiff_play_next_external_asset_frame_state_flow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_play_next_external_asset_frame_state_flow.awk \
