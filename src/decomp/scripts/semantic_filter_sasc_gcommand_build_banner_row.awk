...

{
    ...
    if (u ~ /^MOVE\.W D[0-7],730\(A[0-7]\)$/ || u ~ /^MOVE\.W D[0-7],734\(A[0-7]\)$/ || u ~ /^MOVE\.W D[0-7],\$2DA\(A[0-7]\)$/ || u ~ /^MOVE\.W D[0-7],\$2DE\(A[0-7]\)$/ || u ~ /^LEA \$2DA\(A[0-7]\),A[0-7]$/ || u ~ /^LEA \$2DE\(A[0-7]\),A[0-7]$/) has_row_ptr_words = 1
