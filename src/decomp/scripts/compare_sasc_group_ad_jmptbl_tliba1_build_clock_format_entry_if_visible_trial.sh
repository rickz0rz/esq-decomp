...
BASE="group_ad_jmptbl_tliba1_build_clock_format_entry_if_visible"
ENTRY_ORIG="GROUP_AD_JMPTBL_TLIBA1_BuildClockFormatEntryIfVisible"
ENTRY_SASC="GROUP_AD_JMPTBL_TLIBA1_BuildCloc"
TARGET="TLIBA1_BuildClockFormatEntryIfVisible"
mkdir -p "$OUT_DIR"
