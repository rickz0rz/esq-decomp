...
BASE="cleanup_build_and_render_aligned_status_banner_state_flow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_build_and_render_aligned_status_banner_state_flow.awk \
