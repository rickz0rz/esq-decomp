...
BASE="group_ay_jmptbl_diskio_close_buffered_file_and_flush"
ENTRY_ORIG="GROUP_AY_JMPTBL_DISKIO_CloseBufferedFileAndFlush"
ENTRY_SASC="GROUP_AY_JMPTBL_DISKIO_CloseBuff"
TARGET="DISKIO_CloseBufferedFileAndFlush"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AY_JMPTBL_STRING_CompareNo:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
