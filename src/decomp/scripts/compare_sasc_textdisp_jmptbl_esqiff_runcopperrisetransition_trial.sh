...
BASE="textdisp_jmptbl_esqiff_runcopperrisetransition"
ENTRY_ORIG="TEXTDISP_JMPTBL_ESQIFF_RunCopperRiseTransition"
ENTRY_SASC="TEXTDISP_JMPTBL_ESQIFF_RunCopper"
