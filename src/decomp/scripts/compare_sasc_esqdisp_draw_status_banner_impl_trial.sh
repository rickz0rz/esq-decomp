...
SASC_SRC="esqdisp_draw_status_banner_impl.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqdisp_draw_status_banner_impl"
ENTRY="ESQDISP_DrawStatusBanner_Impl"
ENTRY_SASC_REGEX="^ESQDISP_DrawStatusBanner_Im[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_draw_status_banner_impl.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_draw_status_banner_impl.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
