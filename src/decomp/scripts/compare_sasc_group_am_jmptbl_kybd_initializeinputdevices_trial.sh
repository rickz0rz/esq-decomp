...
BASE="group_am_jmptbl_kybd_initializeinputdevices"
ENTRY_ORIG="GROUP_AM_JMPTBL_KYBD_InitializeInputDevices"
ENTRY_SASC="GROUP_AM_JMPTBL_KYBD_InitializeI"
TARGET="KYBD_InitializeInputDevices"
mkdir -p "$OUT_DIR"
