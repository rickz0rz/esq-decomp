...
BASE="esqfunc_jmptbl_parseini_computehtcmaxvalues"
ENTRY_ORIG="ESQFUNC_JMPTBL_PARSEINI_ComputeHTCMaxValues"
ENTRY_SASC="ESQFUNC_JMPTBL_PARSEINI_ComputeH"
TARGET="PARSEINI_ComputeHTCMaxValues"
mkdir -p "$OUT_DIR"
