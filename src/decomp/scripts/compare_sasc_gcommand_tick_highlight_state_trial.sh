...
SASC_SRC="gcommand_tick_highlight_state.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_tick_highlight_state"
ENTRY="GCOMMAND_TickHighlightState"
ENTRY_SASC_REGEX="^GCOMMAND_TickHighlightState[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_tick_highlight_state.awk \
