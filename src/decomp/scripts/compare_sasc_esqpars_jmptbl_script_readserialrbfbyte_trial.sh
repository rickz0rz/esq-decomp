...
BASE="esqpars_jmptbl_script_readserialrbfbyte"
ENTRY_ORIG="ESQPARS_JMPTBL_SCRIPT_ReadSerialRbfByte"
ENTRY_SASC="ESQPARS_JMPTBL_SCRIPT_ReadSerial"
TARGET="SCRIPT_ReadNextRbfByte"
mkdir -p "$OUT_DIR"
