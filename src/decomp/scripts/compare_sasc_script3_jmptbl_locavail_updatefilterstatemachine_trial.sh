...
BASE="script3_jmptbl_locavail_updatefilterstatemachine"
ENTRY_ORIG="SCRIPT3_JMPTBL_LOCAVAIL_UpdateFilterStateMachine"
ENTRY_SASC="SCRIPT3_JMPTBL_LOCAVAIL_UpdateFi"
TARGET="LOCAVAIL_UpdateFilterStateMachine"
mkdir -p "$OUT_DIR"
