...
BASE="group_am_jmptbl_diskio_loadconfigfromdisk"
ENTRY_ORIG="GROUP_AM_JMPTBL_DISKIO_LoadConfigFromDisk"
ENTRY_SASC="GROUP_AM_JMPTBL_DISKIO_LoadConfi"
TARGET="DISKIO_LoadConfigFromDisk"
mkdir -p "$OUT_DIR"
