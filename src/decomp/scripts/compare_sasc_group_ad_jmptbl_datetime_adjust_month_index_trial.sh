...
BASE="group_ad_jmptbl_datetime_adjust_month_index"
ENTRY_ORIG="GROUP_AD_JMPTBL_DATETIME_AdjustMonthIndex"
ENTRY_SASC="GROUP_AD_JMPTBL_DATETIME_AdjustM"
TARGET="DATETIME_AdjustMonthIndex"
mkdir -p "$OUT_DIR"
