...
BASE="esqiff2_pad_entries_to_max_title_width_return"
ENTRY="ESQIFF2_PadEntriesToMaxTitleWidth_Return"
ENTRY_SASC_REGEX="^ESQIFF2_PadEntriesToMaxTitleWidt[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_PADENTRIESTOMAXTITLEWIDTH_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_PADENTRIESTOMAXTITLEWIDT"
