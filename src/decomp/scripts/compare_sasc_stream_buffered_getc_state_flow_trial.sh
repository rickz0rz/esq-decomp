...
BASE="stream_buffered_getc_state_flow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_stream_buffered_getc_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_stream_buffered_getc_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
