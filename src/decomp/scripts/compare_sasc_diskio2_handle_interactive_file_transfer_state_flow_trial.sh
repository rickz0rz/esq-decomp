...
BASE="diskio2_handle_interactive_file_transfer_state_flow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio2_handle_interactive_file_transfer_state_flow.awk \
