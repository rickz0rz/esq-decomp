...
BASE="tliba1_jmptbl_coi_testentrywithintimewindow"
ENTRY_ORIG="TLIBA1_JMPTBL_COI_TestEntryWithinTimeWindow"
ENTRY_SASC="TLIBA1_JMPTBL_COI_TestEntryWithi"
TARGET="COI_TestEntryWithinTimeWindow"
mkdir -p "$OUT_DIR"
