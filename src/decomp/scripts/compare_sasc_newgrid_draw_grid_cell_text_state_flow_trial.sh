...
SASC_SRC="newgrid_draw_grid_cell_text.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/newgrid1.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="newgrid_draw_grid_cell_text_state_flow"
ENTRY="NEWGRID_DrawGridCellText"
ENTRY_SASC_REGEX="^NEWGRID_DrawGridCellText[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_draw_grid_cell_text_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_draw_grid_cell_text_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
