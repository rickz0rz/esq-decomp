...
SASC_SRC="newgrid_process_grid_entries.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/newgrid1.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="newgrid_process_grid_entries"
ENTRY_ORIG="NEWGRID_ProcessGridEntries"
ENTRY_SASC_REGEX="^NEWGRID_ProcessGridEntries[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_process_grid_entries.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_process_grid_entries.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
