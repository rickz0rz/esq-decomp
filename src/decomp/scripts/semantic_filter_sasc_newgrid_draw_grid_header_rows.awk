...

{
    ...
    if (n ~ /NEWGRID2JMPTBLBEVELDRAWBEVELFRAMEWITHTOP/ || n ~ /NEWGRID2JMPTBLBEVELDRAWBEVELFRAMEWITH/ || n ~ /NEWGRID2JMPTBLBEVELDRAWBEVELFRAMEWIT/ || n ~ /NEWGRID2JMPTBLBEVELDRAWBEVELF/) has_bevel_top=1
