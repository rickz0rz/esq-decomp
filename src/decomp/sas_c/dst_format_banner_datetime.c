...
extern UBYTE DST_TAG_AM[];
extern UBYTE DST_TAG_PM[];
extern UBYTE DST_TAG_STD[];
extern UBYTE DST_TAG_DST[];
extern UBYTE DST_STR_NORM_YEAR[];
extern UBYTE DST_STR_LEAP_YEAR[];
extern UBYTE DST_FMT_PCT_S_COLON_PCT_S_PCT_S_PCT_02D_PCT_[];
