...
SASC_SRC="ed1_update_esc_menu_selection.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/k/ed1.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed1_update_esc_menu_selection"
ENTRY_ORIG="ED1_UpdateEscMenuSelection"
ENTRY_SASC_REGEX="^ED1_UpdateEscMenuSelection[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_update_esc_menu_selection.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_update_esc_menu_selection.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
