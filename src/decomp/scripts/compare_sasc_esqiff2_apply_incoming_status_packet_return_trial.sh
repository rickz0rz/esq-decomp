...
BASE="esqiff2_apply_incoming_status_packet_return"
ENTRY="ESQIFF2_ApplyIncomingStatusPacket_Return"
ENTRY_SASC_REGEX="^ESQIFF2_ApplyIncomingStatusPacke[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_APPLYINCOMINGSTATUSPACKET_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_APPLYINCOMINGSTATUSPACKE"
