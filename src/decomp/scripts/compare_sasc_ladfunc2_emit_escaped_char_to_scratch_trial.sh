...
SASC_SRC="ladfunc2_emit_escaped_char_to_scratch.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/x/ladfunc2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc2_emit_escaped_char_to_scratch"
ENTRY="LADFUNC2_EmitEscapedCharToScratch"
ENTRY_SASC_REGEX="^LADFUNC2_EmitEscapedCharToSc[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc2_emit_escaped_char_to_scratch.awk \
