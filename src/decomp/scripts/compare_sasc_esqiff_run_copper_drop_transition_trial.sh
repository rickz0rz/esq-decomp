...
SASC_SRC="esqiff_run_copper_drop_transition.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_run_copper_drop_transition"
ENTRY="ESQIFF_RunCopperDropTransition"
...
awk -f src/decomp/scripts/semantic_filter_esqiff_run_copper_drop_transition.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_esqiff_run_copper_drop_transition.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
