...
BASE="group_ad_jmptbl_datetime_normalize_month_range"
ENTRY_ORIG="GROUP_AD_JMPTBL_DATETIME_NormalizeMonthRange"
ENTRY_SASC="GROUP_AD_JMPTBL_DATETIME_Normali"
TARGET="DATETIME_NormalizeMonthRange"
mkdir -p "$OUT_DIR"
