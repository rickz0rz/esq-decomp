...
SASC_SRC="gcommand_expand_preset_block.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_expand_preset_block"
ENTRY="GCOMMAND_ExpandPresetBlock"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_expand_preset_block.awk \
