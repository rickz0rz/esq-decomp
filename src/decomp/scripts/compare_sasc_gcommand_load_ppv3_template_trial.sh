...
SASC_SRC="gcommand_load_ppv3_template.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/s/gcommand.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_load_ppv3_template"
ENTRY="GCOMMAND_LoadPPV3Template"
ENTRY_SASC_REGEX="^GCOMMAND_LoadPPV3Template[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_load_ppv3_template.awk \
