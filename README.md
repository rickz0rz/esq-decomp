...
```
maximum-C build, CODE hunk   96.0%   [######################################..]
                                     224,692 of 234,008 bytes come from C
```

| measure | value |
|---|---|
| maximum-C manifest | 811 entries (`src/c/replacements-all.txt`) |
| assembly remaining | 9,316 of 234,008 CODE bytes (4.0%) |
