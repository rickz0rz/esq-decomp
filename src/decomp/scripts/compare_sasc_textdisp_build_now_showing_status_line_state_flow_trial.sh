...
SASC_SRC="textdisp_build_now_showing_status_line.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_build_now_showing_status_line_state_flow"
ENTRY="TEXTDISP_BuildNowShowingStatusLine"
ENTRY_SASC_REGEX="^TEXTDISP_BuildNowShowingStatusL[A-Za-z0-9_]*:$"
...
awk -v e="^${ENTRY}:$" -v e2="$ENTRY_SASC_REGEX" '
    $0 ~ e || $0 ~ e2 { in_func=1 }
    in_func {
        if (($0 ~ /^TEXTDISP_[A-Za-z0-9_]+:$/ || $0 ~ /^_?TEXTDISP_[A-Za-z0-9_]+:$/) && $0 !~ e && $0 !~ e2) exit
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_build_now_showing_status_line_state_flow.awk \
