...
cd "$ROOT_DIR"
SASC_SRC="esqiff_jmptbl_stubs_e.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_jmptbl_newgrid_validateselectioncode"
ENTRY_ORIG="ESQIFF_JMPTBL_NEWGRID_ValidateSelectionCode"
ENTRY_SASC="ESQIFF_JMPTBL_NEWGRID_ValidateSe"
TARGET="NEWGRID_ValidateSelectionCode"
mkdir -p "$OUT_DIR"
