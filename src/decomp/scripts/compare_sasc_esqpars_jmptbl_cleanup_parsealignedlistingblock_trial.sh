...
BASE="esqpars_jmptbl_cleanup_parsealignedlistingblock"
ENTRY_ORIG="ESQPARS_JMPTBL_CLEANUP_ParseAlignedListingBlock"
ENTRY_SASC="ESQPARS_JMPTBL_CLEANUP_ParseAlig"
TARGET="CLEANUP_ParseAlignedListingBlock"
mkdir -p "$OUT_DIR"
