...
cd "$ROOT_DIR"
SASC_SRC="group_ak_jmptbl_xjump2_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/k/xjump2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_ak_jmptbl_gcommand_copy_gfx_to_work_if_available"
ENTRY_ORIG="GROUP_AK_JMPTBL_GCOMMAND_CopyGfxToWorkIfAvailable"
ENTRY_SASC="GROUP_AK_JMPTBL_GCOMMAND_CopyGfx"
TARGET="GCOMMAND_CopyGfxToWorkIfAvailable"
mkdir -p "$OUT_DIR"
