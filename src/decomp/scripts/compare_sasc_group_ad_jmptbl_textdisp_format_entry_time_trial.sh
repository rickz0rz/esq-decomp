...
BASE="group_ad_jmptbl_textdisp_format_entry_time"
ENTRY_ORIG="GROUP_AD_JMPTBL_TEXTDISP_FormatEntryTime"
ENTRY_SASC="GROUP_AD_JMPTBL_TEXTDISP_FormatE"
TARGET="TEXTDISP_FormatEntryTime"
mkdir -p "$OUT_DIR"
