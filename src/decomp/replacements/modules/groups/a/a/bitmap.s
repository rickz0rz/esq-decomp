;------------------------------------------------------------------------------
; DECOMP TARGETS bitmap ILBM parser helper module boundary
; SOURCE: modules/groups/a/a/bitmap.s
; PURPOSE:
;   Object-level hybrid replacement for the BITMAP module now that the
;   restored SAS/C lane covers BITMAP_ProcessIlbmImage with a zero-byte
;   semantic diff in the current checkout. This replacement now carries the
;   module body directly instead of leaving the module unmapped.
;------------------------------------------------------------------------------
