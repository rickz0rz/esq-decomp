...
BASE="esqpars_jmptbl_datetime_savepairtofile"
ENTRY_ORIG="ESQPARS_JMPTBL_DATETIME_SavePairToFile"
ENTRY_SASC="ESQPARS_JMPTBL_DATETIME_SavePair"
TARGET="DATETIME_SavePairToFile"
mkdir -p "$OUT_DIR"
