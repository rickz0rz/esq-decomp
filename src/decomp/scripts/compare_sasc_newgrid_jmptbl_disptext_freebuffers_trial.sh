...
BASE="newgrid_jmptbl_disptext_freebuffers"
ENTRY_ORIG="NEWGRID_JMPTBL_DISPTEXT_FreeBuffers"
ENTRY_SASC="NEWGRID_JMPTBL_DISPTEXT_FreeBuff"
TARGET="DISPTEXT_FreeBuffers"
mkdir -p "$OUT_DIR"
