...
BASE="script3_jmptbl_parse_readsignedlongskipclass3_alt"
ENTRY_ORIG="SCRIPT3_JMPTBL_PARSE_ReadSignedLongSkipClass3_Alt"
ENTRY_SASC="SCRIPT3_JMPTBL_PARSE_ReadSignedL"
