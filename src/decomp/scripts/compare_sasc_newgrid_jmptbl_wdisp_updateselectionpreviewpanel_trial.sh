...
cd "$ROOT_DIR"
SASC_SRC="newgrid_jmptbl_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/newgrid.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="newgrid_jmptbl_wdisp_updateselectionpreviewpanel"
ENTRY_ORIG="NEWGRID_JMPTBL_WDISP_UpdateSelectionPreviewPanel"
ENTRY_SASC="NEWGRID_JMPTBL_WDISP_UpdateSelec"
TARGET="WDISP_UpdateSelectionPreviewPanel"
mkdir -p "$OUT_DIR"
