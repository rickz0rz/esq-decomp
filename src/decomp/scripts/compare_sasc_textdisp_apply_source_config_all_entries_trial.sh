...
SASC_SRC="textdisp_apply_source_config_all_entries.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_apply_source_config_all_entries"
ENTRY="TEXTDISP_ApplySourceConfigAllEntries"
ENTRY_SASC_REGEX="^TEXTDISP_ApplySourceConfigAllEnt[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_apply_source_config_all_entries.awk \
