...
BASE="esqiff2_read_serial_bytes_with_xor_return"
ENTRY="ESQIFF2_ReadSerialBytesWithXor_Return"
ENTRY_SASC_REGEX="^ESQIFF2_ReadSerialBytesWithXor_R[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_READSERIALBYTESWITHXOR_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_READSERIALBYTESWITHXOR_R"
