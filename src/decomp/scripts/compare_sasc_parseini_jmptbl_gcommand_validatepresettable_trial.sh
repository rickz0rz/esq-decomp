...
BASE="parseini_jmptbl_gcommand_validatepresettable"
ENTRY_ORIG="PARSEINI_JMPTBL_GCOMMAND_ValidatePresetTable"
ENTRY_SASC="PARSEINI_JMPTBL_GCOMMAND_Validat"
TARGET="GCOMMAND_ValidatePresetTable"
mkdir -p "$OUT_DIR"
