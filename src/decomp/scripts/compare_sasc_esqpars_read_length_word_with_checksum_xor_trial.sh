...
SASC_SRC="esqpars_read_length_word_with_checksum_xor.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqpars.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqpars_read_length_word_with_checksum_xor"
ENTRY="ESQPARS_ReadLengthWordWithChecksumXor"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqpars_read_length_word_with_checksum_xor.awk \
