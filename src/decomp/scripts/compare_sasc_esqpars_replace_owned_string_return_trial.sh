...
BASE="esqpars_replace_owned_string_return"
ENTRY="ESQPARS_ReplaceOwnedString_Return"
ENTRY_SASC_REGEX="^ESQPARS_ReplaceOwnedString_Retur[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQPARS_REPLACEOWNEDSTRING_RETURN:"
ENTRY_ALT_SEM="ESQPARS_REPLACEOWNEDSTRING_RETUR:"
