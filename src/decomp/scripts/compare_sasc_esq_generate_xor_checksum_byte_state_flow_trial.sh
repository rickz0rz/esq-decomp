...
SASC_SRC="esq_generate_xor_checksum_byte.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/a/app2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esq_generate_xor_checksum_byte_state_flow"
ENTRY="ESQ_GenerateXorChecksumByte"
ENTRY_SASC_REGEX="^ESQ_GenerateXorChecksumByte[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esq_generate_xor_checksum_byte_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esq_generate_xor_checksum_byte_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
