...

{
    ...
    if (n ~ /WDISPJMPTBLESQSETCOPPEREFFECTONENABLEHIGHLIGHT/ || n ~ /WDISPJMPTBLESQSETCOPPEREFF/) has_set_effect = 1
    if (n ~ /WDISPJMPTBLESQIFFRUNCOPPERDROPTRANSITION/ || n ~ /WDISPJMPTBLESQIFFRUNCOPPERDR/) has_drop = 1
    if (n ~ /WDISPJMPTBLESQIFFRESTOREBASEPALETTETRIPLES/ || n ~ /WDISPJMPTBLESQIFFRESTOREBASEPAL/ || n ~ /WDISPJMPTBLESQIFFRESTOREBASEP/) has_restore = 1
    ...
    if (n ~ /TEXTDISPJMPTBLESQIFFRUNCOPPERRISETRANSITION/ || n ~ /TEXTDISPJMPTBLESQIFFRUNCOPPERRI/ || n ~ /TEXTDISPJMPTBLESQIFFRUNCOPPER/) has_rise = 1
