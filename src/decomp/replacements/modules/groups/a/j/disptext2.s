;------------------------------------------------------------------------------
; DECOMP TARGETS disptext2 DATETIME conversion/format helper module boundary
; SOURCE: modules/groups/a/j/disptext2.s
; PURPOSE:
;   Direct object-level hybrid replacement for the DISPText2 DATETIME helper
;   module now that the restored SAS/C lane covers the full direct-export set
;   including DATETIME_ParseString and DATETIME_UpdateSelectionField. This
;   replacement now carries the module body directly instead of delegating
