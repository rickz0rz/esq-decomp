...
BASE="group_ak_jmptbl_tliba3_select_next_view_mode"
ENTRY_ORIG="GROUP_AK_JMPTBL_TLIBA3_SelectNextViewMode"
ENTRY_SASC="GROUP_AK_JMPTBL_TLIBA3_SelectNex"
TARGET="TLIBA3_SelectNextViewMode"
mkdir -p "$OUT_DIR"
