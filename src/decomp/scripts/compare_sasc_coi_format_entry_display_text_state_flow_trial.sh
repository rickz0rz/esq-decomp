...
BASE="coi_format_entry_display_text_state_flow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_coi_format_entry_display_text_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_coi_format_entry_display_text_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
