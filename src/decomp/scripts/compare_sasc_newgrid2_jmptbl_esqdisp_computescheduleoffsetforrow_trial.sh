...
BASE="newgrid2_jmptbl_esqdisp_computescheduleoffsetforrow"
ENTRY_ORIG="NEWGRID2_JMPTBL_ESQDISP_ComputeScheduleOffsetForRow"
ENTRY_SASC="NEWGRID2_JMPTBL_ESQDISP_ComputeS"
