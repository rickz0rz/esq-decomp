...
BASE="parseini_jmptbl_esqpars_replaceownedstring"
ENTRY_ORIG="PARSEINI_JMPTBL_ESQPARS_ReplaceOwnedString"
ENTRY_SASC="PARSEINI_JMPTBL_ESQPARS_ReplaceO"
TARGET="ESQPARS_ReplaceOwnedString"
mkdir -p "$OUT_DIR"
