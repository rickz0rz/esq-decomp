...
BASE="esqpars_jmptbl_textdisp_applysourceconfigallentries"
ENTRY_ORIG="ESQPARS_JMPTBL_TEXTDISP_ApplySourceConfigAllEntries"
ENTRY_SASC="ESQPARS_JMPTBL_TEXTDISP_ApplySou"
TARGET="TEXTDISP_ApplySourceConfigAllEntries"
mkdir -p "$OUT_DIR"
