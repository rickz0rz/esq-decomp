...
SASC_SRC="textdisp_set_entry_text_fields.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_set_entry_text_fields"
ENTRY="TEXTDISP_SetEntryTextFields"
ENTRY_SASC_REGEX="^TEXTDISP_SetEntryTextFields[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_set_entry_text_fields.awk \
