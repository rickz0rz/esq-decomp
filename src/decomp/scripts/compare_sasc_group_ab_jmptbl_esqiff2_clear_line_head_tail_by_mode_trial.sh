...
BASE="group_ab_jmptbl_esqiff2_clear_line_head_tail_by_mode"
ENTRY_ORIG="GROUP_AB_JMPTBL_ESQIFF2_ClearLineHeadTailByMode"
ENTRY_SASC="GROUP_AB_JMPTBL_ESQIFF2_ClearLin"
TARGET="ESQIFF2_ClearLineHeadTailByMode"
mkdir -p "$OUT_DIR"
