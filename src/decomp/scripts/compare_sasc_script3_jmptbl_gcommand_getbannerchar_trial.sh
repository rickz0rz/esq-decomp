...
BASE="script3_jmptbl_gcommand_getbannerchar"
ENTRY_ORIG="SCRIPT3_JMPTBL_GCOMMAND_GetBannerChar"
ENTRY_SASC="SCRIPT3_JMPTBL_GCOMMAND_GetBanne"
TARGET="GCOMMAND_GetBannerChar"
mkdir -p "$OUT_DIR"
