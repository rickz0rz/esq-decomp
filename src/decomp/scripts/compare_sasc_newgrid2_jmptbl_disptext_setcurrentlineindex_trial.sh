...
BASE="newgrid2_jmptbl_disptext_setcurrentlineindex"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_SetCurrentLineIndex"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_SetCurr"
TARGET="DISPTEXT_SetCurrentLineIndex"
mkdir -p "$OUT_DIR"
