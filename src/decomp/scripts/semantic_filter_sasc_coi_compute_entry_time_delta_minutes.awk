...
function trim(s,t){t=s; sub(/;.*/,"",t); sub(/^[ \t]+/,"",t); sub(/[ \t]+$/,"",t); return t}
{
    ...
    if (u ~ /GROUP_AE_JMPTBL_TLIBA_FINDFIRSTWILDCARDMATCHINDEX/ ||
        u ~ /GROUP_AE_JMPTBL_TLIBA_FINDFIRSTWILDCARD/ ||
        u ~ /GROUP_AE_JMPTBL_TLIBA_FINDFIRSTW/ ||
        u ~ /TLIBA_FINDFIRSTWILDCARDMATCHINDEX/ ||
        u ~ /GROUP_AE_JMPTBL_ESQDISP_GETENTRYAUXPOINTERBYMODE/ ||
        u ~ /GROUP_AE_JMPTBL_ESQDISP_GETENTRY/ ||
        u ~ /ESQDISP_GETENTRYAUXPOINTERBYMODE/) has_wildcard_path = 1
    if (u ~ /CLOCK_HALFHOURSLOTINDEX/ || u ~ /MULU #30/ || u ~ /MOVE.L #2880,D1/ || u ~ /#\$B40/) has_halfhour_fallback = 1
    if (u ~ /GROUP_AE_JMPTBL_TEXTDISP_COMPUTETIMEOFFSET/ ||
        u ~ /GROUP_AE_JMPTBL_TEXTDISP_COMPUTE/ ||
        u ~ /TEXTDISP_COMPUTETIMEOFFSET/) has_offset_call = 1
