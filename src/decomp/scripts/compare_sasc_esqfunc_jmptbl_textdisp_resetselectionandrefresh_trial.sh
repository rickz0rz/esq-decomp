...
BASE="esqfunc_jmptbl_textdisp_resetselectionandrefresh"
ENTRY_ORIG="ESQFUNC_JMPTBL_TEXTDISP_ResetSelectionAndRefresh"
ENTRY_SASC="ESQFUNC_JMPTBL_TEXTDISP_ResetSel"
