...
SRC_C="src/decomp/c/replacements/bevel_draw_horizontal_bevel_gcc.c"
ORIG_ASM="src/modules/groups/a/a/bevel.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/bevel_draw_horizontal_bevel.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/bevel_draw_horizontal_bevel.original_slice.s"
GEN_SLICE="${OUT_DIR}/bevel_draw_horizontal_bevel.generated_slice.s"
ORIG_NORM="${OUT_DIR}/bevel_draw_horizontal_bevel.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/bevel_draw_horizontal_bevel.generated_slice.norm.s"
ORIG_SEM="${OUT_DIR}/bevel_draw_horizontal_bevel.original_slice.semantic.txt"
GEN_SEM="${OUT_DIR}/bevel_draw_horizontal_bevel.generated_slice.semantic.txt"
...
awk -v start_label="BEVEL_DrawHorizontalBevel" -v next_label="BEVEL_DrawBeveledFrame" '
...
awk '$0 ~ /^_?BEVEL_DrawHorizontalBevel:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_bevel_draw_horizontal_bevel.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_bevel_draw_horizontal_bevel.awk" "$GEN_NORM" > "$GEN_SEM"
