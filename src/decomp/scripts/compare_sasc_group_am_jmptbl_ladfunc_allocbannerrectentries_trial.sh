...
BASE="group_am_jmptbl_ladfunc_allocbannerrectentries"
ENTRY_ORIG="GROUP_AM_JMPTBL_LADFUNC_AllocBannerRectEntries"
ENTRY_SASC="GROUP_AM_JMPTBL_LADFUNC_AllocBan"
TARGET="LADFUNC_AllocBannerRectEntries"
mkdir -p "$OUT_DIR"
