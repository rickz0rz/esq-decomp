...
BASE="esqiff2_read_serial_sized_text_record_return"
ENTRY="ESQIFF2_ReadSerialSizedTextRecord_Return"
ENTRY_SASC_REGEX="^ESQIFF2_ReadSerialSizedTextRecor[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_READSERIALSIZEDTEXTRECORD_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_READSERIALSIZEDTEXTRECOR"
