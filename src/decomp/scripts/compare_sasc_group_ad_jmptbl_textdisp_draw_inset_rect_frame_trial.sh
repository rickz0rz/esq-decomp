...
BASE="group_ad_jmptbl_textdisp_draw_inset_rect_frame"
ENTRY_ORIG="GROUP_AD_JMPTBL_TEXTDISP_DrawInsetRectFrame"
ENTRY_SASC="GROUP_AD_JMPTBL_TEXTDISP_DrawIns"
TARGET="TEXTDISP_DrawInsetRectFrame"
mkdir -p "$OUT_DIR"
