...
SASC_SRC="render_short_month_short_day_of_week_day.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/c/cleanup2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="render_short_month_short_day_of_week_day"
ENTRY="RENDER_SHORT_MONTH_SHORT_DAY_OF_WEEK_DAY"
ENTRY_SASC_REGEX="^RENDER_SHORT_MONTH_SHORT_DAY_OF_[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_render_short_month_short_day_of_week_day.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_render_short_month_short_day_of_week_day.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
