...
SRC_C="src/decomp/c/replacements/esqpars_jmptbl_script_readserialrbfbyte_gcc.c"
ORIG_ASM="src/modules/groups/a/o/esqpars.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/esqpars_jmptbl_script_readserialrbfbyte.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/esqpars_jmptbl_script_readserialrbfbyte.original_slice.s"
GEN_SLICE="${OUT_DIR}/esqpars_jmptbl_script_readserialrbfbyte.generated_slice.s"
ORIG_NORM="${OUT_DIR}/esqpars_jmptbl_script_readserialrbfbyte.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/esqpars_jmptbl_script_readserialrbfbyte.generated_slice.norm.s"
...
awk -v start_label="ESQPARS_JMPTBL_SCRIPT_ReadSerialRbfByte" -v next_label="ESQPARS_JMPTBL_ESQ_GenerateXorChecksumByte" '
...
awk '$0 ~ /^_?ESQPARS_JMPTBL_SCRIPT_ReadSerialRbfByte:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_esqpars_jmptbl_script_readserialrbfbyte.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_esqpars_jmptbl_script_readserialrbfbyte.awk" "$GEN_NORM" > "$GEN_SEM"
