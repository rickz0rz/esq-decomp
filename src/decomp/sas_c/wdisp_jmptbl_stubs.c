...
extern long ESQIFF_RenderWeatherStatusBrushSlice(char *ctx, unsigned char *brush);
...
extern void NEWGRID_ResetRowTable(unsigned char *gridCtx);
...
void WDISP_JMPTBL_ESQIFF_QueueIffBrushLoad(short mode){ESQIFF_QueueIffBrushLoad(mode);}
...
void WDISP_JMPTBL_ESQIFF_RenderWeatherStatusBrushSlice(char *ctx, unsigned char *brush){ESQIFF_RenderWeatherStatusBrushSlice(ctx, brush);}
...
void WDISP_JMPTBL_NEWGRID_ResetRowTable(unsigned char *gridCtx){NEWGRID_ResetRowTable(gridCtx);}
