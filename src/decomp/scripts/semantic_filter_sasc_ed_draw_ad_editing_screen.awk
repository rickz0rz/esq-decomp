BEGIN{h_entry=0;h_help=0;h_line_page=0;h_text_cursor=0;badge_calls=0;h_sprintf=0;h_mulu=0;h_setapen=0;h_setbpen=0;h_setdrmd=0;h_rect=0;display_calls=0;h_msg330=0;h_msg360=0;h_msg390=0;h_rts=0}
function t(s, x){x=s;sub(/;.*/,"",x);sub(/^[ \t]+/,"",x);sub(/[ \t]+$/,"",x);gsub(/[ \t]+/," ",x);return toupper(x)}
{
    l=t($0)
    if(l=="")next
    if(l~/^ED_DRAWADEDITINGSCREEN:/ || l~/^ED_DRAWADEDITINGSCRE[A-Z0-9_]*:/)h_entry=1
    ...
    if(l~/330/ || l~/#\$14A/)h_msg330=1
    if(l~/360/ || l~/#\$168/)h_msg360=1
    if(l~/390/ || l~/#\$186/)h_msg390=1
    if(l=="RTS")h_rts=1
}
END{
    ...
    print "HAS_MSG_330="h_msg330
    print "HAS_MSG_360="h_msg360
    print "HAS_MSG_390="h_msg390
    print "HAS_RTS="h_rts
}
