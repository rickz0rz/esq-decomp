...
BASE="newgrid2_jmptbl_disptext_islastlineselected"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_IsLastLineSelected"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_IsLastL"
TARGET="DISPTEXT_IsLastLineSelected"
mkdir -p "$OUT_DIR"
