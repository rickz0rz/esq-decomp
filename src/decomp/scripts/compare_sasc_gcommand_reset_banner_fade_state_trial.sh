...
SASC_SRC="gcommand_reset_banner_fade_state.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_reset_banner_fade_state"
ENTRY="GCOMMAND_ResetBannerFadeState"
ENTRY_SASC_REGEX="^GCOMMAND_ResetBannerFadeS[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_reset_banner_fade_state.awk \
