...
BASE="parseini2_jmptbl_datetime_isleapyear"
ENTRY_ORIG="PARSEINI2_JMPTBL_DATETIME_IsLeapYear"
ENTRY_SASC="PARSEINI2_JMPTBL_DATETIME_IsLeap"
TARGET="DATETIME_IsLeapYear"
mkdir -p "$OUT_DIR"
