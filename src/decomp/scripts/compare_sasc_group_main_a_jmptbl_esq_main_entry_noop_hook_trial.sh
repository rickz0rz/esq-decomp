...
SASC_SRC="group_main_a_jmptbl_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/_main/a/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_main_a_jmptbl_esq_main_entry_noop_hook"
ENTRY_ORIG="GROUP_MAIN_A_JMPTBL_ESQ_MainEntryNoOpHook"
ENTRY_SASC="GROUP_MAIN_A_JMPTBL_ESQ_MainEntr"
TARGET="ESQ_MainEntryNoOpHook"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_MAIN_A_JMPTBL_MEMLIST_Free:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
