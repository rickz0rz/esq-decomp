...

{
    ...
    if ((u ~ /MOVE\.W D0,0\(A2,D5\.W\)/ || u ~ /MOVE\.W D0,0\(A3,D5\.W\)/ || u ~ /MOVE\.W D0,\(A[23]\)/ || u ~ /MOVE\.W D[0-7],\$0\(A3,D[0-7]\.W\)/) && u !~ /MOVE\.W D[0-7],D[0-7]/) has_dual_store = 1
    if ((u ~ /MOVE\.W D0,0\(A2,D5\.W\)/ || u ~ /MOVE\.W D0,\(A2\)/ || u ~ /MOVE\.W D[0-7],\$0\(A5,D[0-7]\.W\)/ || u ~ /MOVE\.W D[0-7],\$0\(A3,D[0-7]\.W\)/) && u !~ /MOVE\.W D[0-7],D[0-7]/) has_primary_store = 1
