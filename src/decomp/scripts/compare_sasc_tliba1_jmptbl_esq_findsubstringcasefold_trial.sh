...
BASE="tliba1_jmptbl_esq_findsubstringcasefold"
ENTRY_ORIG="TLIBA1_JMPTBL_ESQ_FindSubstringCaseFold"
ENTRY_SASC="TLIBA1_JMPTBL_ESQ_FindSubstringC"
TARGET="ESQ_FindSubstringCaseFold"
mkdir -p "$OUT_DIR"
