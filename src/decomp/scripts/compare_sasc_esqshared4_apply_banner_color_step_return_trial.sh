...
BASE="esqshared4_apply_banner_color_step_return"
ENTRY="ESQSHARED4_ApplyBannerColorStep_Return"
ENTRY_SASC_REGEX="^ESQSHARED4_ApplyBannerColorStep_[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQSHARED4_APPLYBANNERCOLORSTEP_RETURN:"
ENTRY_ALT_SEM="ESQSHARED4_APPLYBANNERCOLORSTEP_"
