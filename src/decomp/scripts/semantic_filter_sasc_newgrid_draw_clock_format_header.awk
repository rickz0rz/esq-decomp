...

{
    ...
    if (n ~ /NEWGRID2JMPTBLBEVELDRAWBEVELFRAMEWITHTOPRIGHT/ || n ~ /NEWGRID2JMPTBLBEVELDRAWBEVELFRAMEWITHTOPR/ || n ~ /NEWGRID2JMPTBLBEVELDRAWBEVELF/) has_bevel_call=1
    if (n ~ /NEWGRID2JMPTBLCLEANUPFORMATCLOCKFORMATENTRY/ || n ~ /NEWGRID2JMPTBLCLEANUPFORMATCLOCKFORMA/ || n ~ /NEWGRID2JMPTBLCLEANUPFORMATCLOCKF/ || n ~ /NEWGRID2JMPTBLCLEANUPFORMATCL/) has_formatentry_call=1
    if (n ~ /NEWGRIDJMPTBLMATHMULU32/ || n ~ /NEWGRIDJMPTBLMATHMULU/) has_mul_call=1
