...
SASC_SRC="diskio_query_disk_usage_percent_and_set_buffer_size.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/g/diskio.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio_query_disk_usage_percent_and_set_buffer_size"
ENTRY="DISKIO_QueryDiskUsagePercentAndSetBufferSize"
ENTRY_SASC_REGEX="^DISKIO_QueryDiskUsagePercentAndS[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_query_disk_usage_percent_and_set_buffer_size.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_query_disk_usage_percent_and_set_buffer_size.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
