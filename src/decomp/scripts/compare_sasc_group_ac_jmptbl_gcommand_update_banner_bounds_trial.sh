...
BASE="group_ac_jmptbl_gcommand_update_banner_bounds"
ENTRY_ORIG="GROUP_AC_JMPTBL_GCOMMAND_UpdateBannerBounds"
ENTRY_SASC="GROUP_AC_JMPTBL_GCOMMAND_UpdateB"
TARGET="GCOMMAND_UpdateBannerBounds"
mkdir -p "$OUT_DIR"
