...
SASC_SRC="esqiff_render_weather_status_brush_slice_return.c"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_render_weather_status_brush_slice_return.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_render_weather_status_brush_slice_return.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
