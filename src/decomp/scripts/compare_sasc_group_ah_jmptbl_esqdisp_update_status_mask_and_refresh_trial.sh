...
BASE="group_ah_jmptbl_esqdisp_update_status_mask_and_refresh"
ENTRY_ORIG="GROUP_AH_JMPTBL_ESQDISP_UpdateStatusMaskAndRefresh"
ENTRY_SASC="GROUP_AH_JMPTBL_ESQDISP_UpdateSt"
