BEGIN {
    has_label=0; has_link=0; has_save=0; has_markers_call=0; has_textlen=0; has_prefix1=0; has_prefix2=0; has_store=0; has_restore=0; has_return=0
}
function trim(s,t){t=s; sub(/;.*/,"",t); sub(/^[ \t]+/,"",t); sub(/[ \t]+$/,"",t); return t}
{
    ...
    if (index(u,"GROUP_AI_JMPTBL_NEWGRID_SETSELECTIONMARKERS")>0) has_markers_call=1
...
END {
    ...
    print "HAS_MARKERS_CALL="has_markers_call
