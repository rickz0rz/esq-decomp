...

{
    ...
    if (u ~ /GROUP_AJ_JMPTBL_STRING_FINDSUBSTRING|GROUP_AJ_JMPTBL_STRING_FINDSUBSTRIN|GROUP_AJ_JMPTBL_STRING_FINDSUBST|STRING_FINDSUBSTRING|STRING_FINDSUBSTRIN|STRING_FINDSUBST/) find_count++
