...
SASC_SRC="ladfunc_update_highlight_state.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_update_highlight_state"
ENTRY="LADFUNC_UpdateHighlightState"
ENTRY_SASC_REGEX="^LADFUNC_UpdateHighlightState[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_update_highlight_state.awk \
