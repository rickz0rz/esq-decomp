    ...
    XDEF    PARSEINI_TAG_ALL
    XDEF    PARSEINI_TAG_NONE
    XDEF    PARSEINI_TAG_TEXT
    XDEF    PARSEINI_TAG_XPOS
    XDEF    PARSEINI_TAG_TYPE
    XDEF    PARSEINI_TAG_DITHER
    XDEF    PARSEINI_TAG_YPOS
    XDEF    PARSEINI_TAG_XSOURCE
    XDEF    PARSEINI_TAG_YSOURCE
    XDEF    PARSEINI_TAG_SIZEX
    XDEF    PARSEINI_TAG_SIZEY
    XDEF    PARSEINI_TAG_SOURCE
    XDEF    PARSEINI_TAG_PPV
    XDEF    Global_STR_PARSEINI_C_3
    XDEF    PARSEINI_STR_HORIZONTAL
    XDEF    PARSEINI_TAG_RIGHT
    XDEF    PARSEINI_TAG_CENTER_HorizontalAlign
    XDEF    PARSEINI_TAG_VERTICAL
    ...
    XDEF    Global_STR_DF0_BANNER_INI_3
    XDEF    Global_STR_DF0_DEFAULT_INI_2
    XDEF    Global_STR_DF0_SOURCECFG_INI_1
    XDEF    Global_STR_LIST_RAM_LOGODIR_TXT_DH2_LOGOS_NOHEAD_QUICK
    XDEF    PARSEINI_PATH_DF0_COLON_LOGO_DOT_LST
    XDEF    PARSEINI_STR_RB_LogoListPrimary
    XDEF    PARSEINI_PATH_RAM_COLON_LOGODIR_DOT_TXT
    XDEF    PARSEINI_STR_RB_LogoListSecondary
    XDEF    Global_STR_PARSEINI_C_4
    XDEF    Global_STR_PARSEINI_C_5
    XDEF    Global_STR_DELETE_NIL_DH2_LOGOS
