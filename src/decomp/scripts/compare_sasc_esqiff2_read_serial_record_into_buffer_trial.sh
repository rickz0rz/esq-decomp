...
SASC_SRC="esqiff2_read_serial_record_into_buffer.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_read_serial_record_into_buffer"
ENTRY="ESQIFF2_ReadSerialRecordIntoBuffer"
ENTRY_SASC_REGEX="^ESQIFF2_ReadSerialRecordIntoB[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_read_serial_record_into_buffer.awk \
