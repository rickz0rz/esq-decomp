...
BASE="textdisp_jmptbl_cleanup_drawinsetrectframe"
ENTRY_ORIG="TEXTDISP_JMPTBL_CLEANUP_DrawInsetRectFrame"
ENTRY_SASC="TEXTDISP_JMPTBL_CLEANUP_DrawInse"
TARGET="CLEANUP_DrawInsetRectFrame"
mkdir -p "$OUT_DIR"
