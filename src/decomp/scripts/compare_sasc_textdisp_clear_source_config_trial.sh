...
SASC_SRC="textdisp_clear_source_config.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_clear_source_config"
ENTRY="TEXTDISP_ClearSourceConfig"
ENTRY_SASC_REGEX="^TEXTDISP_ClearSourceConfig[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_clear_source_config.awk \
