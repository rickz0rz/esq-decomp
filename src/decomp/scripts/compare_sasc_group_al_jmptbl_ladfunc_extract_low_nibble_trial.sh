...
BASE="group_al_jmptbl_ladfunc_extract_low_nibble"
ENTRY_ORIG="GROUP_AL_JMPTBL_LADFUNC_ExtractLowNibble"
ENTRY_SASC="GROUP_AL_JMPTBL_LADFUNC_ExtractL"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AL_JMPTBL_LADFUNC_UpdateEn:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
