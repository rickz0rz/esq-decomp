...
SASC_SRC="ed1_draw_status_line1.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/k/ed1.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed1_draw_status_line1"
ENTRY_ORIG="ED1_DrawStatusLine1"
ENTRY_SASC_REGEX="^ED1_DrawStatusLine1[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_draw_status_line1.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_draw_status_line1.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
