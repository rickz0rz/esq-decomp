...
SASC_SRC="esqdisp_get_entry_pointers_by_mode.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqdisp_get_entry_aux_pointer_by_mode"
ENTRY="ESQDISP_GetEntryAuxPointerByMode"
ENTRY_SASC_REGEX="^ESQDISP_GetEntryAuxPointerByMo[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQDISP_GETENTRYAUXPOINTERBYMODE:"
ENTRY_ALT_SEM="ESQDISP_GETENTRYAUXPOINTERBYMO"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_esqdisp_get_entry_aux_pointer_by_mode.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_esqdisp_get_entry_aux_pointer_by_mode.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
