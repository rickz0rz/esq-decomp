...

{
    ...
    if (n ~ /NEWGRID2JMPTBLDISPTEXTGETTOTALLINECOUNT/ || n ~ /NEWGRID2JMPTBLDISPTEXTGETTOTALLINE/ || n ~ /NEWGRID2JMPTBLDISPTEXTGETTOTA/) has_total_lines=1
    if (n ~ /NEWGRID2JMPTBLDISPTEXTMEASURECURRENTLINELENGTH/ || n ~ /NEWGRID2JMPTBLDISPTEXTMEASURECURRENT/ || n ~ /NEWGRID2JMPTBLDISPTEXTMEASURE/) has_measure_line=1
