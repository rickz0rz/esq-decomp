...
BASE="newgrid2_jmptbl_coi_renderclockformatentryvariant"
ENTRY_ORIG="NEWGRID2_JMPTBL_COI_RenderClockFormatEntryVariant"
ENTRY_SASC="NEWGRID2_JMPTBL_COI_RenderClockF"
TARGET="COI_RenderClockFormatEntryVariant"
mkdir -p "$OUT_DIR"
