...
SASC_SRC="esqshared4_set_banner_color_base_and_limit.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_set_banner_color_base_and_limit"
ENTRY="ESQSHARED4_SetBannerColorBaseAndLimit"
ENTRY_SASC_REGEX="^ESQSHARED4_SetBannerColorBaseAnd[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_set_banner_color_base_and_limit.awk \
