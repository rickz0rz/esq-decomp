...
; PURPOSE:
;   Object-level hybrid replacement for the TEXTDISP module now that the
;   restored SAS/C lane covers the current non-JMPTBL source-config,
;   selection, and text-format helper cluster. This replacement now carries
