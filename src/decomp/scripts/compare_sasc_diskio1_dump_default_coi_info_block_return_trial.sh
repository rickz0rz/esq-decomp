...
BASE="diskio1_dump_default_coi_info_block_return"
ENTRY="DISKIO1_DumpDefaultCoiInfoBlock_Return"
ENTRY_SASC_REGEX="^DISKIO1_DumpDefaultCoiInfoBlock_[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_DUMPDEFAULTCOIINFOBLOCK_RETURN:"
ENTRY_ALT_SEM="DISKIO1_DUMPDEFAULTCOIINFOBLOCK_:"
