...
SRC_C="src/decomp/c/replacements/parse_readsignedlong_negate_value_gcc.c"
ORIG_ASM="src/modules/submodules/unknown10.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/parse_readsignedlong_negate_value.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/parse_readsignedlong_negate_value.original_slice.s"
GEN_SLICE="${OUT_DIR}/parse_readsignedlong_negate_value.generated_slice.s"
ORIG_NORM="${OUT_DIR}/parse_readsignedlong_negate_value.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/parse_readsignedlong_negate_value.generated_slice.norm.s"
...
awk '
$0 ~ /^PARSE_ReadSignedLong_NegateValue:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;------------------------------------------------------------------------------/) exit
    print
}
...
awk '
$0 ~ /^_?PARSE_ReadSignedLong_NegateValue:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_parse_readsignedlong_negate_value.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_parse_readsignedlong_negate_value.awk "$GEN_NORM" > "$GEN_SEM"
