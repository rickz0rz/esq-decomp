...
BASE="ed1_jmptbl_cleanup_drawdatetimebannerrow"
ENTRY_ORIG="ED1_JMPTBL_CLEANUP_DrawDateTimeBannerRow"
ENTRY_SASC="ED1_JMPTBL_CLEANUP_DrawDateTimeB"
TARGET="CLEANUP_DrawDateTimeBannerRow"
mkdir -p "$OUT_DIR"
