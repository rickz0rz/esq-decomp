...
SASC_SRC="textdisp_build_entry_detail_line.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_build_entry_detail_line"
ENTRY="TEXTDISP_BuildEntryDetailLine"
ENTRY_SASC_REGEX="^TEXTDISP_BuildEntryDetailLi[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_build_entry_detail_line.awk \
