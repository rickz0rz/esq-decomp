...
BASE="group_ak_jmptbl_tliba3_draw_view_mode_guides"
ENTRY_ORIG="GROUP_AK_JMPTBL_TLIBA3_DrawViewModeGuides"
ENTRY_SASC="GROUP_AK_JMPTBL_TLIBA3_DrawViewM"
TARGET="TLIBA3_DrawViewModeGuides"
mkdir -p "$OUT_DIR"
