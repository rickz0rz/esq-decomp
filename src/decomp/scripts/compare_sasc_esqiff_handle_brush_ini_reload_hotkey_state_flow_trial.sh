...
SASC_SRC="esqiff_handle_brush_ini_reload_hotkey.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_handle_brush_ini_reload_hotkey_state_flow"
ENTRY="ESQIFF_HandleBrushIniReloadHotkey"
ENTRY_SASC_REGEX="^ESQIFF_HandleBrushIniReloadHotke[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_handle_brush_ini_reload_hotkey_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_handle_brush_ini_reload_hotkey_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
