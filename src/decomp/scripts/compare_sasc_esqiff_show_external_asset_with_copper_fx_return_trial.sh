...
BASE="esqiff_show_external_asset_with_copper_fx_return"
ENTRY="ESQIFF_ShowExternalAssetWithCopperFx_Return"
ENTRY_CANONICAL="ESQIFF_ShowExternalAssetWithCopperFx"
ENTRY_SASC_REGEX="^ESQIFF_ShowExternalAssetWithCopp[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF_SHOWEXTERNALASSETWITHCOPPERFX_RETURN:"
ENTRY_ALT_SEM="ESQIFF_SHOWEXTERNALASSETWITHCOPP"
