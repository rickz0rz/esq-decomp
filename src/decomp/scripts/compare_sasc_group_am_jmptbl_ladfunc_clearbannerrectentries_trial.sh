...
BASE="group_am_jmptbl_ladfunc_clearbannerrectentries"
ENTRY_ORIG="GROUP_AM_JMPTBL_LADFUNC_ClearBannerRectEntries"
ENTRY_SASC="GROUP_AM_JMPTBL_LADFUNC_ClearBan"
TARGET="LADFUNC_ClearBannerRectEntries"
mkdir -p "$OUT_DIR"
