...
BASE="parse_readsignedlong_negate_value"
ENTRY="PARSE_ReadSignedLong_NegateValue"
ENTRY_SASC_REGEX="^PARSE_ReadSignedLong_NegateValue[A-Za-z0-9_]*:$"
...
awk -v ENTRY="$ENTRY" -f src/decomp/scripts/semantic_filter_sasc_parse_readsignedlong_negate_value.awk \
