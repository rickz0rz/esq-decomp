...
BASE="newgrid_jmptbl_datetime_secondstostruct"
ENTRY_ORIG="NEWGRID_JMPTBL_DATETIME_SecondsToStruct"
ENTRY_SASC="NEWGRID_JMPTBL_DATETIME_SecondsT"
TARGET="DATETIME_SecondsToStruct"
mkdir -p "$OUT_DIR"
