...
BASE="textdisp_jmptbl_cleanup_buildalignedstatusline"
ENTRY_ORIG="TEXTDISP_JMPTBL_CLEANUP_BuildAlignedStatusLine"
ENTRY_SASC="TEXTDISP_JMPTBL_CLEANUP_BuildAli"
TARGET="CLEANUP_BuildAlignedStatusLine"
mkdir -p "$OUT_DIR"
