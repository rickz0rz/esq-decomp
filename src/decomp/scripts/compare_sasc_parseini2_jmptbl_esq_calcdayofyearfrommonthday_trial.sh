...
BASE="parseini2_jmptbl_esq_calcdayofyearfrommonthday"
ENTRY_ORIG="PARSEINI2_JMPTBL_ESQ_CalcDayOfYearFromMonthDay"
ENTRY_SASC="PARSEINI2_JMPTBL_ESQ_CalcDayOfYe"
TARGET="ESQ_CalcDayOfYearFromMonthDay"
mkdir -p "$OUT_DIR"
