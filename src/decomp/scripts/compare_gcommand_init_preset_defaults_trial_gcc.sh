...
SRC_C="src/decomp/c/replacements/gcommand_init_preset_defaults_gcc.c"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/gcommand_init_preset_defaults.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/gcommand_init_preset_defaults.original_slice.s"
GEN_SLICE="${OUT_DIR}/gcommand_init_preset_defaults.generated_slice.s"
ORIG_NORM="${OUT_DIR}/gcommand_init_preset_defaults.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/gcommand_init_preset_defaults.generated_slice.norm.s"
...
awk '
$0 ~ /^GCOMMAND_InitPresetDefaults:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;!======/) exit
    print
}
...
awk '
$0 ~ /^_?GCOMMAND_InitPresetDefaults:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_gcommand_init_preset_defaults.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_gcommand_init_preset_defaults.awk "$GEN_NORM" > "$GEN_SEM"
