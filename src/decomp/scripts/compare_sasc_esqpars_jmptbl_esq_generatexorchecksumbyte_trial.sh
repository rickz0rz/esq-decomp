...
BASE="esqpars_jmptbl_esq_generatexorchecksumbyte"
ENTRY_ORIG="ESQPARS_JMPTBL_ESQ_GenerateXorChecksumByte"
ENTRY_SASC="ESQPARS_JMPTBL_ESQ_GenerateXorCh"
TARGET="ESQ_GenerateXorChecksumByte"
mkdir -p "$OUT_DIR"
