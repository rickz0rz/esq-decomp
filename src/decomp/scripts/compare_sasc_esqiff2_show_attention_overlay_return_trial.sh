...
BASE="esqiff2_show_attention_overlay_return"
ENTRY="ESQIFF2_ShowAttentionOverlay_Return"
ENTRY_SASC_REGEX="^ESQIFF2_ShowAttentionOverlay_Ret[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_SHOWATTENTIONOVERLAY_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_SHOWATTENTIONOVERLAY_RET"
