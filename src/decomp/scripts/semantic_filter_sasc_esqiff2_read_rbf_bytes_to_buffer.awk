...

{
    ...
    if (index(u, "ESQPARS_JMPTBL_SCRIPT_READSERIALRBFBYTE") > 0 || index(u, "READSERIALRBFBYTE") > 0 || index(u, "ESQPARS_JMPTBL_SCRIPT_READSERIAL") > 0 || index(u, "READSERIAL") > 0 || index(u, "SCRIPT_READNEXTRBFBYTE") > 0 || index(u, "READNEXTRBFBYTE") > 0) has_read_byte = 1
