...
function trim(s,t){t=s; sub(/;.*/,"",t); sub(/^[ \t]+/,"",t); sub(/[ \t]+$/,"",t); return t}
{
 ...
 if (n ~ /PARSEINIJMPTBLSTRINGCOMPARENOCASE/ || n ~ /PARSEINIJMPTBLSTRINGCOMPARENO/ || n ~ /STRINGCOMPARENOCASE/ || n ~ /STRINGCOMPARENO/ || n ~ /PARSEINITAGFILENAMEWEATHERSTRING/ || n ~ /PARSEINITAGFILENAMEWEATHERSTR/) has_compare=1
 if (n ~ /PARSEINIJMPTBLBRUSHALLOCBRUSHNODE/ || n ~ /PARSEINIJMPTBLBRUSHALLOCBRUSHNOD/ || n ~ /PARSEINIJMPTBLBRUSHALLOCBRUSH/ || n ~ /BRUSHALLOCBRUSHNODE/ || n ~ /BRUSHALLOCBRUSHNOD/ || n ~ /BRUSHALLOCBRUSH/) has_alloc=1
