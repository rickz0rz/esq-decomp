...
BASE="group_am_jmptbl_ladfunc_loadtextadsfromfile"
ENTRY_ORIG="GROUP_AM_JMPTBL_LADFUNC_LoadTextAdsFromFile"
ENTRY_SASC="GROUP_AM_JMPTBL_LADFUNC_LoadText"
TARGET="LADFUNC_LoadTextAdsFromFile"
mkdir -p "$OUT_DIR"
