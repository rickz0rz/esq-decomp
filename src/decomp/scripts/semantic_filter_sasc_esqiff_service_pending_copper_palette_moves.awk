...

{
    ...
    if (n ~ /ESQIFFJMPTBLESQMOVECOPPERENTRYTOWARDEND/ || n ~ /ESQMOVECOPPERENTRYTOWARDEND/ || n ~ /ESQIFFJMPTBLESQMOVECOPPERENTR/) has_move_end=1
    if (n ~ /ESQIFFJMPTBLESQMOVECOPPERENTRYTOWARDSTART/ || n ~ /ESQMOVECOPPERENTRYTOWARDSTART/ || n ~ /ESQIFFJMPTBLESQMOVECOPPERENTR/) has_move_start=1
