...
BASE="group_main_a_jmptbl_memlist_free_all"
ENTRY_ORIG="GROUP_MAIN_A_JMPTBL_MEMLIST_FreeAll"
ENTRY_SASC="GROUP_MAIN_A_JMPTBL_MEMLIST_Free"
TARGET="MEMLIST_FreeAll"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_MAIN_A_JMPTBL_ESQ_ParseCom:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
