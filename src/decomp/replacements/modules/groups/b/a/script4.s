...
; PURPOSE:
;   Object-level hybrid replacement for the SCRIPT4 module now that the
;   restored SAS/C lane covers the current non-JMPTBL banner-char, inset-text,
;   and highlight-effect helper set. This replacement now carries the module
