...
SASC_SRC="textdisp_get_group_entry_count.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_get_group_entry_count"
ENTRY="TEXTDISP_GetGroupEntryCount"
ENTRY_SASC_REGEX="^TEXTDISP_GetGroupEntryCount[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_get_group_entry_count.awk \
