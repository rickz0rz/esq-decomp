...
BASE="group_ak_jmptbl_parseini_scan_logo_directory"
ENTRY_ORIG="GROUP_AK_JMPTBL_PARSEINI_ScanLogoDirectory"
ENTRY_SASC="GROUP_AK_JMPTBL_PARSEINI_ScanLog"
TARGET="PARSEINI_ScanLogoDirectory"
mkdir -p "$OUT_DIR"
