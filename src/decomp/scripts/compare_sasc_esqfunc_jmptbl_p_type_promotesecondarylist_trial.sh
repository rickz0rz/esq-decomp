...
BASE="esqfunc_jmptbl_p_type_promotesecondarylist"
ENTRY_ORIG="ESQFUNC_JMPTBL_P_TYPE_PromoteSecondaryList"
ENTRY_SASC="ESQFUNC_JMPTBL_P_TYPE_PromoteSec"
TARGET="P_TYPE_PromoteSecondaryList"
mkdir -p "$OUT_DIR"
