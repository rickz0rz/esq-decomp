...
SRC_C="src/decomp/c/replacements/parseini2_jmptbl_clock_convertamigasecondstoclockdata_gcc.c"
ORIG_ASM="src/modules/groups/b/a/parseini2.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/parseini2_jmptbl_clock_convertamigasecondstoclockdata.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/parseini2_jmptbl_clock_convertamigasecondstoclockdata.original_slice.s"
GEN_SLICE="${OUT_DIR}/parseini2_jmptbl_clock_convertamigasecondstoclockdata.generated_slice.s"
ORIG_NORM="${OUT_DIR}/parseini2_jmptbl_clock_convertamigasecondstoclockdata.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/parseini2_jmptbl_clock_convertamigasecondstoclockdata.generated_slice.norm.s"
...
awk -v start_label="PARSEINI2_JMPTBL_CLOCK_ConvertAmigaSecondsToClockData" -v next_label="PARSEINI2_JMPTBL_ESQ_CalcDayOfYearFromMonthDay" '
...
awk '$0 ~ /^_?PARSEINI2_JMPTBL_CLOCK_ConvertAmigaSecondsToClockData:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_parseini2_jmptbl_clock_convertamigasecondstoclockdata.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_parseini2_jmptbl_clock_convertamigasecondstoclockdata.awk" "$GEN_NORM" > "$GEN_SEM"
