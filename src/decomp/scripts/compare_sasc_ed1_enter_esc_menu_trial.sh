...
BASE="ed1_enter_esc_menu"
ENTRY_ORIG="ED1_EnterEscMenu"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_enter_esc_menu.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_enter_esc_menu.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
