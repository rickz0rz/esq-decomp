...
BASE="group_ay_jmptbl_diskio_write_decimal_field"
ENTRY_ORIG="GROUP_AY_JMPTBL_DISKIO_WriteDecimalField"
ENTRY_SASC="GROUP_AY_JMPTBL_DISKIO_WriteDeci"
TARGET="DISKIO_WriteDecimalField"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AY_JMPTBL_DISKIO_WriteBuff:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
