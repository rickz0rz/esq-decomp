...
SRC_C="src/decomp/c/replacements/newgrid2_jmptbl_string_append_n_gcc.c"
ORIG_ASM="src/modules/groups/b/a/newgrid2.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/newgrid2_jmptbl_string_append_n.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/newgrid2_jmptbl_string_append_n.original_slice.s"
GEN_SLICE="${OUT_DIR}/newgrid2_jmptbl_string_append_n.generated_slice.s"
ORIG_NORM="${OUT_DIR}/newgrid2_jmptbl_string_append_n.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/newgrid2_jmptbl_string_append_n.generated_slice.norm.s"
...
awk -v start_label="NEWGRID2_JMPTBL_STRING_AppendN" -v next_label="NEWGRID2_JMPTBL_ESQDISP_ComputeScheduleOffsetForRow" '
...
awk '$0 ~ /^_?NEWGRID2_JMPTBL_STRING_AppendN:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_newgrid2_jmptbl_string_append_n.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_newgrid2_jmptbl_string_append_n.awk" "$GEN_NORM" > "$GEN_SEM"
