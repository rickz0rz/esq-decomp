...
BASE="group_ac_jmptbl_parseini_adjust_hours_to24_hr_format"
ENTRY_ORIG="GROUP_AC_JMPTBL_PARSEINI_AdjustHoursTo24HrFormat"
ENTRY_SASC="GROUP_AC_JMPTBL_PARSEINI_AdjustH"
TARGET="PARSEINI_AdjustHoursTo24HrFormat"
mkdir -p "$OUT_DIR"
