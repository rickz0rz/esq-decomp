...
SASC_SRC="ladfunc_parse_hex_digit.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_parse_hex_digit"
ENTRY="LADFUNC_ParseHexDigit"
ENTRY_SASC_REGEX="^LADFUNC_ParseHexDigit[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_parse_hex_digit.awk \
