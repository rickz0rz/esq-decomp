...
SRC_C="src/decomp/c/replacements/struct_alloc_with_owner_gcc.c"
ORIG_ASM="src/modules/submodules/unknown25.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/struct_alloc_with_owner.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/struct_alloc_with_owner.original_slice.s"
GEN_SLICE="${OUT_DIR}/struct_alloc_with_owner.generated_slice.s"
ORIG_NORM="${OUT_DIR}/struct_alloc_with_owner.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/struct_alloc_with_owner.generated_slice.norm.s"
...
awk '$0 ~ /^STRUCT_AllocWithOwner:?$/ {in_func=1} in_func { if ($0 ~ /^;!======/) exit; print }' "$ORIG_ASM" > "$ORIG_SLICE"
awk '$0 ~ /^_?STRUCT_AllocWithOwner:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_struct_alloc_with_owner.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_struct_alloc_with_owner.awk "$GEN_NORM" > "$GEN_SEM"
