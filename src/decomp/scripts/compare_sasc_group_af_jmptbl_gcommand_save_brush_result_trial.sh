...
SASC_SRC="group_af_jmptbl_gcommand_save_brush_result.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/f/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_af_jmptbl_gcommand_save_brush_result"
ENTRY_ORIG="GROUP_AF_JMPTBL_GCOMMAND_SaveBrushResult"
ENTRY_SASC="GROUP_AF_JMPTBL_GCOMMAND_SaveBru"
TARGET="GCOMMAND_SaveBrushResult"
