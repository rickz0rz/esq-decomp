...
BASE="esqpars_jmptbl_dst_updatebannerqueue"
ENTRY_ORIG="ESQPARS_JMPTBL_DST_UpdateBannerQueue"
ENTRY_SASC="ESQPARS_JMPTBL_DST_UpdateBannerQ"
TARGET="DST_UpdateBannerQueue"
mkdir -p "$OUT_DIR"
