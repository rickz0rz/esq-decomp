...

{
    ...
    if (n ~ /SCRIPT3JMPTBLGCOMMANDGETBANNERCHAR/ || n ~ /SCRIPT3JMPTBLGCOMMANDGETBAN/) has_get = 1
    if (n ~ /SCRIPT3JMPTBLGCOMMANDADJUSTBANNERCOPPEROFFSET/ || n ~ /SCRIPT3JMPTBLGCOMMANDADJUSTBA/) has_adjust = 1
