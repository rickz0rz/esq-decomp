...
BASE="newgrid2_jmptbl_tliba_findfirstwildcardmatchindex"
ENTRY_ORIG="NEWGRID2_JMPTBL_TLIBA_FindFirstWildcardMatchIndex"
ENTRY_SASC="NEWGRID2_JMPTBL_TLIBA_FindFirstW"
TARGET="TLIBA_FindFirstWildcardMatchIndex"
mkdir -p "$OUT_DIR"
