...
SASC_SRC="esqshared4_copy_live_planes_to_snapshot.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_copy_live_planes_to_snapshot"
ENTRY="ESQSHARED4_CopyLivePlanesToSnapshot"
ENTRY_SASC_REGEX="^ESQSHARED4_CopyLivePlanesToS[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_copy_live_planes_to_snapshot.awk \
