...
```
maximum-C build, CODE hunk   95.7%   [######################################..]
                                     223,380 of 233,352 bytes come from C
```

| measure | value |
|---|---|
| maximum-C manifest | 802 entries (`src/c/replacements-all.txt`) |
| assembly remaining | 9,972 of 233,352 CODE bytes (4.3%) |
