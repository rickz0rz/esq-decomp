...
BASE="newgrid_jmptbl_generate_grid_date_string"
ENTRY_ORIG="NEWGRID_JMPTBL_GENERATE_GRID_DATE_STRING"
ENTRY_SASC="NEWGRID_JMPTBL_GENERATE_GRID_DAT"
TARGET="GENERATE_GRID_DATE_STRING"
mkdir -p "$OUT_DIR"
