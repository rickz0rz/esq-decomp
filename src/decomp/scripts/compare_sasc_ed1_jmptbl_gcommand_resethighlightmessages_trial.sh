...
BASE="ed1_jmptbl_gcommand_resethighlightmessages"
ENTRY_ORIG="ED1_JMPTBL_GCOMMAND_ResetHighlightMessages"
ENTRY_SASC="ED1_JMPTBL_GCOMMAND_ResetHighlig"
TARGET="GCOMMAND_ResetHighlightMessages"
mkdir -p "$OUT_DIR"
