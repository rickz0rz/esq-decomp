...
SASC_SRC="ed_draw_diagnostic_register_values.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/l/ed3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed_draw_diagnostic_register_values"
ENTRY_ORIG="ED_DrawDiagnosticRegisterValues"
ENTRY_SASC_REGEX="^ED_DrawDiagnosticRegisterValues[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed_draw_diagnostic_register_values.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed_draw_diagnostic_register_values.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
