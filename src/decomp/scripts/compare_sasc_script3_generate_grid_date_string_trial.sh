...
SASC_SRC="script3_generate_grid_date_string.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/script3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="script3_generate_grid_date_string"
ENTRY="GENERATE_GRID_DATE_STRING"
ENTRY_SASC_REGEX="^GENERATE_GRID_DATE_STRING[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_script3_generate_grid_date_string.awk \
