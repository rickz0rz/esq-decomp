...
SRC_C="src/decomp/c/replacements/group_ar_jmptbl_string_append_at_null_gcc.c"
ORIG_ASM="src/modules/groups/a/r/xjump.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/group_ar_jmptbl_string_append_at_null.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/group_ar_jmptbl_string_append_at_null.original_slice.s"
GEN_SLICE="${OUT_DIR}/group_ar_jmptbl_string_append_at_null.generated_slice.s"
ORIG_NORM="${OUT_DIR}/group_ar_jmptbl_string_append_at_null.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/group_ar_jmptbl_string_append_at_null.generated_slice.norm.s"
...
awk '
$0 ~ /^GROUP_AR_JMPTBL_STRING_AppendAtNull:?$/ {in_func=1}
in_func { print }
' "$ORIG_ASM" > "$ORIG_SLICE"

awk '
$0 ~ /^_?GROUP_AR_JMPTBL_STRING_AppendAtNull:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_group_ar_jmptbl_string_append_at_null.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_group_ar_jmptbl_string_append_at_null.awk "$GEN_NORM" > "$GEN_SEM"
