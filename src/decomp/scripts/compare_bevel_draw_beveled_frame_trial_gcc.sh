...
SRC_C="src/decomp/c/replacements/bevel_draw_beveled_frame_gcc.c"
ORIG_ASM="src/modules/groups/a/a/bevel.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/bevel_draw_beveled_frame.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/bevel_draw_beveled_frame.original_slice.s"
GEN_SLICE="${OUT_DIR}/bevel_draw_beveled_frame.generated_slice.s"
ORIG_NORM="${OUT_DIR}/bevel_draw_beveled_frame.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/bevel_draw_beveled_frame.generated_slice.norm.s"
ORIG_SEM="${OUT_DIR}/bevel_draw_beveled_frame.original_slice.semantic.txt"
GEN_SEM="${OUT_DIR}/bevel_draw_beveled_frame.generated_slice.semantic.txt"
...
awk -v start_label="BEVEL_DrawBeveledFrame" -v next_label="BEVEL_DrawBevelFrameWithTop" '
...
awk '$0 ~ /^_?BEVEL_DrawBeveledFrame:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_bevel_draw_beveled_frame.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_bevel_draw_beveled_frame.awk" "$GEN_NORM" > "$GEN_SEM"
