...

{
    ...
    if (index(u, "TEXTDISP_JMPTBL_NEWGRID_SHOULDOPENEDITOR") > 0 ||
        index(u, "TEXTDISP_JMPTBL_NEWGRID_SHOULDOPENE") > 0 ||
        index(u, "TEXTDISP_JMPTBL_NEWGRID_SHOULDOP") > 0 ||
        index(u, "NEWGRID_SHOULDOPENEDITOR") > 0 ||
        index(u, "NEWGRID_SHOULDOPENE") > 0 ||
        index(u, "NEWGRID_SHOULDOP") > 0) has_editor_check_call = 1
...
END {
    ...
    print "HAS_EDITOR_CHECK_CALL=" has_editor_check_call
