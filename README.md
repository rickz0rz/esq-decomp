...
```
maximum-C build, CODE hunk   96.6%   [#######################################.]
                                     226,404 of 234,256 bytes come from C
```

| measure | value |
|---|---|
| maximum-C manifest | 822 entries (`src/c/replacements-all.txt`) |
| assembly remaining | 7,852 of 234,256 CODE bytes (3.4%) |
