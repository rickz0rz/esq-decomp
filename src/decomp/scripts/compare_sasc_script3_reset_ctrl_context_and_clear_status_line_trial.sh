...
SASC_SRC="script3_reset_ctrl_context_and_clear_status_line.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/script3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="script3_reset_ctrl_context_and_clear_status_line"
ENTRY="SCRIPT_ResetCtrlContextAndClearStatusLine"
ENTRY_SASC_REGEX="^SCRIPT_ResetCtrlContextAndClear[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_script3_reset_ctrl_context_and_clear_status_line.awk \
