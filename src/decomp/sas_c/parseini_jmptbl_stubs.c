...
void PARSEINI_JMPTBL_STRING_CompareNoCase(void){STRING_CompareNoCase();}
...
void PARSEINI_JMPTBL_STR_FindCharPtr(void){STR_FindCharPtr();}
...
void PARSEINI_JMPTBL_DISKIO_LoadFileToWorkBuffer(void){DISKIO_LoadFileToWorkBuffer();}
