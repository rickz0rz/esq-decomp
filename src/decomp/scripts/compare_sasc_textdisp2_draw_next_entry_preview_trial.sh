...
SASC_SRC="textdisp2_draw_next_entry_preview.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp2_draw_next_entry_preview"
ENTRY="TEXTDISP_DrawNextEntryPreview"
ENTRY_SASC_REGEX="^TEXTDISP_DrawNextEntryPre[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp2_draw_next_entry_preview.awk \
