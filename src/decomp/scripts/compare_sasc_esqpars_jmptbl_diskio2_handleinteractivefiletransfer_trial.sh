...
BASE="esqpars_jmptbl_diskio2_handleinteractivefiletransfer"
ENTRY_ORIG="ESQPARS_JMPTBL_DISKIO2_HandleInteractiveFileTransfer"
ENTRY_SASC="ESQPARS_JMPTBL_DISKIO2_HandleInt"
TARGET="DISKIO2_HandleInteractiveFileTransfer"
mkdir -p "$OUT_DIR"
