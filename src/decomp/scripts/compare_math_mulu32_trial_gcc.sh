...
SRC_C="src/decomp/c/replacements/math_mulu32_gcc.c"
ORIG_ASM="src/modules/submodules/unknown22.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/math_mulu32.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/math_mulu32.original_slice.s"
GEN_SLICE="${OUT_DIR}/math_mulu32.generated_slice.s"
ORIG_NORM="${OUT_DIR}/math_mulu32.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/math_mulu32.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_math_mulu32.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_math_mulu32.awk "$GEN_NORM" > "$GEN_SEM"
