...
SRC_C="src/decomp/c/replacements/esqfunc_jmptbl_esq_tickglobalcounters_gcc.c"
ORIG_ASM="src/modules/groups/a/n/esqfunc.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/esqfunc_jmptbl_esq_tickglobalcounters.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/esqfunc_jmptbl_esq_tickglobalcounters.original_slice.s"
GEN_SLICE="${OUT_DIR}/esqfunc_jmptbl_esq_tickglobalcounters.generated_slice.s"
ORIG_NORM="${OUT_DIR}/esqfunc_jmptbl_esq_tickglobalcounters.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/esqfunc_jmptbl_esq_tickglobalcounters.generated_slice.norm.s"
...
awk -v start_label="ESQFUNC_JMPTBL_ESQ_TickGlobalCounters" -v next_label="ESQFUNC_JMPTBL_SCRIPT_HandleSerialCtrlCmd" '
...
awk -f "src/decomp/scripts/semantic_filter_esqfunc_jmptbl_esq_tickglobalcounters.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_esqfunc_jmptbl_esq_tickglobalcounters.awk" "$GEN_NORM" > "$GEN_SEM"
