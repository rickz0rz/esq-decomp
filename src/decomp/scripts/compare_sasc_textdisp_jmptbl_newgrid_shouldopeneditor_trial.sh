...
BASE="textdisp_jmptbl_newgrid_shouldopeneditor"
ENTRY_ORIG="TEXTDISP_JMPTBL_NEWGRID_ShouldOpenEditor"
ENTRY_SASC="TEXTDISP_JMPTBL_NEWGRID_ShouldOp"
TARGET="NEWGRID_ShouldOpenEditor"
mkdir -p "$OUT_DIR"
