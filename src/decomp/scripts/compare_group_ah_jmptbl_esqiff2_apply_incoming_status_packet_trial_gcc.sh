...
SRC_C="src/decomp/c/replacements/group_ah_jmptbl_esqiff2_apply_incoming_status_packet_gcc.c"
ORIG_ASM="src/modules/groups/a/h/xjump.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/group_ah_jmptbl_esqiff2_apply_incoming_status_packet.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/group_ah_jmptbl_esqiff2_apply_incoming_status_packet.original_slice.s"
GEN_SLICE="${OUT_DIR}/group_ah_jmptbl_esqiff2_apply_incoming_status_packet.generated_slice.s"
ORIG_NORM="${OUT_DIR}/group_ah_jmptbl_esqiff2_apply_incoming_status_packet.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/group_ah_jmptbl_esqiff2_apply_incoming_status_packet.generated_slice.norm.s"
...
awk -v start_label="GROUP_AH_JMPTBL_ESQIFF2_ApplyIncomingStatusPacket" -v next_label="GROUP_AH_JMPTBL_NEWGRID_RebuildIndexCache" '
...
awk '
$0 ~ /^_?GROUP_AH_JMPTBL_ESQIFF2_ApplyIncomingStatusPacket:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_group_ah_jmptbl_esqiff2_apply_incoming_status_packet.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_group_ah_jmptbl_esqiff2_apply_incoming_status_packet.awk" "$GEN_NORM" > "$GEN_SEM"
