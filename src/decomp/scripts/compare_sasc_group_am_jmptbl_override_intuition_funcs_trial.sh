...
BASE="group_am_jmptbl_override_intuition_funcs"
ENTRY_ORIG="GROUP_AM_JMPTBL_OVERRIDE_INTUITION_FUNCS"
ENTRY_SASC="GROUP_AM_JMPTBL_OVERRIDE_INTUITI"
TARGET="OVERRIDE_INTUITION_FUNCS"
mkdir -p "$OUT_DIR"
