...
SASC_SRC="esqshared4_program_display_window_and_copper.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_program_display_window_and_copper"
ENTRY="ESQSHARED4_ProgramDisplayWindowAndCopper"
ENTRY_SASC_REGEX="^ESQSHARED4_ProgramDisplayWindowA[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_program_display_window_and_copper.awk \
