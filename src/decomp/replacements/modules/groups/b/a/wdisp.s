;------------------------------------------------------------------------------
; DECOMP TARGETS WDISP weather-status helper module boundary
; SOURCE: modules/groups/b/a/wdisp.s
; PURPOSE:
;   Object-level hybrid replacement for the WDISP module now that the restored
;   SAS/C lane covers the current non-JMPTBL weather-status drawing, preview,
;   and refresh helpers. This replacement now carries the module body directly
;   instead of delegating back to the canonical asm include.
;------------------------------------------------------------------------------
