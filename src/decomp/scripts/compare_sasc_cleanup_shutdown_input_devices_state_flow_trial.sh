...
SASC_SRC="cleanup_shutdown_input_devices.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/b/cleanup.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="cleanup_shutdown_input_devices_state_flow"
ENTRY="CLEANUP_ShutdownInputDevices"
ENTRY_SASC_REGEX="^CLEANUP_ShutdownInputDevices[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_shutdown_input_devices_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_shutdown_input_devices_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
