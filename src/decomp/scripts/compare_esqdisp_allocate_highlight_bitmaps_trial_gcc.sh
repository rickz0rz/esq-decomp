...
SRC_C="src/decomp/c/replacements/esqdisp_allocate_highlight_bitmaps_gcc.c"
ORIG_ASM="src/modules/groups/a/n/esqdisp.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/esqdisp_allocate_highlight_bitmaps.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/esqdisp_allocate_highlight_bitmaps.original_slice.s"
GEN_SLICE="${OUT_DIR}/esqdisp_allocate_highlight_bitmaps.generated_slice.s"
ORIG_NORM="${OUT_DIR}/esqdisp_allocate_highlight_bitmaps.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/esqdisp_allocate_highlight_bitmaps.generated_slice.norm.s"
...
awk '$0 ~ /^ESQDISP_AllocateHighlightBitmaps:?$/ {in_func=1} in_func { if ($0 ~ /^;!======/) exit; print }' "$ORIG_ASM" > "$ORIG_SLICE"
awk '$0 ~ /^_?ESQDISP_AllocateHighlightBitmaps:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_esqdisp_allocate_highlight_bitmaps.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_esqdisp_allocate_highlight_bitmaps.awk "$GEN_NORM" > "$GEN_SEM"
