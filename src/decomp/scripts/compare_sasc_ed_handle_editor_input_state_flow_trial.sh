...
SASC_SRC="ed_handle_editor_input.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/k/ed.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed_handle_editor_input_state_flow"
ENTRY_ORIG="ED_HandleEditorInput"
ENTRY_SASC_REGEX="^ED_HandleEditorInput[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed_handle_editor_input_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed_handle_editor_input_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
