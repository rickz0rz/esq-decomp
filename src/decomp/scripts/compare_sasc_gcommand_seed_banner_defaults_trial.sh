...
SASC_SRC="gcommand_seed_banner_defaults.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_seed_banner_defaults"
ENTRY="GCOMMAND_SeedBannerDefaults"
ENTRY_SASC_REGEX="^GCOMMAND_SeedBannerDefaults[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_seed_banner_defaults.awk \
