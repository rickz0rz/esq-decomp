...

{
    ...
    if (n ~ /NEWGRID2JMPTBLESQTESTBIT1BASED/ || n ~ /NEWGRID2JMPTBLESQTESTBIT1BASE/) has_testbit=1
    if (n ~ /NEWGRID2JMPTBLDISPLIBFINDPREVIOUSVALIDENTRYINDEX/ || n ~ /NEWGRID2JMPTBLDISPLIBFINDPREVIOUSVALID/ || n ~ /NEWGRID2JMPTBLDISPLIBFINDPREV/) has_find_prev=1
