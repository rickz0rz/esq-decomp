...
SASC_SRC="script3_select_playback_cursor_from_search_text.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/script3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="script3_select_playback_cursor_from_search_text"
ENTRY="SCRIPT_SelectPlaybackCursorFromSearchText"
ENTRY_SASC_REGEX="^SCRIPT_SelectPlaybackCursorFromS[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_script3_select_playback_cursor_from_search_text.awk \
