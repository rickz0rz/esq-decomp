...
BASE="group_ad_jmptbl_dst_compute_banner_index"
ENTRY_ORIG="GROUP_AD_JMPTBL_DST_ComputeBannerIndex"
ENTRY_SASC="GROUP_AD_JMPTBL_DST_ComputeBanne"
TARGET="DST_ComputeBannerIndex"
mkdir -p "$OUT_DIR"
