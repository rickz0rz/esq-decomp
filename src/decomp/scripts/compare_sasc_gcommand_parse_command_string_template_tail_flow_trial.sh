...
BASE="gcommand_parse_command_string_template_tail_flow"
ENTRY_ORIG="GCOMMAND_ParseCommandString"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_parse_command_string_template_tail_flow.awk \
