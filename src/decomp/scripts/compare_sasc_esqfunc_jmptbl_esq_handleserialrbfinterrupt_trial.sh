...
BASE="esqfunc_jmptbl_esq_handleserialrbfinterrupt"
ENTRY_ORIG="ESQFUNC_JMPTBL_ESQ_HandleSerialRbfInterrupt"
ENTRY_SASC="ESQFUNC_JMPTBL_ESQ_HandleSerialR"
TARGET="ESQ_HandleSerialRbfInterrupt"
mkdir -p "$OUT_DIR"
