...
BASE="newgrid2_jmptbl_esq_gethalfhourslotindex"
ENTRY_ORIG="NEWGRID2_JMPTBL_ESQ_GetHalfHourSlotIndex"
ENTRY_SASC="NEWGRID2_JMPTBL_ESQ_GetHalfHourS"
TARGET="ESQ_GetHalfHourSlotIndex"
mkdir -p "$OUT_DIR"
