...
BASE="esqpars_jmptbl_diskio_saveconfigtofilehandle"
ENTRY_ORIG="ESQPARS_JMPTBL_DISKIO_SaveConfigToFileHandle"
ENTRY_SASC="ESQPARS_JMPTBL_DISKIO_SaveConfig"
TARGET="DISKIO_SaveConfigToFileHandle"
mkdir -p "$OUT_DIR"
