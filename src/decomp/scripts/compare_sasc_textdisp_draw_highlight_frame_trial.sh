...
SASC_SRC="textdisp_draw_highlight_frame.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_draw_highlight_frame"
ENTRY="TEXTDISP_DrawHighlightFrame"
ENTRY_SASC_REGEX="^TEXTDISP_DrawHighlightFr[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_draw_highlight_frame.awk \
