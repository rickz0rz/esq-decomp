...

{
    ...
    if (uline ~ /ESQSHARED4_TICKCOPPERANDBANNERTRANSITIONS/ || uline ~ /ESQSHARED4_TICKCOPPERANDBANNERTR/) has_call_tick_copper = 1
    ...
    if (uline ~ /TEXTDISP_DEFERREDACTIONDELAYTICKS/ || uline ~ /TEXTDISP_DEFERREDACTIONDELAYTICK/) has_deferred_delay = 1
    ...
    if (uline ~ /ESQIFF_SERVICEPENDINGCOPPERPALETTEMOVES/ || uline ~ /ESQIFF_SERVICEPENDINGCOPPERPALET/) has_call_flush = 1
}
