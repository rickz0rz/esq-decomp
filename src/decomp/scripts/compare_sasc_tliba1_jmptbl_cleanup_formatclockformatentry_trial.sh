...
BASE="tliba1_jmptbl_cleanup_formatclockformatentry"
ENTRY_ORIG="TLIBA1_JMPTBL_CLEANUP_FormatClockFormatEntry"
ENTRY_SASC="TLIBA1_JMPTBL_CLEANUP_FormatCloc"
TARGET="CLEANUP_FormatClockFormatEntry"
mkdir -p "$OUT_DIR"
