...
BASE="newgrid2_jmptbl_disptext_iscurrentlinelast"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_IsCurrentLineLast"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_IsCurre"
TARGET="DISPTEXT_IsCurrentLineLast"
mkdir -p "$OUT_DIR"
