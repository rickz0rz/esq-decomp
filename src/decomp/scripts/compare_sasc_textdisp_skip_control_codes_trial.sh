...
SASC_SRC="textdisp_skip_control_codes.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_skip_control_codes"
ENTRY="TEXTDISP_SkipControlCodes"
ENTRY_SASC_REGEX="^TEXTDISP_SkipControlCod[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_skip_control_codes.awk \
