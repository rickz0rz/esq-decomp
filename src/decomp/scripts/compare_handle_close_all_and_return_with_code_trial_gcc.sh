...
SRC_C="src/decomp/c/replacements/handle_close_all_and_return_with_code_gcc.c"
ORIG_ASM="src/modules/submodules/unknown32.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/handle_close_all_and_return_with_code.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/handle_close_all_and_return_with_code.original_slice.s"
GEN_SLICE="${OUT_DIR}/handle_close_all_and_return_with_code.generated_slice.s"
ORIG_NORM="${OUT_DIR}/handle_close_all_and_return_with_code.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/handle_close_all_and_return_with_code.generated_slice.norm.s"
...
awk '
$0 ~ /^_?HANDLE_CloseAllAndReturnWithCode:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_handle_close_all_and_return_with_code.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_handle_close_all_and_return_with_code.awk "$GEN_NORM" > "$GEN_SEM"
