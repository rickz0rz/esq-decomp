...
BASE="group_ak_jmptbl_script_assert_ctrl_line_now"
ENTRY_ORIG="GROUP_AK_JMPTBL_SCRIPT_AssertCtrlLineNow"
ENTRY_SASC="GROUP_AK_JMPTBL_SCRIPT_AssertCtr"
TARGET="SCRIPT_AssertCtrlLineNow"
mkdir -p "$OUT_DIR"
