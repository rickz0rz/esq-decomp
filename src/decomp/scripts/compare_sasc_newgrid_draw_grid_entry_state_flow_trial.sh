...
BASE="newgrid_draw_grid_entry_state_flow"
ENTRY="NEWGRID_DrawGridEntry"
...
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_draw_grid_entry_state_flow.awk \
