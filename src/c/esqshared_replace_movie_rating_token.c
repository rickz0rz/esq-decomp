/* RESTORES: ESQSHARED_ReplaceMovieRatingToken
 * MODULE:   modules/groups/a/p/esqshared.s
 * STATUS:   behavioural
 *
 * Scans the string for each of the seven movie-rating words in turn, and on the
...
void ESQSHARED_ReplaceMovieRatingToken(char *s)
{
    char *hit;
    char *rest;
    long tail;
