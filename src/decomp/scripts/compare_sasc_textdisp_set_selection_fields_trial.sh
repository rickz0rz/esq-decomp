...
SASC_SRC="textdisp_set_selection_fields.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_set_selection_fields"
ENTRY="TEXTDISP_SetSelectionFields"
ENTRY_SASC_REGEX="^TEXTDISP_SetSelectionFields[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_set_selection_fields.awk \
