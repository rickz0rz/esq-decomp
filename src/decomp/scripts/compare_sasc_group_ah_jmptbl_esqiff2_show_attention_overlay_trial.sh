...
BASE="group_ah_jmptbl_esqiff2_show_attention_overlay"
ENTRY_ORIG="GROUP_AH_JMPTBL_ESQIFF2_ShowAttentionOverlay"
ENTRY_SASC="GROUP_AH_JMPTBL_ESQIFF2_ShowAtte"
TARGET="ESQIFF2_ShowAttentionOverlay"
mkdir -p "$OUT_DIR"
