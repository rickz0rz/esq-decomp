...
BASE="group_ad_jmptbl_graphics_blt_bitmap_rast_port"
ENTRY_ORIG="GROUP_AD_JMPTBL_GRAPHICS_BltBitMapRastPort"
ENTRY_SASC="GROUP_AD_JMPTBL_GRAPHICS_BltBitM"
TARGET="GRAPHICS_BltBitMapRastPort"
mkdir -p "$OUT_DIR"
