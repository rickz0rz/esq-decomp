...
- Current strict sweep coverage includes core string/memory/index lanes plus APP2/Unknown42 foundational stubs (`ESQ_NoOp*`, `ESQ_ShutdownAndReturn`, `ESQ_ReturnWithStackCode`, entry/exit noop hooks, `CLOCK_CheckDateOrSecondsFromEpoch`, `CLOCK_SecondsFromEpoch`, and core `PARALLEL_*` formatting lanes).
