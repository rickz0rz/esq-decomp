...
BASE="newgrid2_jmptbl_parse_readsignedlongskipclass3_alt"
ENTRY_ORIG="NEWGRID2_JMPTBL_PARSE_ReadSignedLongSkipClass3_Alt"
ENTRY_SASC="NEWGRID2_JMPTBL_PARSE_ReadSigned"
TARGET="PARSE_ReadSignedLongSkipClass3_Alt"
mkdir -p "$OUT_DIR"
