...
cd "$ROOT_DIR"
SASC_SRC="parseini_jmptbl_ed1_wait_for_flag_and_clear_bit1.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/parseini.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="parseini_jmptbl_ed1_waitforflagandclearbit1"
ENTRY_ORIG="PARSEINI_JMPTBL_ED1_WaitForFlagAndClearBit1"
ENTRY_SASC="PARSEINI_JMPTBL_ED1_WaitForFlagA"
TARGET="ED1_WaitForFlagAndClearBit1"
mkdir -p "$OUT_DIR"
