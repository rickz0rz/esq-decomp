...
SRC_C="src/decomp/c/replacements/group_ak_jmptbl_esq_set_copper_effect_all_on_gcc.c"
ORIG_ASM="src/modules/groups/a/k/xjump2.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/group_ak_jmptbl_esq_set_copper_effect_all_on.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/group_ak_jmptbl_esq_set_copper_effect_all_on.original_slice.s"
GEN_SLICE="${OUT_DIR}/group_ak_jmptbl_esq_set_copper_effect_all_on.generated_slice.s"
ORIG_NORM="${OUT_DIR}/group_ak_jmptbl_esq_set_copper_effect_all_on.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/group_ak_jmptbl_esq_set_copper_effect_all_on.generated_slice.norm.s"
...
awk -v start_label="GROUP_AK_JMPTBL_ESQ_SetCopperEffect_AllOn" -v next_label="GROUP_AK_JMPTBL_SCRIPT_AssertCtrlLineNow" '
...
awk '$0 ~ /^_?GROUP_AK_JMPTBL_ESQ_SetCopperEffect_AllOn:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_group_ak_jmptbl_esq_set_copper_effect_all_on.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_group_ak_jmptbl_esq_set_copper_effect_all_on.awk" "$GEN_NORM" > "$GEN_SEM"
