...
SASC_SRC="textdisp_reset_selection_state.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_reset_selection_state"
ENTRY="TEXTDISP_ResetSelectionState"
ENTRY_SASC_REGEX="^TEXTDISP_ResetSelectionState[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_reset_selection_state.awk \
