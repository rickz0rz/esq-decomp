...
BASE="wdisp_jmptbl_esqiff_renderweatherstatusbrushslice"
ENTRY_ORIG="WDISP_JMPTBL_ESQIFF_RenderWeatherStatusBrushSlice"
ENTRY_SASC="WDISP_JMPTBL_ESQIFF_RenderWeathe"
TARGET="ESQIFF_RenderWeatherStatusBrushSlice"
mkdir -p "$OUT_DIR"
