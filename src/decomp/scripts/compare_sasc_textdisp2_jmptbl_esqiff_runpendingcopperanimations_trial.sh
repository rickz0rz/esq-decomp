...
BASE="textdisp2_jmptbl_esqiff_runpendingcopperanimations"
ENTRY_ORIG="TEXTDISP2_JMPTBL_ESQIFF_RunPendingCopperAnimations"
ENTRY_SASC="TEXTDISP2_JMPTBL_ESQIFF_RunPendi"
TARGET="ESQIFF_RunPendingCopperAnimations"
mkdir -p "$OUT_DIR"
