...
SASC_SRC="textdisp_should_open_editor_for_entry.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_should_open_editor_for_entry"
ENTRY="TEXTDISP_ShouldOpenEditorForEntry"
ENTRY_SASC_REGEX="^TEXTDISP_ShouldOpenEditorForEnt[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_should_open_editor_for_entry.awk \
