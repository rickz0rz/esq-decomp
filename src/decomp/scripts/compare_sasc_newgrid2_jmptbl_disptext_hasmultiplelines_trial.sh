...
BASE="newgrid2_jmptbl_disptext_hasmultiplelines"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_HasMultipleLines"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_HasMult"
TARGET="DISPTEXT_HasMultipleLines"
mkdir -p "$OUT_DIR"
