...
BASE="newgrid_jmptbl_disptext_initbuffers"
ENTRY_ORIG="NEWGRID_JMPTBL_DISPTEXT_InitBuffers"
ENTRY_SASC="NEWGRID_JMPTBL_DISPTEXT_InitBuff"
TARGET="DISPTEXT_InitBuffers"
mkdir -p "$OUT_DIR"
