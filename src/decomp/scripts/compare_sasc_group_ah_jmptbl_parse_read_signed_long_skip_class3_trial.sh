...
BASE="group_ah_jmptbl_parse_read_signed_long_skip_class3"
ENTRY_ORIG="GROUP_AH_JMPTBL_PARSE_ReadSignedLongSkipClass3"
ENTRY_SASC="GROUP_AH_JMPTBL_PARSE_ReadSigned"
TARGET="PARSE_ReadSignedLongSkipClass3"
mkdir -p "$OUT_DIR"
