...
BASE="esqfunc_jmptbl_locavail_syncsecondaryfilterforcurrentgroup"
ENTRY_ORIG="ESQFUNC_JMPTBL_LOCAVAIL_SyncSecondaryFilterForCurrentGroup"
ENTRY_SASC="ESQFUNC_JMPTBL_LOCAVAIL_SyncSeco"
TARGET="LOCAVAIL_SyncSecondaryFilterForCurrentGroup"
mkdir -p "$OUT_DIR"
