...
SASC_SRC="esqshared_normalize_in_stereo_tag.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/p/esqshared.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared_normalize_in_stereo_tag"
ENTRY="ESQSHARED_NormalizeInStereoTag"
ENTRY_SASC_REGEX="^ESQSHARED_NormalizeInStereoTag[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared_normalize_in_stereo_tag.awk \
