...
SASC_SRC="esqdisp_update_status_mask_and_refresh_return.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqdisp_update_status_mask_and_refresh_return"
ENTRY_ORIG="ESQDISP_UpdateStatusMaskAndRefresh_Return"
ENTRY_SASC_REGEX="^ESQDISP_UpdateStatusMaskAndRefre[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_update_status_mask_and_refresh_return.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_update_status_mask_and_refresh_return.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
