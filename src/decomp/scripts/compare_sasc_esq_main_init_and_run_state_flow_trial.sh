...
SASC_SRC="esq_main_init_and_run.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/m/esq.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esq_main_init_and_run_state_flow"
ENTRY="ESQ_MainInitAndRun"
ENTRY_SASC_REGEX="^ESQ_MainInitAndRun[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esq_main_init_and_run_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esq_main_init_and_run_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
