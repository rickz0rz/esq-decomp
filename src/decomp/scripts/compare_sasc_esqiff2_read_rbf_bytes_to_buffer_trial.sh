...
SASC_SRC="esqiff2_read_rbf_bytes_to_buffer.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_read_rbf_bytes_to_buffer"
ENTRY="ESQIFF2_ReadRbfBytesToBuffer"
ENTRY_SASC_REGEX="^ESQIFF2_ReadRbfBytesToBuffe[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_read_rbf_bytes_to_buffer.awk \
