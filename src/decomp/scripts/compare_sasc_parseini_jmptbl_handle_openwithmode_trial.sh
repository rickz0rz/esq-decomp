...
BASE="parseini_jmptbl_handle_openwithmode"
ENTRY_ORIG="PARSEINI_JMPTBL_HANDLE_OpenWithMode"
ENTRY_SASC="PARSEINI_JMPTBL_HANDLE_OpenWithM"
TARGET="HANDLE_OpenWithMode"
mkdir -p "$OUT_DIR"
