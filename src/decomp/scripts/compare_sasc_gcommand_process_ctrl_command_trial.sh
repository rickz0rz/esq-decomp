...
SASC_SRC="gcommand_process_ctrl_command.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/v/gcommand5.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_process_ctrl_command"
ENTRY="GCOMMAND_ProcessCtrlCommand"
ENTRY_SASC_REGEX="^GCOMMAND_ProcessCtrlCommand[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_process_ctrl_command.awk \
