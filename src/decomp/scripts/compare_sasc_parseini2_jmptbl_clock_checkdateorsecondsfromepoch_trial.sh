...
BASE="parseini2_jmptbl_clock_checkdateorsecondsfromepoch"
ENTRY_ORIG="PARSEINI2_JMPTBL_CLOCK_CheckDateOrSecondsFromEpoch"
ENTRY_SASC="PARSEINI2_JMPTBL_CLOCK_CheckDate"
TARGET="CLOCK_CheckDateOrSecondsFromEpoch"
mkdir -p "$OUT_DIR"
