...

{
    ...
    if (n ~ /SCRIPT3JMPTBLESQSETCOPPEREFFECTCUSTOM/ || n ~ /SCRIPT3JMPTBLESQSETCOPPEREFF/) has_custom_copper = 1
    if (n ~ /SCRIPT3JMPTBLCLEANUPRENDERALIGNEDSTATUSSCREEN/ || n ~ /SCRIPT3JMPTBLCLEANUPRENDERALIGNEDSTAT/ || n ~ /SCRIPT3JMPTBLCLEANUPRENDERALI/) has_render_aligned = 1
