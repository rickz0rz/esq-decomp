...
SASC_SRC="esq_packbits_decode.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/a/app2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esq_packbits_decode"
ENTRY="ESQ_PackBitsDecode"
ENTRY_SASC_REGEX="^ESQ_PackBitsDecode[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_esq_pack_bits_decode.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_esq_pack_bits_decode.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
