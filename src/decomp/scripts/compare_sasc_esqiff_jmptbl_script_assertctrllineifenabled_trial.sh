...
cd "$ROOT_DIR"
SASC_SRC="esqiff_jmptbl_stubs_f.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_jmptbl_script_assertctrllineifenabled"
ENTRY_ORIG="ESQIFF_JMPTBL_SCRIPT_AssertCtrlLineIfEnabled"
ENTRY_SASC="ESQIFF_JMPTBL_SCRIPT_AssertCtrlL"
TARGET="SCRIPT_AssertCtrlLineIfEnabled"
mkdir -p "$OUT_DIR"
