...
SASC_SRC="script3_clear_search_texts_and_channels.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/script3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="script3_clear_search_texts_and_channels"
ENTRY="SCRIPT_ClearSearchTextsAndChannels"
ENTRY_SASC_REGEX="^SCRIPT_ClearSearchTextsAndChan[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_script3_clear_search_texts_and_channels.awk \
