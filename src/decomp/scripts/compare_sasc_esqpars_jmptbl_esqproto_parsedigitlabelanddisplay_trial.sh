...
BASE="esqpars_jmptbl_esqproto_parsedigitlabelanddisplay"
ENTRY_ORIG="ESQPARS_JMPTBL_ESQPROTO_ParseDigitLabelAndDisplay"
ENTRY_SASC="ESQPARS_JMPTBL_ESQPROTO_ParseDig"
TARGET="ESQPROTO_ParseDigitLabelAndDisplay"
mkdir -p "$OUT_DIR"
