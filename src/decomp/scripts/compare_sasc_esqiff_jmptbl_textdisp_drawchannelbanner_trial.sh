...
BASE="esqiff_jmptbl_textdisp_drawchannelbanner"
ENTRY_ORIG="ESQIFF_JMPTBL_TEXTDISP_DrawChannelBanner"
ENTRY_SASC="ESQIFF_JMPTBL_TEXTDISP_DrawChann"
TARGET="TEXTDISP_DrawChannelBanner"
mkdir -p "$OUT_DIR"
