...
BASE="group_au_jmptbl_brush_populate_brush_list"
ENTRY_ORIG="GROUP_AU_JMPTBL_BRUSH_PopulateBrushList"
ENTRY_SASC="GROUP_AU_JMPTBL_BRUSH_PopulateBr"
TARGET="BRUSH_PopulateBrushList"
