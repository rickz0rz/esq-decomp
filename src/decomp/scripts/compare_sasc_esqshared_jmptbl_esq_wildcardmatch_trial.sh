...
BASE="esqshared_jmptbl_esq_wildcardmatch"
ENTRY_ORIG="ESQSHARED_JMPTBL_ESQ_WildcardMatch"
ENTRY_SASC="ESQSHARED_JMPTBL_ESQ_WildcardMat"
TARGET="ESQ_WildcardMatch"
mkdir -p "$OUT_DIR"
