...
SASC_SRC="ed1_clear_esc_menu_mode.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/k/ed1.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed1_clear_esc_menu_mode"
ENTRY="ED1_ClearEscMenuMode"
ENTRY_SASC_REGEX="^ED1_ClearEscMenuMode[A-Za-z0-9_]*:$"
ENTRY_SEM="ED1_CLEARESCMENUMODE:"
ENTRY_ALT_SEM="ED1_CLEARESCMENUMODE"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_ed1_clear_esc_menu_mode.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_ed1_clear_esc_menu_mode.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
