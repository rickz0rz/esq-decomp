...
SRC_C="src/decomp/c/replacements/unknown32_jmptbl_esq_return_with_stack_code_gcc.c"
ORIG_ASM="src/modules/submodules/unknown32.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/unknown32_jmptbl_esq_return_with_stack_code.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/unknown32_jmptbl_esq_return_with_stack_code.original_slice.s"
GEN_SLICE="${OUT_DIR}/unknown32_jmptbl_esq_return_with_stack_code.generated_slice.s"
ORIG_NORM="${OUT_DIR}/unknown32_jmptbl_esq_return_with_stack_code.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/unknown32_jmptbl_esq_return_with_stack_code.generated_slice.norm.s"
...
awk '
$0 ~ /^UNKNOWN32_JMPTBL_ESQ_ReturnWithStackCode:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;!======/) {
        exit
    }
...
awk '
$0 ~ /^_?UNKNOWN32_JMPTBL_ESQ_ReturnWithStackCode:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_unknown32_jmptbl_esq_return_with_stack_code.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_unknown32_jmptbl_esq_return_with_stack_code.awk "$GEN_NORM" > "$GEN_SEM"
