...
BASE="esqiff_jmptbl_brush_findtype3brush"
ENTRY_ORIG="ESQIFF_JMPTBL_BRUSH_FindType3Brush"
ENTRY_SASC="ESQIFF_JMPTBL_BRUSH_FindType3Bru"
TARGET="BRUSH_FindType3Brush"
mkdir -p "$OUT_DIR"
