...
SASC_SRC="ed1_exit_esc_menu.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/k/ed1.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed1_exit_esc_menu"
ENTRY_ORIG="ED1_ExitEscMenu"
ENTRY_SASC_REGEX="^ED1_ExitEscMenu[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_exit_esc_menu.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_exit_esc_menu.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
