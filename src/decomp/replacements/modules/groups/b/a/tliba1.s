...
; PURPOSE:
;   Object-level hybrid replacement for the TLIBA1 module now that the restored
;   SAS/C lane covers the current non-JMPTBL formatted-text, clock-format, and
;   style parsing helpers. This replacement now carries the module body
