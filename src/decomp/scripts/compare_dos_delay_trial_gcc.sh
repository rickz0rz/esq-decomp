...
SRC_C="src/decomp/c/replacements/dos_delay_gcc.c"
ORIG_ASM="src/modules/submodules/unknown40.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/dos_delay.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/dos_delay.original_slice.s"
GEN_SLICE="${OUT_DIR}/dos_delay.generated_slice.s"
ORIG_NORM="${OUT_DIR}/dos_delay.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/dos_delay.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_dos_delay.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_dos_delay.awk "$GEN_NORM" > "$GEN_SEM"
