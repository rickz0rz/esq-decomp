...
BASE="esqpars_jmptbl_newgrid_rebuildindexcache"
ENTRY_ORIG="ESQPARS_JMPTBL_NEWGRID_RebuildIndexCache"
ENTRY_SASC="ESQPARS_JMPTBL_NEWGRID_RebuildIn"
TARGET="NEWGRID_RebuildIndexCache"
mkdir -p "$OUT_DIR"
