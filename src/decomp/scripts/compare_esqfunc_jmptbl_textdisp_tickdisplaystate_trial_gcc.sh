...
SRC_C="src/decomp/c/replacements/esqfunc_jmptbl_textdisp_tickdisplaystate_gcc.c"
ORIG_ASM="src/modules/groups/a/n/esqfunc.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/esqfunc_jmptbl_textdisp_tickdisplaystate.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/esqfunc_jmptbl_textdisp_tickdisplaystate.original_slice.s"
GEN_SLICE="${OUT_DIR}/esqfunc_jmptbl_textdisp_tickdisplaystate.generated_slice.s"
ORIG_NORM="${OUT_DIR}/esqfunc_jmptbl_textdisp_tickdisplaystate.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/esqfunc_jmptbl_textdisp_tickdisplaystate.generated_slice.norm.s"
...
awk -v start_label="ESQFUNC_JMPTBL_TEXTDISP_TickDisplayState" -v next_label="ESQFUNC_JMPTBL_ESQ_PollCtrlInput" '
...
awk -f "src/decomp/scripts/semantic_filter_esqfunc_jmptbl_textdisp_tickdisplaystate.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_esqfunc_jmptbl_textdisp_tickdisplaystate.awk" "$GEN_NORM" > "$GEN_SEM"
