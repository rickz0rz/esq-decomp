...
BASE="group_am_jmptbl_gcommand_resetbannerfadestate"
ENTRY_ORIG="GROUP_AM_JMPTBL_GCOMMAND_ResetBannerFadeState"
ENTRY_SASC="GROUP_AM_JMPTBL_GCOMMAND_ResetBa"
TARGET="GCOMMAND_ResetBannerFadeState"
mkdir -p "$OUT_DIR"
