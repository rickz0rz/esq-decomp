...
BASE="group_main_a_jmptbl_esq_main_exit_noop_hook"
ENTRY_ORIG="GROUP_MAIN_A_JMPTBL_ESQ_MainExitNoOpHook"
ENTRY_SASC="GROUP_MAIN_A_JMPTBL_ESQ_MainExit"
TARGET="ESQ_MainExitNoOpHook"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_MAIN_A_JMPTBL_ESQ_MainEntr:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
