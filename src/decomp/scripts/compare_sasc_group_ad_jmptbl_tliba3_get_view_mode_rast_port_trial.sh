...
cd "$ROOT_DIR"
SASC_SRC="group_ad_jmptbl_tliba3_get_view_mode_rast_port.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/d/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_ad_jmptbl_tliba3_get_view_mode_rast_port"
ENTRY_ORIG="GROUP_AD_JMPTBL_TLIBA3_GetViewModeRastPort"
ENTRY_SASC="GROUP_AD_JMPTBL_TLIBA3_GetViewMo"
TARGET="TLIBA3_GetViewModeRastPort"
mkdir -p "$OUT_DIR"
