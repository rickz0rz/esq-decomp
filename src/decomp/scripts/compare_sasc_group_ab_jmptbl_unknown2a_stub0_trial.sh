...
SASC_SRC="group_ab_jmptbl_unknown2a_stub0.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/b/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_ab_jmptbl_unknown2a_stub0"
ENTRY="GROUP_AB_JMPTBL_UNKNOWN2A_Stub0"
ENTRY_SASC_REGEX="^GROUP_AB_JMPTBL_UNKNOWN2A_Stub0[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_group_ab_jmptbl_unknown2a_stub0.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_group_ab_jmptbl_unknown2a_stub0.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
