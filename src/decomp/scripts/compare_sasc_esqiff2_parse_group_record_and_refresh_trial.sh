...
BASE="esqiff2_parse_group_record_and_refresh"
ENTRY="ESQIFF2_ParseGroupRecordAndRefresh"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_parse_group_record_and_refresh.awk \
