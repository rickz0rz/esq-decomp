...
BASE="esqpars_jmptbl_dst_handlebannercommand32_33"
ENTRY_ORIG="ESQPARS_JMPTBL_DST_HandleBannerCommand32_33"
ENTRY_SASC="ESQPARS_JMPTBL_DST_HandleBannerC"
TARGET="DST_HandleBannerCommand32_33"
mkdir -p "$OUT_DIR"
