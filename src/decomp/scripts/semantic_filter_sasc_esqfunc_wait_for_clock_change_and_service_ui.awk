...

{
    ...
    if (uline ~ /ESQFUNC_JMPTBL_PARSEINI_MONITORCLOCKCHANGE/ ||
        uline ~ /ESQFUNC_JMPTBL_PARSEINI_MONITORCLOC/ ||
        uline ~ /ESQFUNC_JMPTBL_PARSEINI_MONITORC/ ||
        uline ~ /PARSEINI_MONITORCLOCKCHANGE/ ||
        uline ~ /PARSEINI_MONITORCLOC/ ||
        uline ~ /PARSEINI_MONITORC/) has_monitor = 1
