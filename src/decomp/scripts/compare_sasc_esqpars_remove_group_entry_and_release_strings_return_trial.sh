...
BASE="esqpars_remove_group_entry_and_release_strings_return"
ENTRY="ESQPARS_RemoveGroupEntryAndReleaseStrings_Return"
ENTRY_SASC_REGEX="^ESQPARS_RemoveGroupEntryAndRelea[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQPARS_REMOVEGROUPENTRYANDRELEASESTRINGS_RETURN:"
ENTRY_ALT_SEM="ESQPARS_REMOVEGROUPENTRYANDRELEA:"
