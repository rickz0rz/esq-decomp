...
SRC_C="src/decomp/c/replacements/parseini_load_weather_strings_gcc.c"
ORIG_ASM="src/modules/groups/b/a/parseini.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/parseini_load_weather_strings.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/parseini_load_weather_strings.original_slice.s"
GEN_SLICE="${OUT_DIR}/parseini_load_weather_strings.generated_slice.s"
ORIG_NORM="${OUT_DIR}/parseini_load_weather_strings.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/parseini_load_weather_strings.generated_slice.norm.s"
...
awk -v start_label="PARSEINI_LoadWeatherStrings" -v next_label="PARSEINI_LoadWeatherMessageStrings" '
...
awk '$0 ~ /^_?PARSEINI_LoadWeatherStrings:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_parseini_load_weather_strings.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_parseini_load_weather_strings.awk" "$GEN_NORM" > "$GEN_SEM"
