...
SASC_SRC="gcommand_copy_gfx_to_work_if_available.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/t/gcommand2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_copy_gfx_to_work_if_available"
ENTRY="GCOMMAND_CopyGfxToWorkIfAvailable"
ENTRY_SASC_REGEX="^GCOMMAND_CopyGfxToWorkIfAvailab[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_copy_gfx_to_work_if_available.awk \
