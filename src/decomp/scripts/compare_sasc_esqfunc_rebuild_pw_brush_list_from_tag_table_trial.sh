...
SASC_SRC="esqfunc_rebuild_pw_brush_list_from_tag_table.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqfunc_rebuild_pw_brush_list_from_tag_table"
ENTRY_ORIG="ESQFUNC_RebuildPwBrushListFromTagTable"
ENTRY_SASC_REGEX="^ESQFUNC_RebuildPwBrushListFromTa[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqfunc_rebuild_pw_brush_list_from_tag_table.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqfunc_rebuild_pw_brush_list_from_tag_table.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
