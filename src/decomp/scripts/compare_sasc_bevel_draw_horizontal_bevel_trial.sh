...
SASC_SRC="bevel_draw_horizontal_bevel.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/a/bevel.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="bevel_draw_horizontal_bevel"
ENTRY="BEVEL_DrawHorizontalBevel"
ENTRY_SASC_REGEX="^BEVEL_DrawHorizontalBevel[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_bevel_draw_horizontal_bevel.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_bevel_draw_horizontal_bevel.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
