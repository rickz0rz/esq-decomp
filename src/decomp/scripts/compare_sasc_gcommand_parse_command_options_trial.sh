...
SASC_SRC="gcommand_parse_command_options.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/s/gcommand.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_parse_command_options"
ENTRY="GCOMMAND_ParseCommandOptions"
ENTRY_SASC_REGEX="^GCOMMAND_ParseCommandOptions[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_parse_command_options.awk \
