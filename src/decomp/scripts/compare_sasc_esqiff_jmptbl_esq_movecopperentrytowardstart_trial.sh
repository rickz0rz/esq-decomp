...
cd "$ROOT_DIR"
SASC_SRC="esqiff_jmptbl_stubs_c.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_jmptbl_esq_movecopperentrytowardstart"
ENTRY_ORIG="ESQIFF_JMPTBL_ESQ_MoveCopperEntryTowardStart"
ENTRY_SASC="ESQIFF_JMPTBL_ESQ_MoveCopperEntr"
TARGET="ESQ_MoveCopperEntryTowardStart"
mkdir -p "$OUT_DIR"
