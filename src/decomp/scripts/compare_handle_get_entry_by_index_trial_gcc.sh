...
SRC_C="src/decomp/c/replacements/handle_get_entry_by_index_gcc.c"
ORIG_ASM="src/modules/submodules/unknown23.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/handle_get_entry_by_index.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/handle_get_entry_by_index.original_slice.s"
GEN_SLICE="${OUT_DIR}/handle_get_entry_by_index.generated_slice.s"
ORIG_NORM="${OUT_DIR}/handle_get_entry_by_index.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/handle_get_entry_by_index.generated_slice.norm.s"
...
awk '
$0 ~ /^HANDLE_GetEntryByIndex:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;!======/) {
        exit
    }
...
awk '
$0 ~ /^_?HANDLE_GetEntryByIndex:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_handle_get_entry_by_index.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_handle_get_entry_by_index.awk "$GEN_NORM" > "$GEN_SEM"
