...
BASE="group_ah_jmptbl_locavail_save_availability_data_file"
ENTRY_ORIG="GROUP_AH_JMPTBL_LOCAVAIL_SaveAvailabilityDataFile"
ENTRY_SASC="GROUP_AH_JMPTBL_LOCAVAIL_SaveAva"
