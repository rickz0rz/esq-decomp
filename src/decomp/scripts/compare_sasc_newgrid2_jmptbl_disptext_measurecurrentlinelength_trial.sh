...
BASE="newgrid2_jmptbl_disptext_measurecurrentlinelength"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_MeasureCurrentLineLength"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_Measure"
TARGET="DISPTEXT_MeasureCurrentLineLength"
mkdir -p "$OUT_DIR"
