    XDEF    _ED_DrawAdNumberPrompt


; enter ad number prompt
;------------------------------------------------------------------------------
; FUNC: _ED_DrawAdNumberPrompt   (Draw ad number promptuncertain)
; ARGS:
;   (none)
; RET:
;   (none)
...
; WRITES:
;   _ED_EditCursorOffset, _ED_AdNumberPromptStateBlock
; DESC:
...
_ED_DrawAdNumberPrompt:
    ...
    PEA     _Global_STR_ENTER_AD_NUMBER_ONE_HYPHEN
    PEA     330.W
    PEA     40.W
    ...
    PEA     _Global_STR_LEFT_PARENTHESIS_THEN
    PEA     330.W
    PEA     370.W
    MOVE.L  _Global_REF_RASTPORT_1,-(A7)
    JSR     _DISPLIB_DisplayTextAtPosition(PC)

    PEA     _Global_STR_PUSH_RETURN_TO_ENTER_SELECTION_2
    PEA     360.W
    PEA     40.W
    MOVE.L  _Global_REF_RASTPORT_1,-(A7)
    JSR     _DISPLIB_DisplayTextAtPosition(PC)
    ...
    LEA     80(A7),A7
    PEA     _Global_STR_SINGLE_SPACE_4
    PEA     390.W
    PEA     40.W
    MOVE.L  _Global_REF_RASTPORT_1,-(A7)
    JSR     _DISPLIB_DisplayTextAtPosition(PC)
    ...
    PEA     _Global_STR_AD_NUMBER_QUESTIONMARK
    PEA     90.W
    PEA     40.W
    MOVE.L  _Global_REF_RASTPORT_1,-(A7)
    JSR     _DISPLIB_DisplayTextAtPosition(PC)
...
.init_entry_done:
    CLR.B   _ED_AdNumberPromptStateBlock
