...
BASE="esqiff2_validate_field_index_and_length_return"
ENTRY="ESQIFF2_ValidateFieldIndexAndLength_Return"
ENTRY_SASC_REGEX="^ESQIFF2_ValidateFieldIndexAndLen[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_VALIDATEFIELDINDEXANDLENGTH_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_VALIDATEFIELDINDEXANDLEN"
