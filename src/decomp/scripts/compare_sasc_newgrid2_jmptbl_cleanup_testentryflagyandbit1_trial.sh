...
BASE="newgrid2_jmptbl_cleanup_testentryflagyandbit1"
ENTRY_ORIG="NEWGRID2_JMPTBL_CLEANUP_TestEntryFlagYAndBit1"
ENTRY_SASC="NEWGRID2_JMPTBL_CLEANUP_TestEntr"
TARGET="CLEANUP_TestEntryFlagYAndBit1"
mkdir -p "$OUT_DIR"
