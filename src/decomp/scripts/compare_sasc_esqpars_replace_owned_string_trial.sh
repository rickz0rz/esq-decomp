...
SASC_SRC="esqpars_replace_owned_string.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqpars.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqpars_replace_owned_string"
ENTRY="ESQPARS_ReplaceOwnedString"
ENTRY_SASC_REGEX="^ESQPARS_ReplaceOwnedString[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqpars_replace_owned_string.awk \
