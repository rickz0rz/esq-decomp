...
BASE="script2_jmptbl_esq_readserialrbfbyte"
ENTRY_ORIG="SCRIPT2_JMPTBL_ESQ_ReadSerialRbfByte"
ENTRY_SASC="SCRIPT2_JMPTBL_ESQ_ReadSerialRbf"
TARGET="ESQ_ReadSerialRbfByte"
mkdir -p "$OUT_DIR"
