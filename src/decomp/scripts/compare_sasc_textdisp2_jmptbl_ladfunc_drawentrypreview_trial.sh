...
BASE="textdisp2_jmptbl_ladfunc_drawentrypreview"
ENTRY_ORIG="TEXTDISP2_JMPTBL_LADFUNC_DrawEntryPreview"
ENTRY_SASC="TEXTDISP2_JMPTBL_LADFUNC_DrawEnt"
TARGET="LADFUNC_DrawEntryPreview"
mkdir -p "$OUT_DIR"
