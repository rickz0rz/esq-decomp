...
BASE="wdisp_jmptbl_newgrid_drawwrappedtext"
ENTRY_ORIG="WDISP_JMPTBL_NEWGRID_DrawWrappedText"
ENTRY_SASC="WDISP_JMPTBL_NEWGRID_DrawWrapped"
TARGET="NEWGRID_DrawWrappedText"
mkdir -p "$OUT_DIR"
