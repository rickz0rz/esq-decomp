...
SASC_SRC="group_at_jmptbl_ed1_wait_for_flag_and_clear_bit1.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/t/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_at_jmptbl_ed1_wait_for_flag_and_clear_bit1"
ENTRY_ORIG="GROUP_AT_JMPTBL_ED1_WaitForFlagAndClearBit1"
