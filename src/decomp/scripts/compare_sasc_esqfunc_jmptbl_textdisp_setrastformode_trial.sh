...
BASE="esqfunc_jmptbl_textdisp_setrastformode"
ENTRY_ORIG="ESQFUNC_JMPTBL_TEXTDISP_SetRastForMode"
ENTRY_SASC="ESQFUNC_JMPTBL_TEXTDISP_SetRastF"
TARGET="TEXTDISP_SetRastForMode"
mkdir -p "$OUT_DIR"
