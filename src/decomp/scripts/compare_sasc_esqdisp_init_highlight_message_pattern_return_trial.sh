...
SASC_SRC="esqdisp_init_highlight_message_pattern_return.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqdisp_init_highlight_message_pattern_return"
ENTRY_ORIG="ESQDISP_InitHighlightMessagePattern_Return"
ENTRY_SASC_REGEX="^ESQDISP_InitHighlightMessagePat[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_init_highlight_message_pattern_return.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_init_highlight_message_pattern_return.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
