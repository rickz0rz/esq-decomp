...
BASE="newgrid2_jmptbl_disptext_setlayoutparams"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_SetLayoutParams"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_SetLayo"
TARGET="DISPTEXT_SetLayoutParams"
mkdir -p "$OUT_DIR"
