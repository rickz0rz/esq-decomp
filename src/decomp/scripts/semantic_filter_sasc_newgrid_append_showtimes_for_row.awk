BEGIN{h_entry=0;h_field_select=0;h_elig=0;h_timefmt=0;h_preset=0;h_bit_test=0;h_cmp=0;h_skip=0;h_append=0;h_sep=0;h_setbit=0;h_fallback=0;h_title_ptr=0;h_prefix_skip=0;h_bit7_skip=0;h_rts=0}
function t(s, x){x=s;sub(/;.*/,"",x);sub(/^[ \t]+/,"",x);sub(/[ \t]+$/,"",x);gsub(/[ \t]+/," ",x);return toupper(x)}
{
    ...
    if(l ~ /BTST[ \t]+#\\$?7/ || l ~ /& 0X80/)h_bit7_skip=1
