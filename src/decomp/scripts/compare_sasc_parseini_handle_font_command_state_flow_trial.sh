...
BASE="parseini_handle_font_command_state_flow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_parseini_handle_font_command_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_parseini_handle_font_command_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
