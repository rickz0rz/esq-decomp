...
SASC_SRC="esqfunc_draw_memory_status_screen.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqfunc_draw_memory_status_screen"
ENTRY_ORIG="ESQFUNC_DrawMemoryStatusScreen"
ENTRY_SASC_REGEX="^ESQFUNC_DrawMemoryStatus[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_esqfunc_draw_memory_status_screen.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqfunc_draw_memory_status_screen.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
