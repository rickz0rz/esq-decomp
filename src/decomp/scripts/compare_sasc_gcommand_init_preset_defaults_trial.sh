...
SASC_SRC="gcommand_init_preset_defaults.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_init_preset_defaults"
ENTRY="GCOMMAND_InitPresetDefaults"
ENTRY_SASC_REGEX="^GCOMMAND_InitPresetD[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_init_preset_defaults.awk \
