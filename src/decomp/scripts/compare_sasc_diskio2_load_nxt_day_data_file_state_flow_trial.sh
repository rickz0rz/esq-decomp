...
BASE="diskio2_load_nxt_day_data_file_state_flow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio2_load_nxt_day_data_file_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_diskio2_load_nxt_day_data_file_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
