...
BASE="wdisp_jmptbl_brush_selectbrushslot"
ENTRY_ORIG="WDISP_JMPTBL_BRUSH_SelectBrushSlot"
ENTRY_SASC="WDISP_JMPTBL_BRUSH_SelectBrushSl"
TARGET="BRUSH_SelectBrushSlot"
mkdir -p "$OUT_DIR"
