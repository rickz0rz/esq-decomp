...
BASE="parseini_jmptbl_diskio_consumelinefromworkbuffer"
ENTRY_ORIG="PARSEINI_JMPTBL_DISKIO_ConsumeLineFromWorkBuffer"
ENTRY_SASC="PARSEINI_JMPTBL_DISKIO_ConsumeLi"
TARGET="DISKIO_ConsumeLineFromWorkBuffer"
mkdir -p "$OUT_DIR"
