...
SASC_SRC="ladfunc_set_packed_pen_low_nibble.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_set_packed_pen_low_nibble"
ENTRY="LADFUNC_SetPackedPenLowNibble"
ENTRY_SASC_REGEX="^LADFUNC_SetPackedPenLowNibb[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_set_packed_pen_low_nibble.awk \
