...
BASE="group_ak_jmptbl_textdisp_format_entry_time_for_index"
ENTRY_ORIG="GROUP_AK_JMPTBL_TEXTDISP_FormatEntryTimeForIndex"
ENTRY_SASC="GROUP_AK_JMPTBL_TEXTDISP_FormatE"
TARGET="TEXTDISP_FormatEntryTimeForIndex"
mkdir -p "$OUT_DIR"
