...
BASE="esqpars_jmptbl_ladfunc_savetextadstofile"
ENTRY_ORIG="ESQPARS_JMPTBL_LADFUNC_SaveTextAdsToFile"
ENTRY_SASC="ESQPARS_JMPTBL_LADFUNC_SaveTextA"
TARGET="LADFUNC_SaveTextAdsToFile"
mkdir -p "$OUT_DIR"
