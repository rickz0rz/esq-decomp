...
BASE="esqpars_jmptbl_parse_readsignedlongskipclass3_alt"
ENTRY_ORIG="ESQPARS_JMPTBL_PARSE_ReadSignedLongSkipClass3_Alt"
ENTRY_SASC="ESQPARS_JMPTBL_PARSE_ReadSignedL"
