...
SRC_C="src/decomp/c/replacements/get_bit_4_of_ciab_pra_into_d1_gcc.c"
ORIG_ASM="src/modules/groups/a/a/app.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/get_bit_4_of_ciab_pra_into_d1.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/get_bit_4_of_ciab_pra_into_d1.original_slice.s"
GEN_SLICE="${OUT_DIR}/get_bit_4_of_ciab_pra_into_d1.generated_slice.s"
ORIG_NORM="${OUT_DIR}/get_bit_4_of_ciab_pra_into_d1.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/get_bit_4_of_ciab_pra_into_d1.generated_slice.norm.s"
...
awk '$0 ~ /^GET_BIT_4_OF_CIAB_PRA_INTO_D1:?$/ {in_func=1} in_func { if ($0 ~ /^;!======/) exit; print }' "$ORIG_ASM" > "$ORIG_SLICE"
awk '$0 ~ /^_?GET_BIT_4_OF_CIAB_PRA_INTO_D1:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_get_bit_4_of_ciab_pra_into_d1.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_get_bit_4_of_ciab_pra_into_d1.awk "$GEN_NORM" > "$GEN_SEM"
