...
BASE="esqpars_jmptbl_esq_seedminuteeventthresholds"
ENTRY_ORIG="ESQPARS_JMPTBL_ESQ_SeedMinuteEventThresholds"
ENTRY_SASC="ESQPARS_JMPTBL_ESQ_SeedMinuteEve"
TARGET="ESQ_SeedMinuteEventThresholds"
mkdir -p "$OUT_DIR"
