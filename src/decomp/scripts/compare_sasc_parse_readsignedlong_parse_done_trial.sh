...
BASE="parse_readsignedlong_parse_done"
ENTRY="PARSE_ReadSignedLong_ParseDone"
ENTRY_SASC_REGEX="^PARSE_ReadSignedLong_ParseDone[A-Za-z0-9_]*:$"
...
awk -v ENTRY="$ENTRY" -f src/decomp/scripts/semantic_filter_parse_readsignedlong_parse_done.awk \
