...
BASE="newgrid_jmptbl_str_copyuntilanydelimn"
ENTRY_ORIG="NEWGRID_JMPTBL_STR_CopyUntilAnyDelimN"
ENTRY_SASC="NEWGRID_JMPTBL_STR_CopyUntilAnyD"
TARGET="STR_CopyUntilAnyDelimN"
mkdir -p "$OUT_DIR"
