...
SRC_C="src/decomp/c/replacements/parseini_jmptbl_diskio_loadfiletoworkbuffer_gcc.c"
ORIG_ASM="src/modules/groups/b/a/parseini.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/parseini_jmptbl_diskio_loadfiletoworkbuffer.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/parseini_jmptbl_diskio_loadfiletoworkbuffer.original_slice.s"
GEN_SLICE="${OUT_DIR}/parseini_jmptbl_diskio_loadfiletoworkbuffer.generated_slice.s"
ORIG_NORM="${OUT_DIR}/parseini_jmptbl_diskio_loadfiletoworkbuffer.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/parseini_jmptbl_diskio_loadfiletoworkbuffer.generated_slice.norm.s"
...
awk -v start_label="PARSEINI_JMPTBL_DISKIO_LoadFileToWorkBuffer" -v next_label="PARSEINI_JMPTBL_ED1_WaitForFlagAndClearBit1" '
...
awk '$0 ~ /^_?PARSEINI_JMPTBL_DISKIO_LoadFileToWorkBuffer:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_parseini_jmptbl_diskio_loadfiletoworkbuffer.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_parseini_jmptbl_diskio_loadfiletoworkbuffer.awk" "$GEN_NORM" > "$GEN_SEM"
