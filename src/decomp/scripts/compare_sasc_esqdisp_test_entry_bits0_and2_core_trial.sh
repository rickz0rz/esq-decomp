...
SASC_SRC="esqdisp_test_entry_bits0_and2_core.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqdisp_test_entry_bits0_and2_core"
ENTRY_ORIG="ESQDISP_TestEntryBits0And2_Core"
ENTRY_SASC_REGEX="^ESQDISP_TestEntryBits0And2_Cor[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_test_entry_bits0_and2_core.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_test_entry_bits0_and2_core.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
