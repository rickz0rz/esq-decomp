...

{
    ...
    if (n ~ /NEWGRID2JMPTBLDISPTEXTSETLAYOUTPARAMS/ || n ~ /NEWGRID2JMPTBLDISPTEXTSETLAYOUTP/ || n ~ /NEWGRID2JMPTBLDISPTEXTSETLAYO/) has_set_layout=1
    if (n ~ /NEWGRID2JMPTBLDISPTEXTLAYOUTANDAPPENDTOBUFFER/ || n ~ /NEWGRID2JMPTBLDISPTEXTLAYOUTA/) has_layout_append=1
    if (n ~ /NEWGRID2JMPTBLDISPTEXTCOMPUTEVISIBLELINECOUNT/ || n ~ /NEWGRID2JMPTBLDISPTEXTCOMPUTEVISIBLEL/ || n ~ /NEWGRID2JMPTBLDISPTEXTCOMPUTE/) has_visible_count=1
