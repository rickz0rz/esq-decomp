...
SASC_SRC="diskio_parse_config_buffer.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/g/diskio.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio_parse_config_buffer"
ENTRY="DISKIO_ParseConfigBuffer"
ENTRY_SASC_REGEX="^DISKIO_ParseConfigBuffer[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_parse_config_buffer.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_parse_config_buffer.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
