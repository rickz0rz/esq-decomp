...
BASE="esqiff_handle_brush_ini_reload_hotkey"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_handle_brush_ini_reload_hotkey.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_handle_brush_ini_reload_hotkey.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
