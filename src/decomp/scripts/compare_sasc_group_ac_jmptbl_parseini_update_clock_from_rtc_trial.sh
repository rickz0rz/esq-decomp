...
BASE="group_ac_jmptbl_parseini_update_clock_from_rtc"
ENTRY_ORIG="GROUP_AC_JMPTBL_PARSEINI_UpdateClockFromRtc"
ENTRY_SASC="GROUP_AC_JMPTBL_PARSEINI_UpdateC"
TARGET="PARSEINI_UpdateClockFromRtc"
mkdir -p "$OUT_DIR"
