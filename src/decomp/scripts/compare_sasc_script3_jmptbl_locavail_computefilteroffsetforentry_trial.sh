...
BASE="script3_jmptbl_locavail_computefilteroffsetforentry"
ENTRY_ORIG="SCRIPT3_JMPTBL_LOCAVAIL_ComputeFilterOffsetForEntry"
ENTRY_SASC="SCRIPT3_JMPTBL_LOCAVAIL_ComputeF"
TARGET="LOCAVAIL_ComputeFilterOffsetForEntry"
mkdir -p "$OUT_DIR"
