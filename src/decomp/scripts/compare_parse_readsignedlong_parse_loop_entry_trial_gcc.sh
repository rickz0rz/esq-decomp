...
SRC_C="src/decomp/c/replacements/parse_readsignedlong_parse_loop_entry_gcc.c"
ORIG_ASM="src/modules/submodules/unknown10.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/parse_readsignedlong_parse_loop_entry.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/parse_readsignedlong_parse_loop_entry.original_slice.s"
GEN_SLICE="${OUT_DIR}/parse_readsignedlong_parse_loop_entry.generated_slice.s"
ORIG_NORM="${OUT_DIR}/parse_readsignedlong_parse_loop_entry.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/parse_readsignedlong_parse_loop_entry.generated_slice.norm.s"
...
awk '$0 ~ /^PARSE_ReadSignedLong_ParseLoopEntry:?$/ {in_func=1} in_func { if ($0 ~ /^;------------------------------------------------------------------------------/) exit; print }' "$ORIG_ASM" > "$ORIG_SLICE"
awk '$0 ~ /^_?PARSE_ReadSignedLong_ParseLoopEntry:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_parse_readsignedlong_parse_loop_entry.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_parse_readsignedlong_parse_loop_entry.awk "$GEN_NORM" > "$GEN_SEM"
