...
BASE="newgrid2_jmptbl_coi_processentryselectionstate"
ENTRY_ORIG="NEWGRID2_JMPTBL_COI_ProcessEntrySelectionState"
ENTRY_SASC="NEWGRID2_JMPTBL_COI_ProcessEntry"
TARGET="COI_ProcessEntrySelectionState"
mkdir -p "$OUT_DIR"
