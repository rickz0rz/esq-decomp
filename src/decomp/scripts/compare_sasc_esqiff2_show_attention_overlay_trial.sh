...
SASC_SRC="esqiff2_show_attention_overlay.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_show_attention_overlay"
ENTRY="ESQIFF2_ShowAttentionOverlay"
ENTRY_SASC_REGEX="^ESQIFF2_ShowAttentionOver[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_show_attention_overlay.awk \
