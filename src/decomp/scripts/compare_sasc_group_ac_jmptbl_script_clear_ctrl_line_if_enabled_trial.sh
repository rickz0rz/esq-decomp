...
BASE="group_ac_jmptbl_script_clear_ctrl_line_if_enabled"
ENTRY_ORIG="GROUP_AC_JMPTBL_SCRIPT_ClearCtrlLineIfEnabled"
ENTRY_SASC="GROUP_AC_JMPTBL_SCRIPT_ClearCtrl"
TARGET="SCRIPT_ClearCtrlLineIfEnabled"
mkdir -p "$OUT_DIR"
