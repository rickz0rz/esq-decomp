...
SASC_SRC="group_az_jmptbl_esq_cold_reboot.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/z/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_az_jmptbl_esq_cold_reboot"
ENTRY_ORIG="GROUP_AZ_JMPTBL_ESQ_ColdReboot"
ENTRY_SASC="GROUP_AZ_JMPTBL_ESQ_ColdReboot"
TARGET="ESQ_ColdReboot"
