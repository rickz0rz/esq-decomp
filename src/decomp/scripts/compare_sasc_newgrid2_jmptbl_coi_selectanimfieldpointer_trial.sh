...
BASE="newgrid2_jmptbl_coi_selectanimfieldpointer"
ENTRY_ORIG="NEWGRID2_JMPTBL_COI_SelectAnimFieldPointer"
ENTRY_SASC="NEWGRID2_JMPTBL_COI_SelectAnimFi"
TARGET="COI_SelectAnimFieldPointer"
mkdir -p "$OUT_DIR"
