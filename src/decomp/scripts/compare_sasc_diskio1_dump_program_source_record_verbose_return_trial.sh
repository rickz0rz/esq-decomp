...
SASC_SRC="diskio1_return_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/g/diskio1.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio1_dump_program_source_record_verbose_return"
ENTRY="DISKIO1_DumpProgramSourceRecordVerbose_Return"
ENTRY_SASC_REGEX="^DISKIO1_DumpProgramSourceRecordV[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_DUMPPROGRAMSOURCERECORDVERBOSE_RETURN:"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio1_return_stub.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio1_return_stub.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
