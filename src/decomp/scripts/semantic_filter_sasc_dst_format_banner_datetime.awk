...

{
    ...
    if (u ~ /GROUP_AJ_JMPTBL_FORMAT_RAWDOFMTWITHSCRATCHBUFFER|GROUP_AJ_JMPTBL_FORMAT_RAWDOFMTWITHSCRAT|GROUP_AJ_JMPTBL_FORMAT_RAWDOFMTW|FORMAT_RAWDOFMTWITHSCRATCHBUFFER|FORMAT_RAWDOFMTWITHSCRAT|FORMAT_RAWDOFMTW/) fmt_call = 1
