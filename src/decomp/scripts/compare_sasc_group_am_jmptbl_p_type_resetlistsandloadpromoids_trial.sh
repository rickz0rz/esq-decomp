...
BASE="group_am_jmptbl_p_type_resetlistsandloadpromoids"
ENTRY_ORIG="GROUP_AM_JMPTBL_P_TYPE_ResetListsAndLoadPromoIds"
ENTRY_SASC="GROUP_AM_JMPTBL_P_TYPE_ResetList"
TARGET="P_TYPE_ResetListsAndLoadPromoIds"
mkdir -p "$OUT_DIR"
