...
SASC_SRC="unknown10_parse_read_signed_long_labels.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/submodules/unknown10.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="parse_readsignedlong_parse_loop_entry"
ENTRY="PARSE_ReadSignedLong_ParseLoopEntry"
ENTRY_SASC_REGEX="^PARSE_ReadSignedLong_ParseLoopEn[A-Za-z0-9_]*:$"
...
awk -v ENTRY="$ENTRY" -f src/decomp/scripts/semantic_filter_parse_readsignedlong_parse_loop_entry.awk \
