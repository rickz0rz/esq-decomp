...
BASE="diskio1_append_attr_flag_bit7"
ENTRY="DISKIO1_AppendAttrFlagBit7"
ENTRY_SASC_REGEX="^DISKIO1_AppendAttrFlagBit7[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_APPENDATTRFLAGBIT7:"
ENTRY_ALT_SEM="DISKIO1_APPENDATTRFLAGBIT7:"
TARGET_SEM="DISKIO1_FORMATTIMESLOTMASKFLAGS"
EXPECTED_BIT="7"
FORMAT_LABEL_PREFIX="DISKIO_STR_0X80"
