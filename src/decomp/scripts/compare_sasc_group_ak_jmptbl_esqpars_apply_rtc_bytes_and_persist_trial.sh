...
BASE="group_ak_jmptbl_esqpars_apply_rtc_bytes_and_persist"
ENTRY_ORIG="GROUP_AK_JMPTBL_ESQPARS_ApplyRtcBytesAndPersist"
ENTRY_SASC="GROUP_AK_JMPTBL_ESQPARS_ApplyRtc"
