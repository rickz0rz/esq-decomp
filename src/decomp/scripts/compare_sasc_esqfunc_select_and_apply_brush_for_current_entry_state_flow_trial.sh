...
BASE="esqfunc_select_and_apply_brush_for_current_entry_state_flow"
ENTRY="ESQFUNC_SelectAndApplyBrushForCurrentEntry"
ENTRY_SASC_REGEX="^ESQFUNC_SelectAndApplyBrushForCu[A-Za-z0-9_]*:$"
NEXT_LABEL="^ESQFUNC_RebuildPwBrushListFromTagTable:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqfunc_select_and_apply_brush_for_current_entry_state_flow.awk \
