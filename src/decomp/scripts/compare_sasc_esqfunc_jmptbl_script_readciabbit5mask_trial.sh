...
cd "$ROOT_DIR"
SASC_SRC="esqfunc_jmptbl_script_read_ciab_bit5_mask.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqfunc_jmptbl_script_readciabbit5mask"
ENTRY_ORIG="ESQFUNC_JMPTBL_SCRIPT_ReadCiaBBit5Mask"
ENTRY_SASC="ESQFUNC_JMPTBL_SCRIPT_ReadCiaBBi"
