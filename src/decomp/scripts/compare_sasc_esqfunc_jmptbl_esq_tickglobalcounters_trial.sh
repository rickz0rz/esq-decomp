...
BASE="esqfunc_jmptbl_esq_tickglobalcounters"
ENTRY_ORIG="ESQFUNC_JMPTBL_ESQ_TickGlobalCounters"
ENTRY_SASC="ESQFUNC_JMPTBL_ESQ_TickGlobalCou"
TARGET="ESQ_TickGlobalCounters"
mkdir -p "$OUT_DIR"
