...
BASE="esqshared_jmptbl_dst_buildbannertimeword"
ENTRY_ORIG="ESQSHARED_JMPTBL_DST_BuildBannerTimeWord"
ENTRY_SASC="ESQSHARED_JMPTBL_DST_BuildBanner"
TARGET="DST_BuildBannerTimeWord"
mkdir -p "$OUT_DIR"
