...
SASC_SRC="esqshared4_decode_rgb_nibble_triplet.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_decode_rgb_nibble_triplet"
ENTRY="ESQSHARED4_DecodeRgbNibbleTriplet"
ENTRY_SASC_REGEX="^ESQSHARED4_DecodeRgbNibble[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_decode_rgb_nibble_triplet.awk \
