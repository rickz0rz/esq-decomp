...
SRC_C="src/decomp/c/replacements/newgrid2_jmptbl_esq_test_bit1_based_gcc.c"
ORIG_ASM="src/modules/groups/b/a/newgrid2.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/newgrid2_jmptbl_esq_test_bit1_based.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/newgrid2_jmptbl_esq_test_bit1_based.original_slice.s"
GEN_SLICE="${OUT_DIR}/newgrid2_jmptbl_esq_test_bit1_based.generated_slice.s"
ORIG_NORM="${OUT_DIR}/newgrid2_jmptbl_esq_test_bit1_based.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/newgrid2_jmptbl_esq_test_bit1_based.generated_slice.norm.s"
...
awk -v start_label="NEWGRID2_JMPTBL_ESQ_TestBit1Based" -v next_label="NEWGRID2_JMPTBL_BEVEL_DrawVerticalBevelPair" '
...
awk '$0 ~ /^_?NEWGRID2_JMPTBL_ESQ_TestBit1Based:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_newgrid2_jmptbl_esq_test_bit1_based.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_newgrid2_jmptbl_esq_test_bit1_based.awk" "$GEN_NORM" > "$GEN_SEM"
