...
BASE="group_am_jmptbl_cleanup_shutdownsystem"
ENTRY_ORIG="GROUP_AM_JMPTBL_CLEANUP_ShutdownSystem"
ENTRY_SASC="GROUP_AM_JMPTBL_CLEANUP_Shutdown"
TARGET="CLEANUP_ShutdownSystem"
mkdir -p "$OUT_DIR"
