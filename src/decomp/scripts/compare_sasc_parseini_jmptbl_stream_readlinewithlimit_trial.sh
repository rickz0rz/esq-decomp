...
BASE="parseini_jmptbl_stream_readlinewithlimit"
ENTRY_ORIG="PARSEINI_JMPTBL_STREAM_ReadLineWithLimit"
ENTRY_SASC="PARSEINI_JMPTBL_STREAM_ReadLineW"
TARGET="STREAM_ReadLineWithLimit"
mkdir -p "$OUT_DIR"
