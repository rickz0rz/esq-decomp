...
SASC_SRC="esqiff2_clear_primary_entry_flags34_to39.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_clear_primary_entry_flags34_to39"
ENTRY="ESQIFF2_ClearPrimaryEntryFlags34To39"
ENTRY_SASC_REGEX="^ESQIFF2_ClearPrimaryEntryFlags3[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_clear_primary_entry_flags34_to39.awk \
