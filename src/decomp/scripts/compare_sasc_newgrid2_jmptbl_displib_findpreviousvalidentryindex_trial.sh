...
BASE="newgrid2_jmptbl_displib_findpreviousvalidentryindex"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPLIB_FindPreviousValidEntryIndex"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPLIB_FindPrev"
