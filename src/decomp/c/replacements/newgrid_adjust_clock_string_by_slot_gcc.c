...
s32 NEWGRID_ComputeDaySlotFromClock(void *clock_ptr) __attribute__((noinline));

s32 NEWGRID_AdjustClockStringBySlot(void *clock_ptr) __attribute__((noinline, used));

s32 NEWGRID_AdjustClockStringBySlot(void *clock_ptr)
{
