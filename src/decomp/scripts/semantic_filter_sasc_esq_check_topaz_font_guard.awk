...

{
    ...
    if (uline ~ /GROUP_MAIN_B_JMPTBL_STREAM_BUFFEREDWRITESTRING/ || uline ~ /GROUP_MAIN_B_JMPTBL_STREAM_BUFFE/) has_rerun_write = 1
    if (uline ~ /GROUP_MAIN_B_JMPTBL_BUFFER_FLUSHALLANDCLOSEWITHCODE/ || uline ~ /GROUP_MAIN_B_JMPTBL_BUFFER_FLUSH/) has_flush_close = 1
