...
SASC_SRC="datetime_build_from_globals.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/j/disptext2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="datetime_build_from_globals"
ENTRY_ORIG="DATETIME_BuildFromGlobals"
ENTRY_SASC_REGEX="^DATETIME_BuildFromGlobals[A-Za-z0-9_]*:$"
NEXT_ENTRY_ORIG="DATETIME_ClassifyValueInRange"
...
awk -f src/decomp/scripts/semantic_filter_sasc_datetime_build_from_globals.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_datetime_build_from_globals.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
