...
cd "$ROOT_DIR"
SASC_SRC="esqiff_jmptbl_stubs_i.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_jmptbl_diskio_resetctrlinputstateifidle"
ENTRY_ORIG="ESQIFF_JMPTBL_DISKIO_ResetCtrlInputStateIfIdle"
ENTRY_SASC="ESQIFF_JMPTBL_DISKIO_ResetCtrlIn"
TARGET="DISKIO_ResetCtrlInputStateIfIdle"
mkdir -p "$OUT_DIR"
