...
SASC_SRC="esqiff_queue_iff_brush_load.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_queue_iff_brush_load"
ENTRY="ESQIFF_QueueIffBrushLoad"
ENTRY_SASC_REGEX="^ESQIFF_QueueIffBrushLoad[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_esqiff_queue_iff_brush_load.awk \
