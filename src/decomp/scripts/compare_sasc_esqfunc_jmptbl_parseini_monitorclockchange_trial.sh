...
BASE="esqfunc_jmptbl_parseini_monitorclockchange"
ENTRY_ORIG="ESQFUNC_JMPTBL_PARSEINI_MonitorClockChange"
ENTRY_SASC="ESQFUNC_JMPTBL_PARSEINI_MonitorC"
TARGET="PARSEINI_MonitorClockChange"
mkdir -p "$OUT_DIR"
