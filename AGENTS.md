...
`src/c/replacements-all.txt` is the one to grow. It stands at **798 entries**,
...
**At 798 it is PROVEN END TO END** (2026-08-03), on the same sequence that
proved 440: `check_pcrel_range` 0 truncated of 50 calls, `a6_audit` 0 of 797,
...
**The maximum-C build is 95.5% C by CODE byte.** 221,732 bytes of 232,204 come
from compiled C. 10,472 bytes are assembly.
