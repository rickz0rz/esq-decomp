...
SASC_SRC="gcommand_validate_preset_table.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_validate_preset_table"
ENTRY="GCOMMAND_ValidatePresetTable"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_validate_preset_table.awk \
