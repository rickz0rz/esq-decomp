...
SASC_SRC="ladfunc_load_text_ads_from_file.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_load_text_ads_from_file"
ENTRY="LADFUNC_LoadTextAdsFromFile"
ENTRY_SASC_REGEX="^LADFUNC_LoadTextAdsFromFil[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_load_text_ads_from_file.awk \
