...
BASE="esqpars_jmptbl_p_type_writepromoiddatafile"
ENTRY_ORIG="ESQPARS_JMPTBL_P_TYPE_WritePromoIdDataFile"
ENTRY_SASC="ESQPARS_JMPTBL_P_TYPE_WritePromo"
TARGET="P_TYPE_WritePromoIdDataFile"
mkdir -p "$OUT_DIR"
