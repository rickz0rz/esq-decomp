...
BASE="esqiff_jmptbl_diskio_forceuirefreshifidle"
ENTRY_ORIG="ESQIFF_JMPTBL_DISKIO_ForceUiRefreshIfIdle"
ENTRY_SASC="ESQIFF_JMPTBL_DISKIO_ForceUiRefr"
TARGET="DISKIO_ForceUiRefreshIfIdle"
mkdir -p "$OUT_DIR"
