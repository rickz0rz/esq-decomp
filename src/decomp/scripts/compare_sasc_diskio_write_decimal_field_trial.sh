...
SASC_SRC="diskio_write_decimal_field.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/g/diskio.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio_write_decimal_field"
ENTRY="DISKIO_WriteDecimalField"
ENTRY_SASC_REGEX="^DISKIO_WriteDecimalField[A-Za-z0-9_]*:$"
