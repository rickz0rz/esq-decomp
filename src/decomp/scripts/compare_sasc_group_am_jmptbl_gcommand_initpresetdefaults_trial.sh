...
BASE="group_am_jmptbl_gcommand_initpresetdefaults"
ENTRY_ORIG="GROUP_AM_JMPTBL_GCOMMAND_InitPresetDefaults"
ENTRY_SASC="GROUP_AM_JMPTBL_GCOMMAND_InitPre"
TARGET="GCOMMAND_InitPresetDefaults"
mkdir -p "$OUT_DIR"
