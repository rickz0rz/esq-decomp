...
SASC_SRC="textdisp_apply_source_config_to_entry.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_apply_source_config_to_entry"
ENTRY="TEXTDISP_ApplySourceConfigToEntry"
ENTRY_SASC_REGEX="^TEXTDISP_ApplySourceConfigToEntr[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_apply_source_config_to_entry.awk \
