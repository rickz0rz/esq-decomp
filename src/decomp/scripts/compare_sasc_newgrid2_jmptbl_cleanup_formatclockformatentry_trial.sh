...
BASE="newgrid2_jmptbl_cleanup_formatclockformatentry"
ENTRY_ORIG="NEWGRID2_JMPTBL_CLEANUP_FormatClockFormatEntry"
ENTRY_SASC="NEWGRID2_JMPTBL_CLEANUP_FormatCl"
