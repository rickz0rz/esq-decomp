...
SASC_SRC="gcommand_parse_ppv_command.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/s/gcommand.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_parse_ppv_command_state_flow"
ENTRY="GCOMMAND_ParsePPVCommand"
ENTRY_SASC_REGEX="^GCOMMAND_ParsePPVCommand[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_parse_ppv_command_state_flow.awk \
