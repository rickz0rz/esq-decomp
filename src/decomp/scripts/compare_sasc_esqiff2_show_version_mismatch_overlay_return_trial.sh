...
BASE="esqiff2_show_version_mismatch_overlay_return"
ENTRY="ESQIFF2_ShowVersionMismatchOverlay_Return"
ENTRY_SASC_REGEX="^ESQIFF2_ShowVersionMismatchOverl[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_SHOWVERSIONMISMATCHOVERLAY_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_SHOWVERSIONMISMATCHOVERL"
