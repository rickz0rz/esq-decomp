...
SASC_SRC="esqshared4_load_default_palette_to_copper_no_op.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_load_default_palette_to_copper_no_op"
ENTRY="ESQSHARED4_LoadDefaultPaletteToCopper_NoOp"
ENTRY_SASC_REGEX="^ESQSHARED4_LoadDefaultPaletteToC[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_load_default_palette_to_copper_no_op.awk \
