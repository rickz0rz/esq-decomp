...
SASC_SRC="esqiff_set_apen_to_brightest_palette_index.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_set_apen_to_brightest_palette_index"
ENTRY_ORIG="ESQIFF_SetApenToBrightestPaletteIndex"
ENTRY_SASC_REGEX="^ESQIFF_SetApenToBrightestPalett[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_set_apen_to_brightest_palette_index.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_set_apen_to_brightest_palette_index.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
