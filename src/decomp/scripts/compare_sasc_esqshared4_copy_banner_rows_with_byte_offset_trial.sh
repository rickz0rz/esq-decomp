...
SASC_SRC="esqshared4_copy_banner_rows_with_byte_offset.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_copy_banner_rows_with_byte_offset"
ENTRY="ESQSHARED4_CopyBannerRowsWithByteOffset"
ENTRY_SASC_REGEX="^ESQSHARED4_CopyBannerRowsWithByt[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_copy_banner_rows_with_byte_offset.awk \
