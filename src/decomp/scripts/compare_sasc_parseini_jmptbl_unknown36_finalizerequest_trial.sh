...
BASE="parseini_jmptbl_unknown36_finalizerequest"
ENTRY_ORIG="PARSEINI_JMPTBL_UNKNOWN36_FinalizeRequest"
ENTRY_SASC="PARSEINI_JMPTBL_UNKNOWN36_Finali"
TARGET="UNKNOWN36_FinalizeRequest"
mkdir -p "$OUT_DIR"
