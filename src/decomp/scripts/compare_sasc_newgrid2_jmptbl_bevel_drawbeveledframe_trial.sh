...
BASE="newgrid2_jmptbl_bevel_drawbeveledframe"
ENTRY_ORIG="NEWGRID2_JMPTBL_BEVEL_DrawBeveledFrame"
ENTRY_SASC="NEWGRID2_JMPTBL_BEVEL_DrawBevele"
TARGET="BEVEL_DrawBeveledFrame"
mkdir -p "$OUT_DIR"
