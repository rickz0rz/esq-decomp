...
BASE="group_ad_jmptbl_textdisp_trim_text_to_pixel_width"
ENTRY_ORIG="GROUP_AD_JMPTBL_TEXTDISP_TrimTextToPixelWidth"
ENTRY_SASC="GROUP_AD_JMPTBL_TEXTDISP_TrimTex"
TARGET="TEXTDISP_TrimTextToPixelWidth"
mkdir -p "$OUT_DIR"
