...
BASE="diskio2_write_cur_day_data_file"
ENTRY="DISKIO2_WriteCurDayDataFile"
ENTRY_SASC_REGEX="^DISKIO2_WriteCurDayDataFile[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO2_WRITECURDAYDATAFILE:"
ENTRY_ALT_SEM="DISKIO2_WRITECURDAYDATAFILE"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio2_write_cur_day_data_file.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio2_write_cur_day_data_file.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
