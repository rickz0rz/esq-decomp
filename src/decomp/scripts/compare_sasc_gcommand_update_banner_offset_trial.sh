...
SASC_SRC="gcommand_update_banner_offset.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_update_banner_offset"
ENTRY="GCOMMAND_UpdateBannerOffset"
ENTRY_SASC_REGEX="^GCOMMAND_UpdateBannerOffset[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_update_banner_offset.awk \
