...
BASE="wdisp_jmptbl_gcommand_expandpresetblock"
ENTRY_ORIG="WDISP_JMPTBL_GCOMMAND_ExpandPresetBlock"
ENTRY_SASC="WDISP_JMPTBL_GCOMMAND_ExpandPres"
TARGET="GCOMMAND_ExpandPresetBlock"
mkdir -p "$OUT_DIR"
