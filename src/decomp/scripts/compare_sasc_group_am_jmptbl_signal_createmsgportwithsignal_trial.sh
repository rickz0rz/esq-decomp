...
BASE="group_am_jmptbl_signal_createmsgportwithsignal"
ENTRY_ORIG="GROUP_AM_JMPTBL_SIGNAL_CreateMsgPortWithSignal"
ENTRY_SASC="GROUP_AM_JMPTBL_SIGNAL_CreateMsg"
