...
BASE="parse_readsignedlong_store_result"
ENTRY="PARSE_ReadSignedLong_StoreResult"
ENTRY_SASC_REGEX="^PARSE_ReadSignedLong_StoreResult[A-Za-z0-9_]*:$"
...
awk -v ENTRY="$ENTRY" -f src/decomp/scripts/semantic_filter_parse_readsignedlong_store_result.awk \
