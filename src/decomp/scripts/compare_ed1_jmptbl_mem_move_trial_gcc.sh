...
SRC_C="src/decomp/c/replacements/ed1_jmptbl_mem_move_gcc.c"
ORIG_ASM="src/modules/groups/a/k/ed1.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/ed1_jmptbl_mem_move.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/ed1_jmptbl_mem_move.original_slice.s"
GEN_SLICE="${OUT_DIR}/ed1_jmptbl_mem_move.generated_slice.s"
ORIG_NORM="${OUT_DIR}/ed1_jmptbl_mem_move.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/ed1_jmptbl_mem_move.generated_slice.norm.s"
ORIG_SEM="${OUT_DIR}/ed1_jmptbl_mem_move.original_slice.semantic.txt"
GEN_SEM="${OUT_DIR}/ed1_jmptbl_mem_move.generated_slice.semantic.txt"
...
awk -v start_label="ED1_JMPTBL_MEM_Move" -v next_label="ED1_JMPTBL_GCOMMAND_SeedBannerFromPrefs" '
...
awk '$0 ~ /^_?ED1_JMPTBL_MEM_Move:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_ed1_jmptbl_mem_move.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_ed1_jmptbl_mem_move.awk" "$GEN_NORM" > "$GEN_SEM"
