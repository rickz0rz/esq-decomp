...
BASE="parseini_jmptbl_brush_freebrushresources"
ENTRY_ORIG="PARSEINI_JMPTBL_BRUSH_FreeBrushResources"
ENTRY_SASC="PARSEINI_JMPTBL_BRUSH_FreeBrushR"
TARGET="BRUSH_FreeBrushResources"
mkdir -p "$OUT_DIR"
