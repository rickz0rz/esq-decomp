...
BASE="esqfunc_jmptbl_cleanup_processalerts"
ENTRY_ORIG="ESQFUNC_JMPTBL_CLEANUP_ProcessAlerts"
ENTRY_SASC="ESQFUNC_JMPTBL_CLEANUP_ProcessAl"
TARGET="CLEANUP_ProcessAlerts"
mkdir -p "$OUT_DIR"
