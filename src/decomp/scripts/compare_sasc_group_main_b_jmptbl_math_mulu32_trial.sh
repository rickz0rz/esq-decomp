...
BASE="group_main_b_jmptbl_math_mulu32"
ENTRY_ORIG="GROUP_MAIN_B_JMPTBL_MATH_Mulu32"
ENTRY_SASC="GROUP_MAIN_B_JMPTBL_MATH_Mulu32"
TARGET="MATH_Mulu32"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_MAIN_B_JMPTBL_BUFFER_Flush:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
