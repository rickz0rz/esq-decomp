...
SASC_SRC="esqiff2_validate_field_index_and_length.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_validate_field_index_and_length"
ENTRY="ESQIFF2_ValidateFieldIndexAndLength"
ENTRY_SASC_REGEX="^ESQIFF2_ValidateFieldIndexAndL[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_validate_field_index_and_length.awk \
