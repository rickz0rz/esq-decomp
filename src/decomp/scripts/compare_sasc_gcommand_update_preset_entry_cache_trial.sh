...
SASC_SRC="gcommand_update_preset_entry_cache.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_update_preset_entry_cache"
ENTRY="GCOMMAND_UpdatePresetEntryCache"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_update_preset_entry_cache.awk \
