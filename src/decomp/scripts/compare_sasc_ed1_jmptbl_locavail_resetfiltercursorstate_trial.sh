...
BASE="ed1_jmptbl_locavail_resetfiltercursorstate"
ENTRY_ORIG="ED1_JMPTBL_LOCAVAIL_ResetFilterCursorState"
ENTRY_SASC="ED1_JMPTBL_LOCAVAIL_ResetFilterC"
TARGET="LOCAVAIL_ResetFilterCursorState"
mkdir -p "$OUT_DIR"
