...
BASE="battclock_write_seconds_to_battery_backed_clock"
ENTRY="BATTCLOCK_WriteSecondsToBatteryBackedClock"
ENTRY_SASC_REGEX="^BATTCLOCK_WriteSecondsToBatteryB[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_battclock_write_seconds_to_battery_backed_clock.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_battclock_write_seconds_to_battery_backed_clock.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
