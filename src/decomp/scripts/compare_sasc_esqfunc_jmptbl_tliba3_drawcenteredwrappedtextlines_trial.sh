...
BASE="esqfunc_jmptbl_tliba3_drawcenteredwrappedtextlines"
ENTRY_ORIG="ESQFUNC_JMPTBL_TLIBA3_DrawCenteredWrappedTextLines"
ENTRY_SASC="ESQFUNC_JMPTBL_TLIBA3_DrawCenter"
TARGET="TLIBA3_DrawCenteredWrappedTextLines"
mkdir -p "$OUT_DIR"
