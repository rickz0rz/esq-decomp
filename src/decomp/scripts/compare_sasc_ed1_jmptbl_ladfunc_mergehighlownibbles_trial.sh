...
BASE="ed1_jmptbl_ladfunc_mergehighlownibbles"
ENTRY_ORIG="ED1_JMPTBL_LADFUNC_MergeHighLowNibbles"
ENTRY_SASC="ED1_JMPTBL_LADFUNC_MergeHighLowN"
TARGET="LADFUNC_SetPackedPenLowNibble"
mkdir -p "$OUT_DIR"
