...
BASE="group_al_jmptbl_ladfunc_pack_nibbles_to_byte"
ENTRY_ORIG="GROUP_AL_JMPTBL_LADFUNC_PackNibblesToByte"
ENTRY_SASC="GROUP_AL_JMPTBL_LADFUNC_PackNibb"
TARGET="LADFUNC_ComposePackedPenByte"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AL_JMPTBL_LADFUNC_ExtractL:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
