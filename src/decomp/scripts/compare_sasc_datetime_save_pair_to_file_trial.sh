...
SASC_SRC="datetime_save_pair_to_file.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/j/disptext2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="datetime_save_pair_to_file"
ENTRY_ORIG="DATETIME_SavePairToFile"
ENTRY_SASC_REGEX="^DATETIME_SavePairToFile[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_datetime_save_pair_to_file.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_datetime_save_pair_to_file.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
