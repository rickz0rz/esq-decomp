...
SASC_SRC="esqiff2_validate_ascii_numeric_byte.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_validate_ascii_numeric_byte"
ENTRY="ESQIFF2_ValidateAsciiNumericByte"
ENTRY_SASC_REGEX="^ESQIFF2_ValidateAsciiNumericB[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_validate_ascii_numeric_byte.awk \
