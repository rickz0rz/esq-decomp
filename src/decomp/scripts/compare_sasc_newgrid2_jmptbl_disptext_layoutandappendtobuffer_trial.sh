...
BASE="newgrid2_jmptbl_disptext_layoutandappendtobuffer"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_LayoutAndAppendToBuffer"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_LayoutA"
TARGET="DISPTEXT_LayoutAndAppendToBuffer"
mkdir -p "$OUT_DIR"
