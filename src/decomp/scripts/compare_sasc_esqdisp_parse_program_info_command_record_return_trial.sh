...
SASC_SRC="esqdisp_parse_program_info_command_record_return.c"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_parse_program_info_command_record_return.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_parse_program_info_command_record_return.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
