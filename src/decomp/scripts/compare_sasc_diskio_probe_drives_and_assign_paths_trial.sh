...
BASE="diskio_probe_drives_and_assign_paths"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_probe_drives_and_assign_paths.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_probe_drives_and_assign_paths.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
