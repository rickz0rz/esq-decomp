...
SRC_C="src/decomp/c/replacements/unknown29_jmptbl_esq_main_init_and_run_gcc.c"
ORIG_ASM="src/modules/submodules/unknown29.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/unknown29_jmptbl_esq_main_init_and_run.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/unknown29_jmptbl_esq_main_init_and_run.original_slice.s"
GEN_SLICE="${OUT_DIR}/unknown29_jmptbl_esq_main_init_and_run.generated_slice.s"
ORIG_NORM="${OUT_DIR}/unknown29_jmptbl_esq_main_init_and_run.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/unknown29_jmptbl_esq_main_init_and_run.generated_slice.norm.s"
...
awk '
$0 ~ /^UNKNOWN29_JMPTBL_ESQ_MainInitAndRun:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;!======/) {
        exit
    }
...
awk '
$0 ~ /^_?UNKNOWN29_JMPTBL_ESQ_MainInitAndRun:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_unknown29_jmptbl_esq_main_init_and_run.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_unknown29_jmptbl_esq_main_init_and_run.awk "$GEN_NORM" > "$GEN_SEM"
