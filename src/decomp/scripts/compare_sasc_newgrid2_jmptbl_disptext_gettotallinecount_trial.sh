...
BASE="newgrid2_jmptbl_disptext_gettotallinecount"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_GetTotalLineCount"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_GetTota"
TARGET="DISPTEXT_GetTotalLineCount"
mkdir -p "$OUT_DIR"
