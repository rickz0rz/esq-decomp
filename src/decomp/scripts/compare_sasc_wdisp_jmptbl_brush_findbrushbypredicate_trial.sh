...
BASE="wdisp_jmptbl_brush_findbrushbypredicate"
ENTRY_ORIG="WDISP_JMPTBL_BRUSH_FindBrushByPredicate"
ENTRY_SASC="WDISP_JMPTBL_BRUSH_FindBrushByPr"
TARGET="BRUSH_FindBrushByPredicate"
mkdir -p "$OUT_DIR"
