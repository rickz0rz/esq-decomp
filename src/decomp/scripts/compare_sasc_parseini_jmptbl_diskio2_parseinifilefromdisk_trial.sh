...
BASE="parseini_jmptbl_diskio2_parseinifilefromdisk"
ENTRY_ORIG="PARSEINI_JMPTBL_DISKIO2_ParseIniFileFromDisk"
ENTRY_SASC="PARSEINI_JMPTBL_DISKIO2_ParseIni"
TARGET="DISKIO2_ParseIniFileFromDisk"
mkdir -p "$OUT_DIR"
