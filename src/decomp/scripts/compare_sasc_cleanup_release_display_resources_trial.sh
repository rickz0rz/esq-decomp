...
SASC_SRC="cleanup_release_display_resources.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/b/cleanup.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="cleanup_release_display_resources"
ENTRY="CLEANUP_ReleaseDisplayResources"
ENTRY_SASC_REGEX="^CLEANUP_ReleaseDisplayResources[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_release_display_resources.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_release_display_resources.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
