...
SASC_SRC="gcommand_get_banner_char.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_get_banner_char"
ENTRY="GCOMMAND_GetBannerChar"
ENTRY_SASC_REGEX="^GCOMMAND_GetBanner[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_get_banner_char.awk \
