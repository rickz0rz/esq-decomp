...
BASE="newgrid2_jmptbl_bevel_drawverticalbevel"
ENTRY_ORIG="NEWGRID2_JMPTBL_BEVEL_DrawVerticalBevel"
ENTRY_SASC="NEWGRID2_JMPTBL_BEVEL_DrawVertic"
TARGET="BEVEL_DrawVerticalBevel"
mkdir -p "$OUT_DIR"
