...
enum {
    CTASKS_FLAG_FALSE = 0,
    CTASKS_TASKSTATE_LOGO = 4,
    CTASKS_TASKSTATE_GADS = 5,
    CTASKS_TASKSTATE_IFF = 6,
    CTASKS_TASKPROC_ALLOC_LINE = 159,
    CTASKS_TASKPROC_STRUCT_SIZE = 14,
    CTASKS_MEMF_PUBLIC_CLEAR = 0x10001UL,
    CTASKS_TASKLIST_SIZE_OFFSET = 0,
    CTASKS_TASKLIST_MAGIC_OFFSET = 8,
    CTASKS_TASKLIST_ENTRY_OFFSET = 10,
    CTASKS_TASKLIST_MAGIC = 20217,
    CTASKS_TASKLIST_SEG_BPTR_SHIFT = 2,
    CTASKS_TASKLIST_SEG_BPTR_ADD = 4
};
