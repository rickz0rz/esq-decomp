...
cd "$ROOT_DIR"
SASC_SRC="parseini_jmptbl_string_compare_nocase_n.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/parseini.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="parseini_jmptbl_string_comparenocasen"
ENTRY_ORIG="PARSEINI_JMPTBL_STRING_CompareNoCaseN"
ENTRY_SASC="PARSEINI_JMPTBL_STRING_CompareNo"
