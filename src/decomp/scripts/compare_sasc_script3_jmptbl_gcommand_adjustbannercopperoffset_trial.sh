...
BASE="script3_jmptbl_gcommand_adjustbannercopperoffset"
ENTRY_ORIG="SCRIPT3_JMPTBL_GCOMMAND_AdjustBannerCopperOffset"
ENTRY_SASC="SCRIPT3_JMPTBL_GCOMMAND_AdjustBa"
TARGET="GCOMMAND_AdjustBannerCopperOffset"
mkdir -p "$OUT_DIR"
