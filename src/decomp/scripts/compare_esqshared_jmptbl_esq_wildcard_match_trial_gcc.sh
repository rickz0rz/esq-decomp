...
SRC_C="src/decomp/c/replacements/esqshared_jmptbl_esq_wildcard_match_gcc.c"
ORIG_ASM="src/modules/groups/a/p/esqshared.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/esqshared_jmptbl_esq_wildcard_match.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/esqshared_jmptbl_esq_wildcard_match.original_slice.s"
GEN_SLICE="${OUT_DIR}/esqshared_jmptbl_esq_wildcard_match.generated_slice.s"
ORIG_NORM="${OUT_DIR}/esqshared_jmptbl_esq_wildcard_match.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/esqshared_jmptbl_esq_wildcard_match.generated_slice.norm.s"
...
awk -v start_label="ESQSHARED_JMPTBL_ESQ_WildcardMatch" -v next_label="ESQSHARED_JMPTBL_STR_SkipClass3Chars" '
...
awk '$0 ~ /^_?ESQSHARED_JMPTBL_ESQ_WildcardMatch:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_esqshared_jmptbl_esq_wildcard_match.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_esqshared_jmptbl_esq_wildcard_match.awk" "$GEN_NORM" > "$GEN_SEM"
