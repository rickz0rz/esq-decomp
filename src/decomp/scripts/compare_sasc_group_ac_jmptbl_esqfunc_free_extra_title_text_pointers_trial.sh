...
cd "$ROOT_DIR"
SASC_SRC="group_ac_jmptbl_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/c/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_ac_jmptbl_esqfunc_free_extra_title_text_pointers"
ENTRY_ORIG="GROUP_AC_JMPTBL_ESQFUNC_FreeExtraTitleTextPointers"
ENTRY_SASC="GROUP_AC_JMPTBL_ESQFUNC_FreeExtr"
TARGET="ESQFUNC_FreeExtraTitleTextPointers"
mkdir -p "$OUT_DIR"
