...
SASC_SRC="diskio_reset_ctrl_input_state_if_idle.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/g/diskio.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio_reset_ctrl_input_state_if_idle"
ENTRY="DISKIO_ResetCtrlInputStateIfIdle"
ENTRY_SASC_REGEX="^DISKIO_ResetCtrlInputStateIfIdle[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_reset_ctrl_input_state_if_idle.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_reset_ctrl_input_state_if_idle.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
