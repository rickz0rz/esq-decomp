...
BASE="group_ad_jmptbl_tliba3_build_display_context_for_view_mode"
ENTRY_ORIG="GROUP_AD_JMPTBL_TLIBA3_BuildDisplayContextForViewMode"
ENTRY_SASC="GROUP_AD_JMPTBL_TLIBA3_BuildDisp"
