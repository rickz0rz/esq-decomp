...
; PURPOSE:
;   Object-level hybrid replacement for the PARSEINI3 module now that the
;   restored SAS/C lane covers the module's full non-JMPTBL export set. This
;   replacement now carries the module body directly instead of delegating back
;   to the canonical asm include.
;------------------------------------------------------------------------------
...
PARSEINI_MonitorClockChange:
    ...
    BEQ.S   .return_2             ; If PARSEINI_ClockChangeActiveFlag was 1, then return
