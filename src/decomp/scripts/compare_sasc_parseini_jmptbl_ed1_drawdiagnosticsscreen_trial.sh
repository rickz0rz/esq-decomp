...
BASE="parseini_jmptbl_ed1_drawdiagnosticsscreen"
ENTRY_ORIG="PARSEINI_JMPTBL_ED1_DrawDiagnosticsScreen"
ENTRY_SASC="PARSEINI_JMPTBL_ED1_DrawDiagnost"
TARGET="ED1_DrawDiagnosticsScreen"
mkdir -p "$OUT_DIR"
