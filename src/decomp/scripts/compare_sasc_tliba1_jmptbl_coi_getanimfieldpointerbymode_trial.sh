...
BASE="tliba1_jmptbl_coi_getanimfieldpointerbymode"
ENTRY_ORIG="TLIBA1_JMPTBL_COI_GetAnimFieldPointerByMode"
ENTRY_SASC="TLIBA1_JMPTBL_COI_GetAnimFieldPo"
TARGET="COI_GetAnimFieldPointerByMode"
mkdir -p "$OUT_DIR"
