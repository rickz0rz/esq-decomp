...
SASC_SRC="script3_process_ctrl_context_playback_tick.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/script3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="script3_process_ctrl_context_playback_tick"
ENTRY="SCRIPT_ProcessCtrlContextPlaybackTick"
ENTRY_SASC_REGEX="^SCRIPT_ProcessCtrlContextPlaybac[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_script3_process_ctrl_context_playback_tick.awk \
