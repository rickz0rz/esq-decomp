...
; PURPOSE:
;   Object-level hybrid replacement for the ESQDISP module now that the
;   restored SAS/C lane covers the module's full non-JMPTBL display, status,
;   and highlight helper export set. This replacement now carries the module
