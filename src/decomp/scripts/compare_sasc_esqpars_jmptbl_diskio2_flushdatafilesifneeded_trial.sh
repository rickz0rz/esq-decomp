...
BASE="esqpars_jmptbl_diskio2_flushdatafilesifneeded"
ENTRY_ORIG="ESQPARS_JMPTBL_DISKIO2_FlushDataFilesIfNeeded"
ENTRY_SASC="ESQPARS_JMPTBL_DISKIO2_FlushData"
TARGET="DISKIO2_FlushDataFilesIfNeeded"
mkdir -p "$OUT_DIR"
