;------------------------------------------------------------------------------
; DECOMP TARGETS unknown10 format/parse/open helper module boundary
; SOURCE: modules/submodules/unknown10.s
; PURPOSE:
;   Object-level hybrid replacement for the UNKNOWN10 module now that the
;   restored SAS/C lane covers the hex formatter, signed-long parser helpers,
;   open-with-flags helper, and WDISP_SPrintf callback path
;   (FORMAT_U32ToHexString, PARSE_ReadSignedLong,
;   PARSE_ReadSignedLong_NoBranch, HANDLE_OpenEntryWithFlags,
;   UNKNOWN10_PrintfPutcToBuffer, and WDISP_SPrintf). This replacement now
