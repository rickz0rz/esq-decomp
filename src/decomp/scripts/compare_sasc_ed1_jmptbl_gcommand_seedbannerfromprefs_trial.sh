...
BASE="ed1_jmptbl_gcommand_seedbannerfromprefs"
ENTRY_ORIG="ED1_JMPTBL_GCOMMAND_SeedBannerFromPrefs"
ENTRY_SASC="ED1_JMPTBL_GCOMMAND_SeedBannerFr"
TARGET="GCOMMAND_SeedBannerFromPrefs"
mkdir -p "$OUT_DIR"
