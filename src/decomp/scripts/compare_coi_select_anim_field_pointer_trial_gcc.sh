...
SRC_C="src/decomp/c/replacements/coi_select_anim_field_pointer_gcc.c"
ORIG_ASM="src/modules/groups/a/e/coi.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/coi_select_anim_field_pointer.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/coi_select_anim_field_pointer.original_slice.s"
GEN_SLICE="${OUT_DIR}/coi_select_anim_field_pointer.generated_slice.s"
ORIG_NORM="${OUT_DIR}/coi_select_anim_field_pointer.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/coi_select_anim_field_pointer.generated_slice.norm.s"
...
awk '
$0 ~ /^COI_SelectAnimFieldPointer:?$/ {print; exit}
' "$ORIG_ASM" > "$ORIG_SLICE"

awk '
$0 ~ /^_?COI_SelectAnimFieldPointer:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_coi_select_anim_field_pointer.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_coi_select_anim_field_pointer.awk "$GEN_NORM" > "$GEN_SEM"
