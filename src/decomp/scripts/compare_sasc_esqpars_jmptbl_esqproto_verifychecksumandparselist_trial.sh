...
BASE="esqpars_jmptbl_esqproto_verifychecksumandparselist"
ENTRY_ORIG="ESQPARS_JMPTBL_ESQPROTO_VerifyChecksumAndParseList"
ENTRY_SASC="ESQPARS_JMPTBL_ESQPROTO_VerifyCh"
TARGET="ESQPROTO_VerifyChecksumAndParseList"
mkdir -p "$OUT_DIR"
