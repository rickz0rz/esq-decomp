...
extern LONG NEWGRID_HandleDetailGridState(char *ctx, LONG index, UWORD row);
extern LONG NEWGRID_FindNextEntryWithAltMarkers(LONG state, LONG selected, UWORD row);
