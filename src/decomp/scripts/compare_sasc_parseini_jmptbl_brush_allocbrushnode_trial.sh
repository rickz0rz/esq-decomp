...
BASE="parseini_jmptbl_brush_allocbrushnode"
ENTRY_ORIG="PARSEINI_JMPTBL_BRUSH_AllocBrushNode"
ENTRY_SASC="PARSEINI_JMPTBL_BRUSH_AllocBrush"
TARGET="BRUSH_AllocBrushNode"
mkdir -p "$OUT_DIR"
