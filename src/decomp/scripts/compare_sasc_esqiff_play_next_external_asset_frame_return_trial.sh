...
BASE="esqiff_play_next_external_asset_frame_return"
ENTRY="ESQIFF_PlayNextExternalAssetFrame_Return"
ENTRY_CANONICAL="ESQIFF_PlayNextExternalAssetFrame"
ENTRY_SASC_REGEX="^ESQIFF_PlayNextExternalAssetFram[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF_PLAYNEXTEXTERNALASSETFRAME_RETURN:"
ENTRY_ALT_SEM="ESQIFF_PLAYNEXTEXTERNALASSETFRAM"
