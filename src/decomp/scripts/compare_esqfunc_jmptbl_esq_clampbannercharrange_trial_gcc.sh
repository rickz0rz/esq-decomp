...
SRC_C="src/decomp/c/replacements/esqfunc_jmptbl_esq_clampbannercharrange_gcc.c"
ORIG_ASM="src/modules/groups/a/n/esqfunc.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/esqfunc_jmptbl_esq_clampbannercharrange.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/esqfunc_jmptbl_esq_clampbannercharrange.original_slice.s"
GEN_SLICE="${OUT_DIR}/esqfunc_jmptbl_esq_clampbannercharrange.generated_slice.s"
ORIG_NORM="${OUT_DIR}/esqfunc_jmptbl_esq_clampbannercharrange.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/esqfunc_jmptbl_esq_clampbannercharrange.generated_slice.norm.s"
...
awk -v start_label="ESQFUNC_JMPTBL_ESQ_ClampBannerCharRange" -v next_label="ESQFUNC_JMPTBL_SCRIPT_ReadCiaBBit3Flag" '
...
awk '$0 ~ /^_?ESQFUNC_JMPTBL_ESQ_ClampBannerCharRange:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_esqfunc_jmptbl_esq_clampbannercharrange.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_esqfunc_jmptbl_esq_clampbannercharrange.awk" "$GEN_NORM" > "$GEN_SEM"
