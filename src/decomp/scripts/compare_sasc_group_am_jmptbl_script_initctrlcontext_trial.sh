...
BASE="group_am_jmptbl_script_initctrlcontext"
ENTRY_ORIG="GROUP_AM_JMPTBL_SCRIPT_InitCtrlContext"
ENTRY_SASC="GROUP_AM_JMPTBL_SCRIPT_InitCtrlC"
TARGET="SCRIPT_InitCtrlContext"
mkdir -p "$OUT_DIR"
