...
BASE="esqshared_jmptbl_coi_ensureanimobjectallocated"
ENTRY_ORIG="ESQSHARED_JMPTBL_COI_EnsureAnimObjectAllocated"
ENTRY_SASC="ESQSHARED_JMPTBL_COI_EnsureAnimO"
TARGET="COI_EnsureAnimObjectAllocated"
mkdir -p "$OUT_DIR"
