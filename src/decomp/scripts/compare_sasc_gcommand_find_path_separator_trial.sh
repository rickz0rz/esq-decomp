...
SASC_SRC="gcommand_find_path_separator.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/t/gcommand2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_find_path_separator"
ENTRY="GCOMMAND_FindPathSeparator"
ENTRY_SASC_REGEX="^GCOMMAND_FindPathSeparator[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_find_path_separator.awk \
