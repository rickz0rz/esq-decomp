...
LAB_047B:
    ...
    MOVE.L  D0,-(A7)
    MOVE.L  A1,-(A7)
    JSR     GROUP_AH_JMP_TBL_ESQ_TestBit1Based(PC)
...
LAB_0496:
    ...
    JSR     GROUP_AH_JMP_TBL_GCOMMAND_LoadMplexFile(PC)

    JSR     GROUP_AH_JMP_TBL_GCOMMAND_LoadPPVTemplate(PC)
...
LAB_049E:
    ...
    PEA     LAB_1C51
    PEA     LAB_2249
    JSR     GROUP_AH_JMP_TBL_ESQ_WildcardMatch(PC)
