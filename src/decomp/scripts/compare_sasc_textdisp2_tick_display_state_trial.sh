...
SASC_SRC="textdisp2_tick_display_state.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp2_tick_display_state"
ENTRY="TEXTDISP_TickDisplayState"
ENTRY_SASC_REGEX="^TEXTDISP_TickDisplayState[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp2_tick_display_state.awk \
