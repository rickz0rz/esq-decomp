...
SRC_C="src/decomp/c/replacements/bevel_draw_bevel_frame_with_top_right_gcc.c"
ORIG_ASM="src/modules/groups/a/a/bevel.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/bevel_draw_bevel_frame_with_top_right.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/bevel_draw_bevel_frame_with_top_right.original_slice.s"
GEN_SLICE="${OUT_DIR}/bevel_draw_bevel_frame_with_top_right.generated_slice.s"
ORIG_NORM="${OUT_DIR}/bevel_draw_bevel_frame_with_top_right.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/bevel_draw_bevel_frame_with_top_right.generated_slice.norm.s"
...
awk -v start_label="BEVEL_DrawBevelFrameWithTopRight" -v next_label="" '
...
awk '$0 ~ /^_?BEVEL_DrawBevelFrameWithTopRight:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_bevel_draw_bevel_frame_with_top_right.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_bevel_draw_bevel_frame_with_top_right.awk" "$GEN_NORM" > "$GEN_SEM"
