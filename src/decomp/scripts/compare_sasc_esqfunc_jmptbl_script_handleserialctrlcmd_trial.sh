...
BASE="esqfunc_jmptbl_script_handleserialctrlcmd"
ENTRY_ORIG="ESQFUNC_JMPTBL_SCRIPT_HandleSerialCtrlCmd"
ENTRY_SASC="ESQFUNC_JMPTBL_SCRIPT_HandleSeri"
TARGET="SCRIPT_HandleSerialCtrlCmd"
mkdir -p "$OUT_DIR"
