...
function trim(s,t){t=s; sub(/;.*/,"",t); sub(/^[ \t]+/,"",t); sub(/[ \t]+$/,"",t); return t}
{
 ...
 if (n ~ /PARSEINIJMPTBLSTRINGCOMPARENocase/ || n ~ /PARSEINIJMPTBLSTRINGCOMPARENOCASE/ || n ~ /PARSEINIJMPTBLSTRINGCOMPARENO/) has_compare=1
 if (n ~ /PARSEINIJMPTBLESQPARSREPLACEOWNEDSTRING/ || n ~ /PARSEINIJMPTBLESQPARSREPLACEOWNEDSTRIN/ || n ~ /PARSEINIJMPTBLESQPARSREPLACEO/) has_replace=1
