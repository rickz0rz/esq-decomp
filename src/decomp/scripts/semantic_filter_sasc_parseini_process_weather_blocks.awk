...
function trim(s,t){t=s; sub(/;.*/,"",t); sub(/^[ \t]+/,"",t); sub(/[ \t]+$/,"",t); return t}
{
 ...
 if (n ~ /PARSEINIJMPTBLSTRINGCOMPARENOCASE/ || n ~ /PARSEINIJMPTBLSTRINGCOMPARENO/ || n ~ /PARSEINITAGSOURCE/ || n ~ /PARSEINISTRLOADCOLOR/) has_compare=1
 if (n ~ /PARSEINIJMPTBLBRUSHALLOCBRUSHNODE/ || n ~ /PARSEINIJMPTBLBRUSHALLOCBRUSHNOD/ || n ~ /PARSEINIJMPTBLBRUSHALLOCBRUSH/) has_alloc_brush=1
 if (n ~ /SCRIPT3JMPTBLPARSEREADSIGNEDLONGSKIPCLASS3ALT/ || n ~ /SCRIPT3JMPTBLPARSEREADSIGNEDLONGSKIPCLASS3AL/ || n ~ /SCRIPT3JMPTBLPARSEREADSIGNEDL/) has_read_long=1
 if (n ~ /SCRIPTJMPTBLMEMORYALLOCATEMEMORY/ || n ~ /GLOBALSTRPARSEINIC3/) has_alloc_mem=1
 if (n ~ /SCRIPT3JMPTBLSTRINGCOPYPADNUL/ || n ~ /SCRIPT3JMPTBLSTRINGCOPYPADNU/) has_copy_id=1
