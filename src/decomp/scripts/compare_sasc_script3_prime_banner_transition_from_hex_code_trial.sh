...
SASC_SRC="script3_prime_banner_transition_from_hex_code.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/script3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="script3_prime_banner_transition_from_hex_code"
ENTRY="SCRIPT_PrimeBannerTransitionFromHexCode"
ENTRY_SASC_REGEX="^SCRIPT_PrimeBannerTransitionFrom[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_script3_prime_banner_transition_from_hex_code.awk \
