...
function trim(s,t){t=s; sub(/;.*/,"",t); sub(/^[ \t]+/,"",t); sub(/[ \t]+$/,"",t); return t}
{
    ...
    if (u ~ /^ESQDISP_GETENTRYAUXPOINTERBYMODE:/) has_label=1
    ...
    if (index(u,"TEXTDISP_PRIMARYTITLEPTRTABLE")>0) has_primary_table=1
    ...
    if (index(u,"TEXTDISP_SECONDARYTITLEPTRTABLE")>0) has_secondary_table=1
