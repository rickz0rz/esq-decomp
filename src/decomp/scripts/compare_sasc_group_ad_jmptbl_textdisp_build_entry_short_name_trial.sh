...
BASE="group_ad_jmptbl_textdisp_build_entry_short_name"
ENTRY_ORIG="GROUP_AD_JMPTBL_TEXTDISP_BuildEntryShortName"
ENTRY_SASC="GROUP_AD_JMPTBL_TEXTDISP_BuildEn"
TARGET="TEXTDISP_BuildEntryShortName"
mkdir -p "$OUT_DIR"
