...
SASC_SRC="esqshared4_copy_interleaved_row_words_from_offset.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_copy_interleaved_row_words_from_offset"
ENTRY="ESQSHARED4_CopyInterleavedRowWordsFromOffset"
ENTRY_SASC_REGEX="^ESQSHARED4_CopyInterleavedRowWor[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_copy_interleaved_row_words_from_offset.awk \
