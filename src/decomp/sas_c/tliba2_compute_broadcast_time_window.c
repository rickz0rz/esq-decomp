...
void TLIBA2_ComputeBroadcastTimeWindow(WORD groupCode, const void *entryContext, LONG entryIndex, LONG slotIndex, LONG *outDateTriplet, LONG *outTimePair)
{
    WORD clockScratch[6];
    LONG parsedRange[2];
    LONG hourDelta;
