...
BASE="esqfunc_draw_diagnostics_screen_state_flow"
ENTRY="ESQFUNC_DrawDiagnosticsScreen"
ENTRY_SASC_REGEX="^ESQFUNC_DrawDiagnosticsS[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqfunc_draw_diagnostics_screen_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqfunc_draw_diagnostics_screen_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
