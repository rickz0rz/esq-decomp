...
SASC_SRC="gcommand_load_default_table.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/s/gcommand.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_load_default_table"
ENTRY="GCOMMAND_LoadDefaultTable"
ENTRY_SASC_REGEX="^GCOMMAND_LoadDefaultTable[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_load_default_table.awk \
