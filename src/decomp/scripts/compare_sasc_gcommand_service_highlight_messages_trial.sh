...
SASC_SRC="gcommand_service_highlight_messages.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_service_highlight_messages"
ENTRY="GCOMMAND_ServiceHighlightMessages"
ENTRY_SASC_REGEX="^GCOMMAND_ServiceHighlightMessage[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_service_highlight_messages.awk \
