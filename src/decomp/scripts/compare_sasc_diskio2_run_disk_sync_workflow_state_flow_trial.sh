...
BASE="diskio2_run_disk_sync_workflow_state_flow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio2_run_disk_sync_workflow_state_flow.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_diskio2_run_disk_sync_workflow_state_flow.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
