...
;------------------------------------------------------------------------------
; FUNC: JMP_TBL_UNKNOWN6_AppendDataAtNull_3   (JumpStub_UNKNOWN6_AppendDataAtNull)
; ARGS:
;   ??
; RET:
;   ??
...
;   D0/D7
; CALLS:
;   GROUPD_JMP_TBL_DISKIO_OpenFileWithBuffer, GROUPD_JMP_TBL_LAB_03A0, GROUPD_JMP_TBL_LAB_039A
; READS:
;   LAB_2049, LAB_233A, LAB_1B5E
; WRITES:
;   Err log file on disk
; DESC:
;   Opens df0:err.log (MODE_NEWFILE), writes two entries via GROUPD_JMP_TBL_LAB_03A0 and closes.
; NOTES:
...
.LAB_1488:
    ...
    JSR     GROUPD_JMP_TBL_DISKIO_OpenFileWithBuffer(PC)
...
.LAB_1489:
    ...
    MOVE.L  LAB_2049,-(A7)
    MOVE.L  D7,-(A7)
    JSR     GROUPD_JMP_TBL_LAB_03A0(PC)
    ...
    MOVE.L  D7,(A7)
    JSR     GROUPD_JMP_TBL_LAB_039A(PC)
