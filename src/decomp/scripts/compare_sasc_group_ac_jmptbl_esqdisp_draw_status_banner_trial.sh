...
BASE="group_ac_jmptbl_esqdisp_draw_status_banner"
ENTRY_ORIG="GROUP_AC_JMPTBL_ESQDISP_DrawStatusBanner"
ENTRY_SASC="GROUP_AC_JMPTBL_ESQDISP_DrawStat"
TARGET="ESQDISP_DrawStatusBanner"
mkdir -p "$OUT_DIR"
