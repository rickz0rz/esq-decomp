...
; PURPOSE:
;   Object-level hybrid replacement for the DISKIO module now that the restored
;   SAS/C lane covers the module's full non-JMPTBL buffered file, config,
;   and drive-probe helper export set. This replacement now carries the module
