;------------------------------------------------------------------------------
; DECOMP TARGETS NEWGRID2 grid-state helper module boundary
; SOURCE: modules/groups/b/a/newgrid2.s
; PURPOSE:
;   Object-level hybrid replacement for the NEWGRID2 module now that the
;   restored SAS/C lane covers the current non-JMPTBL state-dispatch and
;   buffer-management helper set. This replacement now carries the module body
;   directly instead of delegating back to the canonical asm include, while
