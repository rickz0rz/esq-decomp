...
cd "$ROOT_DIR"
SASC_SRC="cleanup_build_and_render_aligned_status_banner.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/d/cleanup3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="cleanup_build_and_render_aligned_status_banner"
ENTRY="CLEANUP_BuildAndRenderAlignedStatusBanner"
ENTRY_SASC_REGEX="^CLEANUP_BuildAndRenderAlignedSta[A-Za-z0-9_]*:$"
mkdir -p "$OUT_DIR"
...
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_build_and_render_aligned_status_banner.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_build_and_render_aligned_status_banner.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
