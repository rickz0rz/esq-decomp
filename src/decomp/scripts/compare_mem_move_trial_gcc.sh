...
SRC_C="src/decomp/c/replacements/mem_move_gcc.c"
ORIG_ASM="src/modules/submodules/unknown34.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/mem_move.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/mem_move.original_slice.s"
GEN_SLICE="${OUT_DIR}/mem_move.generated_slice.s"
ORIG_NORM="${OUT_DIR}/mem_move.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/mem_move.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_memmove.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_memmove.awk "$GEN_NORM" > "$GEN_SEM"
