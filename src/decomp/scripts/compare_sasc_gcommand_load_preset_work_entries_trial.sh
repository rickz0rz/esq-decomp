...
SASC_SRC="gcommand_load_preset_work_entries.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_load_preset_work_entries"
ENTRY="GCOMMAND_LoadPresetWorkEntries"
ENTRY_SASC_REGEX="^GCOMMAND_LoadPresetWorkEntries[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_load_preset_work_entries.awk \
