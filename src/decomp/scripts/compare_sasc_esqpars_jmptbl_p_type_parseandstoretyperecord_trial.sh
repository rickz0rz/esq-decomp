...
BASE="esqpars_jmptbl_p_type_parseandstoretyperecord"
ENTRY_ORIG="ESQPARS_JMPTBL_P_TYPE_ParseAndStoreTypeRecord"
ENTRY_SASC="ESQPARS_JMPTBL_P_TYPE_ParseAndSt"
TARGET="P_TYPE_ParseAndStoreTypeRecord"
mkdir -p "$OUT_DIR"
