...
BASE="group_ay_jmptbl_diskio_write_buffered_bytes"
ENTRY_ORIG="GROUP_AY_JMPTBL_DISKIO_WriteBufferedBytes"
ENTRY_SASC="GROUP_AY_JMPTBL_DISKIO_WriteBuff"
TARGET="DISKIO_WriteBufferedBytes"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AY_JMPTBL_DISKIO_CloseBuff:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
