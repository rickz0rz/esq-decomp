...
BASE="esqfunc_jmptbl_parseini_normalizeclockdata"
ENTRY_ORIG="ESQFUNC_JMPTBL_PARSEINI_NormalizeClockData"
ENTRY_SASC="ESQFUNC_JMPTBL_PARSEINI_Normaliz"
TARGET="PARSEINI_NormalizeClockData"
mkdir -p "$OUT_DIR"
