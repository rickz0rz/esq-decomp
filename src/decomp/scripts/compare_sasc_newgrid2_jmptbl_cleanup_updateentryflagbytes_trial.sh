...
BASE="newgrid2_jmptbl_cleanup_updateentryflagbytes"
ENTRY_ORIG="NEWGRID2_JMPTBL_CLEANUP_UpdateEntryFlagBytes"
ENTRY_SASC="NEWGRID2_JMPTBL_CLEANUP_UpdateEn"
TARGET="CLEANUP_UpdateEntryFlagBytes"
mkdir -p "$OUT_DIR"
