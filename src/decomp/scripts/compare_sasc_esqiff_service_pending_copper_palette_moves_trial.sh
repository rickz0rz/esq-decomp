...
SASC_SRC="esqiff_service_pending_copper_palette_moves.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_service_pending_copper_palette_moves"
ENTRY_ORIG="ESQIFF_ServicePendingCopperPaletteMoves"
ENTRY_SASC_REGEX="^ESQIFF_ServicePendingCopperPalet[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_service_pending_copper_palette_moves.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff_service_pending_copper_palette_moves.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
