...
BASE="esqiff_jmptbl_brush_clonebrushrecord"
ENTRY_ORIG="ESQIFF_JMPTBL_BRUSH_CloneBrushRecord"
ENTRY_SASC="ESQIFF_JMPTBL_BRUSH_CloneBrushRe"
TARGET="BRUSH_CloneBrushRecord"
mkdir -p "$OUT_DIR"
