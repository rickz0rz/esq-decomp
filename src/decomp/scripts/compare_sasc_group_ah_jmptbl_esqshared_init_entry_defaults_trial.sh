...
BASE="group_ah_jmptbl_esqshared_init_entry_defaults"
ENTRY_ORIG="GROUP_AH_JMPTBL_ESQSHARED_InitEntryDefaults"
ENTRY_SASC="GROUP_AH_JMPTBL_ESQSHARED_InitEn"
TARGET="ESQSHARED_InitEntryDefaults"
mkdir -p "$OUT_DIR"
