...

{
    ...
    if (n ~ /NEWGRID2JMPTBLESQDISPGETENTRYPOINTERBYMODE/ || n ~ /NEWGRID2JMPTBLESQDISPGETENTRY/ || n ~ /ESQDISPGETENTRYPOINTERBYMODE/) has_get_entry_mode=1
    if (n ~ /NEWGRID2JMPTBLESQDISPGETENTRYAUXPOINTERBYMODE/ || n ~ /NEWGRID2JMPTBLESQDISPGETENTRY/ || n ~ /ESQDISPGETENTRYAUXPOINTERBYMODE/) has_get_aux_mode=1
    if (n ~ /NEWGRID2JMPTBLESQGETHALFHOURSLOTINDEX/ || n ~ /NEWGRID2JMPTBLESQGETHALFHOURS/ || n ~ /ESQGETHALFHOURSLOTINDEX/ || n ~ /ESQGETHALFHOURS/) has_halfhour_call=1
