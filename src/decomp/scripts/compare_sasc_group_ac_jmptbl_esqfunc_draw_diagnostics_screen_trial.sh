...
BASE="group_ac_jmptbl_esqfunc_draw_diagnostics_screen"
ENTRY_ORIG="GROUP_AC_JMPTBL_ESQFUNC_DrawDiagnosticsScreen"
ENTRY_SASC="GROUP_AC_JMPTBL_ESQFUNC_DrawDiag"
TARGET="ESQFUNC_DrawDiagnosticsScreen"
mkdir -p "$OUT_DIR"
