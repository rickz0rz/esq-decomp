...
BASE="group_ay_jmptbl_math_mulu32"
ENTRY_ORIG="GROUP_AY_JMPTBL_MATH_Mulu32"
ENTRY_SASC="GROUP_AY_JMPTBL_MATH_Mulu32"
TARGET="MATH_Mulu32"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AY_JMPTBL_DISKIO_LoadFileT:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
