...
BASE="esqpars_jmptbl_esqproto_copylabeltoglobal"
ENTRY_ORIG="ESQPARS_JMPTBL_ESQPROTO_CopyLabelToGlobal"
ENTRY_SASC="ESQPARS_JMPTBL_ESQPROTO_CopyLabe"
TARGET="ESQPROTO_CopyLabelToGlobal"
mkdir -p "$OUT_DIR"
