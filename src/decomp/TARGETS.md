...
## Target 501: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_BRUSH_AllocBrushNode`)

Status: promoted (GCC gate)

Why this target:
- Small jump-table export in `groups/b/a/parseini.s` with direct forward-dispatch semantics.
- Starts conversion of currently uncovered `PARSEINI_JMPTBL_*` bridge stubs.

Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_brush_allocbrushnode_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_brush_allocbrushnode_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_brush_allocbrushnode.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_brush_allocbrushnode_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_brush_allocbrushnode_trial_gcc.sh`
...
## Target 502: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_BRUSH_FreeBrushList`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_brush_freebrushlist_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_brush_freebrushlist_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_brush_freebrushlist.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_brush_freebrushlist_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_brush_freebrushlist_trial_gcc.sh`
...
## Target 503: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_BRUSH_FreeBrushResources`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_brush_freebrushresources_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_brush_freebrushresources_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_brush_freebrushresources.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_brush_freebrushresources_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_brush_freebrushresources_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_brush_freebrushresources_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP BRUSH_FreeBrushResources`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 504: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_ESQFUNC_RebuildPwBrushListFromTagTableFromTagTable`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_esqfunc_rebuildpwbrushlistfromtagtablefromtagtable_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_esqfunc_rebuildpwbrushlistfromtagtablefromtagtable_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_esqfunc_rebuildpwbrushlistfromtagtablefromtagtable.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_esqfunc_rebuildpwbrushlistfromtagtablefromtagtable_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_esqfunc_rebuildpwbrushlistfromtagtablefromtagtable_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_esqfunc_rebuildpwbrushlistfromtagtablefromtagtable_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP ESQFUNC_RebuildPwBrushListFromTagTable`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 505: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_GCOMMAND_FindPathSeparator`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_gcommand_findpathseparator_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_gcommand_findpathseparator_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_gcommand_findpathseparator.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_gcommand_findpathseparator_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_gcommand_findpathseparator_trial_gcc.sh`
...
## Target 506: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_DISKIO_ConsumeLineFromWorkBuffer`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_diskio_consumelinefromworkbuffer_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_diskio_consumelinefromworkbuffer_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_diskio_consumelinefromworkbuffer.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_diskio_consumelinefromworkbuffer_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_diskio_consumelinefromworkbuffer_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_diskio_consumelinefromworkbuffer_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP DISKIO_ConsumeLineFromWorkBuffer`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 507: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_DISKIO2_ParseIniFileFromDisk`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_diskio2_parseinifilefromdisk_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_diskio2_parseinifilefromdisk_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_diskio2_parseinifilefromdisk.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_diskio2_parseinifilefromdisk_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_diskio2_parseinifilefromdisk_trial_gcc.sh`
...
## Target 508: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_DISKIO_LoadFileToWorkBuffer`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_diskio_loadfiletoworkbuffer_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_diskio_loadfiletoworkbuffer_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_diskio_loadfiletoworkbuffer.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_diskio_loadfiletoworkbuffer_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_diskio_loadfiletoworkbuffer_trial_gcc.sh`
...
## Target 509: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_ED1_DrawDiagnosticsScreen`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_ed1_drawdiagnosticsscreen_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_ed1_drawdiagnosticsscreen_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_ed1_drawdiagnosticsscreen.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_ed1_drawdiagnosticsscreen_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_ed1_drawdiagnosticsscreen_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_ed1_drawdiagnosticsscreen_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP ED1_DrawDiagnosticsScreen`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 510: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_ED1_EnterEscMenu`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_ed1_enterescmenu_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_ed1_enterescmenu_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_ed1_enterescmenu.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_ed1_enterescmenu_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_ed1_enterescmenu_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_ed1_enterescmenu_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP ED1_EnterEscMenu`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 511: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_ED1_ExitEscMenu`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_ed1_exitescmenu_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_ed1_exitescmenu_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_ed1_exitescmenu.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_ed1_exitescmenu_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_ed1_exitescmenu_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_ed1_exitescmenu_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP ED1_ExitEscMenu`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 512: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_ED1_WaitForFlagAndClearBit0`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_ed1_waitforflagandclearbit0_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_ed1_waitforflagandclearbit0_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_ed1_waitforflagandclearbit0.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_ed1_waitforflagandclearbit0_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_ed1_waitforflagandclearbit0_trial_gcc.sh`
...
## Target 513: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_ED1_WaitForFlagAndClearBit1`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_ed1_waitforflagandclearbit1_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_ed1_waitforflagandclearbit1_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_ed1_waitforflagandclearbit1.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_ed1_waitforflagandclearbit1_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_ed1_waitforflagandclearbit1_trial_gcc.sh`
...
## Target 515: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_ESQIFF_QueueIffBrushLoad`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_esqiff_queueiffbrushload_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_esqiff_queueiffbrushload_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_esqiff_queueiffbrushload.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_esqiff_queueiffbrushload_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_esqiff_queueiffbrushload_trial_gcc.sh`
...
## Target 516: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_ESQIFF_HandleBrushIniReloadHotkey`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_esqiff_handlebrushinireloadhotkey_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_esqiff_handlebrushinireloadhotkey_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_esqiff_handlebrushinireloadhotkey.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_esqiff_handlebrushinireloadhotkey_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_esqiff_handlebrushinireloadhotkey_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_esqiff_handlebrushinireloadhotkey_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP ESQIFF_HandleBrushIniReloadHotkey`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 517: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_ESQPARS_ReplaceOwnedString`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_esqpars_replaceownedstring_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_esqpars_replaceownedstring_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_esqpars_replaceownedstring.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_esqpars_replaceownedstring_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_esqpars_replaceownedstring_trial_gcc.sh`
...
## Target 518: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_GCOMMAND_InitPresetTableFromPalette`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_gcommand_initpresettablefrompalette_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_gcommand_initpresettablefrompalette_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_gcommand_initpresettablefrompalette.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_gcommand_initpresettablefrompalette_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_gcommand_initpresettablefrompalette_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_gcommand_initpresettablefrompalette_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP GCOMMAND_InitPresetTableFromPalette`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 519: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_GCOMMAND_ValidatePresetTable`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_gcommand_validatepresettable_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_gcommand_validatepresettable_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_gcommand_validatepresettable.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_gcommand_validatepresettable_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_gcommand_validatepresettable_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_gcommand_validatepresettable_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP GCOMMAND_ValidatePresetTable`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 520: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_HANDLE_OpenWithMode`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_handle_openwithmode_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_handle_openwithmode_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_handle_openwithmode.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_handle_openwithmode_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_handle_openwithmode_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_handle_openwithmode_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP HANDLE_OpenWithMode`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 521: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_STREAM_ReadLineWithLimit`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_stream_readlinewithlimit_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_stream_readlinewithlimit_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_stream_readlinewithlimit.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_stream_readlinewithlimit_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_stream_readlinewithlimit_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_stream_readlinewithlimit_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP STREAM_ReadLineWithLimit`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 522: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_STRING_AppendAtNull`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_string_appendatnull_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_string_appendatnull_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_string_appendatnull.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_string_appendatnull_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_string_appendatnull_trial_gcc.sh`
...
## Target 523: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_STRING_CompareNoCase`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_string_comparenocase_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_string_comparenocase_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_string_comparenocase.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_string_comparenocase_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_string_comparenocase_trial_gcc.sh`
...
## Target 524: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_STRING_CompareNoCaseN`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_string_comparenocasen_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_string_comparenocasen_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_string_comparenocasen.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_string_comparenocasen_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_string_comparenocasen_trial_gcc.sh`
...
## Target 525: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_STR_FindAnyCharPtr`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_str_findanycharptr_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_str_findanycharptr_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_str_findanycharptr.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_str_findanycharptr_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_str_findanycharptr_trial_gcc.sh`
...
## Target 526: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_STR_FindCharPtr`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_str_findcharptr_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_str_findcharptr_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_str_findcharptr.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_str_findcharptr_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_str_findcharptr_trial_gcc.sh`
...
## Target 527: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_UNKNOWN36_FinalizeRequest`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_unknown36_finalizerequest_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_unknown36_finalizerequest_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_unknown36_finalizerequest.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_unknown36_finalizerequest_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_unknown36_finalizerequest_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_jmptbl_unknown36_finalizerequest_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP UNKNOWN36_FinalizeRequest`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 528: `modules/groups/b/a/parseini.s` (`PARSEINI_JMPTBL_WDISP_SPrintf`)

Status: promoted (GCC gate)

Why this target:
- Small jump-table export in `groups/b/a/parseini.s` with direct forward-dispatch semantics.
- Closes out remaining uncovered `PARSEINI_JMPTBL_*` bridge stubs in this file.

Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_jmptbl_wdisp_sprintf_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_jmptbl_wdisp_sprintf_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_jmptbl_wdisp_sprintf.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_jmptbl_wdisp_sprintf_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_jmptbl_wdisp_sprintf_trial_gcc.sh`
...
## Target 530: `modules/groups/b/a/script3.s` (`SCRIPT3_JMPTBL_LOCAVAIL_ComputeFilterOffsetForEntry`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/script3_jmptbl_locavail_computefilteroffsetforentry_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_script3_jmptbl_locavail_computefilteroffsetforentry_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_script3_jmptbl_locavail_computefilteroffsetforentry.awk`
- Promotion gate: `src/decomp/scripts/promote_script3_jmptbl_locavail_computefilteroffsetforentry_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_script3_jmptbl_locavail_computefilteroffsetforentry_trial_gcc.sh`
- `bash src/decomp/scripts/promote_script3_jmptbl_locavail_computefilteroffsetforentry_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP LOCAVAIL_ComputeFilterOffsetForEntry`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).
...
## Target 541: `modules/groups/b/a/script3.s` (`SCRIPT3_JMPTBL_GCOMMAND_AdjustBannerCopperOffset`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/script3_jmptbl_gcommand_adjustbannercopperoffset_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_script3_jmptbl_gcommand_adjustbannercopperoffset_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_script3_jmptbl_gcommand_adjustbannercopperoffset.awk`
- Promotion gate: `src/decomp/scripts/promote_script3_jmptbl_gcommand_adjustbannercopperoffset_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_script3_jmptbl_gcommand_adjustbannercopperoffset_trial_gcc.sh`
- `bash src/decomp/scripts/promote_script3_jmptbl_gcommand_adjustbannercopperoffset_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP GCOMMAND_AdjustBannerCopperOffset`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 542: `modules/groups/b/a/script3.s` (`SCRIPT3_JMPTBL_ESQ_SetCopperEffect_Custom`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/script3_jmptbl_esq_setcoppereffect_custom_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_script3_jmptbl_esq_setcoppereffect_custom_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_script3_jmptbl_esq_setcoppereffect_custom.awk`
- Promotion gate: `src/decomp/scripts/promote_script3_jmptbl_esq_setcoppereffect_custom_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_script3_jmptbl_esq_setcoppereffect_custom_trial_gcc.sh`
...
## Target 543: `modules/groups/b/a/script3.s` (`SCRIPT3_JMPTBL_ESQSHARED_ApplyProgramTitleTextFilters`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/script3_jmptbl_esqshared_applyprogramtitletextfilters_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_script3_jmptbl_esqshared_applyprogramtitletextfilters_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_script3_jmptbl_esqshared_applyprogramtitletextfilters.awk`
- Promotion gate: `src/decomp/scripts/promote_script3_jmptbl_esqshared_applyprogramtitletextfilters_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_script3_jmptbl_esqshared_applyprogramtitletextfilters_trial_gcc.sh`
...
## Target 548: `modules/groups/b/a/parseini3.s` (`PARSEINI_MonitorClockChange`)

Status: promoted (GCC gate)

Why this target:
- Adjacent `parseini3.s` state-monitor routine sharing the same status-mask call pattern as Target 547.
- Expands non-jump routine coverage for clock-change edge handling.

Artifacts:
- GCC C candidate: `src/decomp/c/replacements/parseini_monitor_clock_change_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_parseini_monitor_clock_change_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_parseini_monitor_clock_change.awk`
- Promotion gate: `src/decomp/scripts/promote_parseini_monitor_clock_change_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_parseini_monitor_clock_change_trial_gcc.sh`
- `bash src/decomp/scripts/promote_parseini_monitor_clock_change_target_gcc.sh`

Current notes:
- Candidate preserves `changed` as `0/-1`, active-flag latching, sample-counter threshold at `3`, and `ESQDISP_UpdateStatusMaskAndRefresh` calls with mask constant `1`.
...
## Target 601: `modules/submodules/unknown16.s` (`BUFFER_FlushAllAndCloseWithCode`)

Status: promoted (GCC gate)

Why this target:
- Natural companion to Target 600 in buffered I/O lifecycle.
- Compact control-flow routine with linked-list traversal and deterministic close tail-call.

Artifacts:
- GCC C candidate: `src/decomp/c/replacements/buffer_flush_all_and_close_with_code_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_buffer_flush_all_and_close_with_code_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_buffer_flush_all_and_close_with_code.awk`
- Promotion gate: `src/decomp/scripts/promote_buffer_flush_all_and_close_with_code_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_buffer_flush_all_and_close_with_code_trial_gcc.sh`
- `bash src/decomp/scripts/promote_buffer_flush_all_and_close_with_code_target_gcc.sh`

Current notes:
- Candidate preserves linked-list walk from `Global_PreallocHandleNode0`, dual state-bit gate (unbuffered/write-pending), pending-byte calculation (`BufferCursor - BufferBase`) feeding `DOS_WriteByIndex`, next-node traversal, and final dispatch to `HANDLE_CloseAllAndReturnWithCode(code)`.
...
## Target 491: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_CLEANUP_DrawClockFormatList`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_cleanup_drawclockformatlist_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_cleanup_drawclockformatlist_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_cleanup_drawclockformatlist.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_cleanup_drawclockformatlist_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_cleanup_drawclockformatlist_trial_gcc.sh`
- `bash src/decomp/scripts/promote_newgrid_jmptbl_cleanup_drawclockformatlist_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP CLEANUP_DrawClockFormatList`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 492: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_DISPTEXT_FreeBuffers`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_disptext_freebuffers_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_disptext_freebuffers_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_disptext_freebuffers.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_disptext_freebuffers_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_disptext_freebuffers_trial_gcc.sh`
- `bash src/decomp/scripts/promote_newgrid_jmptbl_disptext_freebuffers_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP DISPTEXT_FreeBuffers`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).
...
## Target 494: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_MEMORY_AllocateMemory`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_memory_allocatememory_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_memory_allocatememory_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_memory_allocatememory.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_memory_allocatememory_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_memory_allocatememory_trial_gcc.sh`
...
## Target 495: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_DISPTEXT_InitBuffers`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_disptext_initbuffers_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_disptext_initbuffers_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_disptext_initbuffers.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_disptext_initbuffers_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_disptext_initbuffers_trial_gcc.sh`
- `bash src/decomp/scripts/promote_newgrid_jmptbl_disptext_initbuffers_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP DISPTEXT_InitBuffers`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 496: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_CLEANUP_DrawClockFormatFrame`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_cleanup_drawclockformatframe_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_cleanup_drawclockformatframe_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_cleanup_drawclockformatframe.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_cleanup_drawclockformatframe_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_cleanup_drawclockformatframe_trial_gcc.sh`
- `bash src/decomp/scripts/promote_newgrid_jmptbl_cleanup_drawclockformatframe_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP CLEANUP_DrawClockFormatFrame`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 497: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_DATETIME_NormalizeStructToSeconds`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_datetime_normalizestructtoseconds_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_datetime_normalizestructtoseconds_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_datetime_normalizestructtoseconds.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_datetime_normalizestructtoseconds_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_datetime_normalizestructtoseconds_trial_gcc.sh`
- `bash src/decomp/scripts/promote_newgrid_jmptbl_datetime_normalizestructtoseconds_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP DATETIME_NormalizeStructToSeconds`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 498: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_STR_CopyUntilAnyDelimN`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_str_copyuntilanydelimn_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_str_copyuntilanydelimn_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_str_copyuntilanydelimn.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_str_copyuntilanydelimn_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_str_copyuntilanydelimn_trial_gcc.sh`
...
## Target 499: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_WDISP_UpdateSelectionPreviewPanel`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_wdisp_updateselectionpreviewpanel_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_wdisp_updateselectionpreviewpanel_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_wdisp_updateselectionpreviewpanel.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_wdisp_updateselectionpreviewpanel_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_wdisp_updateselectionpreviewpanel_trial_gcc.sh`
- `bash src/decomp/scripts/promote_newgrid_jmptbl_wdisp_updateselectionpreviewpanel_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP WDISP_UpdateSelectionPreviewPanel`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 500: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_MATH_Mulu32`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_math_mulu32_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_math_mulu32_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_math_mulu32.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_math_mulu32_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_math_mulu32_trial_gcc.sh`
...
## Target 489: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_GENERATE_GRID_DATE_STRING`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_generate_grid_date_string_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_generate_grid_date_string_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_generate_grid_date_string.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_generate_grid_date_string_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_generate_grid_date_string_trial_gcc.sh`
- `bash src/decomp/scripts/promote_newgrid_jmptbl_generate_grid_date_string_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP GENERATE_GRID_DATE_STRING`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 490: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_MEMORY_DeallocateMemory`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_memory_deallocatememory_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_memory_deallocatememory_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_memory_deallocatememory.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_memory_deallocatememory_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_memory_deallocatememory_trial_gcc.sh`
...
## Target 482: `modules/groups/b/a/wdisp.s` (`WDISP_JMPTBL_ESQ_SetCopperEffect_OnEnableHighlight`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/wdisp_jmptbl_esq_setcoppereffect_onenablehighlight_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_wdisp_jmptbl_esq_setcoppereffect_onenablehighlight_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_wdisp_jmptbl_esq_setcoppereffect_onenablehighlight.awk`
- Promotion gate: `src/decomp/scripts/promote_wdisp_jmptbl_esq_setcoppereffect_onenablehighlight_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_wdisp_jmptbl_esq_setcoppereffect_onenablehighlight_trial_gcc.sh`
...
## Target 483: `modules/groups/b/a/wdisp.s` (`WDISP_JMPTBL_ESQIFF_RenderWeatherStatusBrushSlice`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/wdisp_jmptbl_esqiff_renderweatherstatusbrushslice_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_wdisp_jmptbl_esqiff_renderweatherstatusbrushslice_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_wdisp_jmptbl_esqiff_renderweatherstatusbrushslice.awk`
- Promotion gate: `src/decomp/scripts/promote_wdisp_jmptbl_esqiff_renderweatherstatusbrushslice_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_wdisp_jmptbl_esqiff_renderweatherstatusbrushslice_trial_gcc.sh`
- `bash src/decomp/scripts/promote_wdisp_jmptbl_esqiff_renderweatherstatusbrushslice_target_gcc.sh`

Current notes:
- Original assembly is a direct `JMP ESQIFF_RenderWeatherStatusBrushSlice`; GCC may emit jump/call-return form, both accepted as equivalent jump-stub dispatch.
- Semantic gate validates target dispatch reference and terminal jump/return form.
- Current promotion decision: pass (on GCC profile `-O1 -fomit-frame-pointer` + m68k freestanding flags).

## Target 484: `modules/groups/b/a/wdisp.s` (`WDISP_JMPTBL_BRUSH_SelectBrushSlot`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/wdisp_jmptbl_brush_selectbrushslot_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_wdisp_jmptbl_brush_selectbrushslot_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_wdisp_jmptbl_brush_selectbrushslot.awk`
- Promotion gate: `src/decomp/scripts/promote_wdisp_jmptbl_brush_selectbrushslot_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_wdisp_jmptbl_brush_selectbrushslot_trial_gcc.sh`
...
## Target 485: `modules/groups/b/a/wdisp.s` (`WDISP_JMPTBL_NEWGRID_DrawWrappedText`)
...
Artifacts:
- GCC C candidate: `src/decomp/c/replacements/wdisp_jmptbl_newgrid_drawwrappedtext_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_wdisp_jmptbl_newgrid_drawwrappedtext_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_wdisp_jmptbl_newgrid_drawwrappedtext.awk`
- Promotion gate: `src/decomp/scripts/promote_wdisp_jmptbl_newgrid_drawwrappedtext_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_wdisp_jmptbl_newgrid_drawwrappedtext_trial_gcc.sh`
...
## Target 487: `modules/groups/b/a/newgrid.s` (`NEWGRID_JMPTBL_MATH_DivS32`)

Status: promoted (GCC gate)

Why this target:
- Small jump-table export in `groups/b/a/newgrid.s` with direct forward-dispatch semantics.
- Starts coverage of uncovered `NEWGRID_JMPTBL_*` bridge stubs.

Artifacts:
- GCC C candidate: `src/decomp/c/replacements/newgrid_jmptbl_math_divs32_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_newgrid_jmptbl_math_divs32_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_newgrid_jmptbl_math_divs32.awk`
- Promotion gate: `src/decomp/scripts/promote_newgrid_jmptbl_math_divs32_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_newgrid_jmptbl_math_divs32_trial_gcc.sh`
...
## Target 720: `modules/groups/a/a/app2.s` (`ESQ_SetCopperEffect_OffDisableHighlight`)

Status: promoted (GCC gate)

Why this target:
- Small direct wrapper with deterministic CIAB bit update plus two fixed calls.
- Continues closing the copper-effect wrapper family with low-risk, high-throughput targets.

Artifacts:
- GCC C candidate: `src/decomp/c/replacements/esq_set_copper_effect_off_disable_highlight_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_esq_set_copper_effect_off_disable_highlight_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_esq_set_copper_effect_off_disable_highlight.awk`
- Promotion gate: `src/decomp/scripts/promote_esq_set_copper_effect_off_disable_highlight_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_esq_set_copper_effect_off_disable_highlight_trial_gcc.sh`
...
## Target 740: `modules/groups/a/a/app2.s` (`ESQ_CalcDayOfYearFromMonthDay`)

Status: promoted (GCC gate)

Why this target:
- Compact calendar arithmetic helper with straightforward table-driven behavior.
- Frequently referenced through jmptbl stubs; promoting direct implementation improves core date-path coverage.

Artifacts:
- GCC C candidate: `src/decomp/c/replacements/esq_calc_day_of_year_from_month_day_gcc.c`
- GCC compile/compare script: `src/decomp/scripts/compare_esq_calc_day_of_year_from_month_day_trial_gcc.sh`
- Semantic filter: `src/decomp/scripts/semantic_filter_esq_calc_day_of_year_from_month_day.awk`
- Promotion gate: `src/decomp/scripts/promote_esq_calc_day_of_year_from_month_day_target_gcc.sh`

Run:
- `CROSS_CC=/opt/amiga/bin/m68k-amigaos-gcc bash src/decomp/scripts/compare_esq_calc_day_of_year_from_month_day_trial_gcc.sh`
