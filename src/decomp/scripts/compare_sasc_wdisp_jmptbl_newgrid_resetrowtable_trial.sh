...
BASE="wdisp_jmptbl_newgrid_resetrowtable"
ENTRY_ORIG="WDISP_JMPTBL_NEWGRID_ResetRowTable"
ENTRY_SASC="WDISP_JMPTBL_NEWGRID_ResetRowTab"
TARGET="NEWGRID_ResetRowTable"
mkdir -p "$OUT_DIR"
