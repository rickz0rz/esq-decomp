...
SASC_SRC="esqfunc_select_and_apply_brush_for_current_entry.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqfunc_select_and_apply_brush_for_current_entry"
ENTRY="ESQFUNC_SelectAndApplyBrushForCurrentEntry"
ENTRY_SASC_REGEX="^ESQFUNC_SelectAndApplyBrushForCu[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_esqfunc_select_and_apply_brush_for_current_entry.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_esqfunc_select_and_apply_brush_for_current_entry.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
