...
SASC_SRC="ladfunc_display_text_packed_pens.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_display_text_packed_pens"
ENTRY="LADFUNC_DisplayTextPackedPens"
ENTRY_SASC_REGEX="^LADFUNC_DisplayTextPackedPe[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_display_text_packed_pens.awk \
