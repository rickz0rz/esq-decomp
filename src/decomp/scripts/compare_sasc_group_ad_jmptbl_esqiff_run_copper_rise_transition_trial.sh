...
cd "$ROOT_DIR"
SASC_SRC="group_ad_jmptbl_esqiff_run_copper_rise_transition.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/d/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_ad_jmptbl_esqiff_run_copper_rise_transition"
ENTRY_ORIG="GROUP_AD_JMPTBL_ESQIFF_RunCopperRiseTransition"
ENTRY_SASC="GROUP_AD_JMPTBL_ESQIFF_RunCopper"
