...
SRC_C="src/decomp/c/replacements/group_ay_jmptbl_diskio_write_buffered_bytes_gcc.c"
ORIG_ASM="src/modules/groups/a/y/xjump.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/group_ay_jmptbl_diskio_write_buffered_bytes.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/group_ay_jmptbl_diskio_write_buffered_bytes.original_slice.s"
GEN_SLICE="${OUT_DIR}/group_ay_jmptbl_diskio_write_buffered_bytes.generated_slice.s"
ORIG_NORM="${OUT_DIR}/group_ay_jmptbl_diskio_write_buffered_bytes.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/group_ay_jmptbl_diskio_write_buffered_bytes.generated_slice.norm.s"
...
awk -v start_label="GROUP_AY_JMPTBL_DISKIO_WriteBufferedBytes" -v next_label="GROUP_AY_JMPTBL_DISKIO_CloseBufferedFileAndFlush" '
...
awk '
$0 ~ /^_?GROUP_AY_JMPTBL_DISKIO_WriteBufferedBytes:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_group_ay_jmptbl_diskio_write_buffered_bytes.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_group_ay_jmptbl_diskio_write_buffered_bytes.awk "$GEN_NORM" > "$GEN_SEM"
