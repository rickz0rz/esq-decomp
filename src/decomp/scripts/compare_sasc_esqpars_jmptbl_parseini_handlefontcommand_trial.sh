...
BASE="esqpars_jmptbl_parseini_handlefontcommand"
ENTRY_ORIG="ESQPARS_JMPTBL_PARSEINI_HandleFontCommand"
ENTRY_SASC="ESQPARS_JMPTBL_PARSEINI_HandleFo"
TARGET="PARSEINI_HandleFontCommand"
mkdir -p "$OUT_DIR"
