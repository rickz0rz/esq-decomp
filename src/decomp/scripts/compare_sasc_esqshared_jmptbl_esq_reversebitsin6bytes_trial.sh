...
BASE="esqshared_jmptbl_esq_reversebitsin6bytes"
ENTRY_ORIG="ESQSHARED_JMPTBL_ESQ_ReverseBitsIn6Bytes"
ENTRY_SASC="ESQSHARED_JMPTBL_ESQ_ReverseBits"
TARGET="ESQ_ReverseBitsIn6Bytes"
mkdir -p "$OUT_DIR"
