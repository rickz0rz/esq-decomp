...
BASE="newgrid2_jmptbl_bevel_drawbevelframewithtopright"
ENTRY_ORIG="NEWGRID2_JMPTBL_BEVEL_DrawBevelFrameWithTopRight"
ENTRY_SASC="NEWGRID2_JMPTBL_BEVEL_DrawBevelF"
TARGET="BEVEL_DrawBevelFrameWithTopRight"
mkdir -p "$OUT_DIR"
