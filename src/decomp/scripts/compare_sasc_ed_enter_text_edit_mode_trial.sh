...
SASC_SRC="ed_enter_text_edit_mode.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/k/ed.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed_enter_text_edit_mode"
ENTRY_ORIG="ED_EnterTextEditMode"
ENTRY_SASC_REGEX="^ED_EnterTextEditMode[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed_enter_text_edit_mode.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed_enter_text_edit_mode.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
