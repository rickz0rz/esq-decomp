...
SASC_SRC="textdisp_handle_script_command.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_handle_script_command"
ENTRY="TEXTDISP_HandleScriptCommand"
ENTRY_SASC_REGEX="^TEXTDISP_HandleScriptCommand[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_handle_script_command.awk \
