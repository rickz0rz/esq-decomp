...
SASC_SRC="ladfunc_repack_entry_text_and_attr_buffers.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_repack_entry_text_and_attr_buffers"
ENTRY="LADFUNC_RepackEntryTextAndAttrBuffers"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_repack_entry_text_and_attr_buffers.awk \
