...
BASE="esqpars_jmptbl_locavail_saveavailabilitydatafile"
ENTRY_ORIG="ESQPARS_JMPTBL_LOCAVAIL_SaveAvailabilityDataFile"
ENTRY_SASC="ESQPARS_JMPTBL_LOCAVAIL_SaveAvai"
TARGET="LOCAVAIL_SaveAvailabilityDataFile"
mkdir -p "$OUT_DIR"
