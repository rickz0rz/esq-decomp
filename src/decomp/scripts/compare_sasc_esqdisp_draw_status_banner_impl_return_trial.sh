...
SASC_SRC="esqdisp_draw_status_banner_impl_return.c"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_draw_status_banner_impl_return.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_draw_status_banner_impl_return.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
