...
SASC_SRC="textdisp_build_channel_label.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_build_channel_label"
ENTRY="TEXTDISP_BuildChannelLabel"
ENTRY_SASC_REGEX="^TEXTDISP_BuildChannelLabel[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_build_channel_label.awk \
