...
; PURPOSE:
;   Object-level hybrid replacement for the COI module now that the restored
;   SAS/C lane covers the current non-JMPTBL entry, animation-field, and
;   OI-data helper set. This replacement now carries the module body directly
