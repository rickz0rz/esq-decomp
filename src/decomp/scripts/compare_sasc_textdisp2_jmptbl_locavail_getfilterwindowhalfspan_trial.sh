...
BASE="textdisp2_jmptbl_locavail_getfilterwindowhalfspan"
ENTRY_ORIG="TEXTDISP2_JMPTBL_LOCAVAIL_GetFilterWindowHalfSpan"
ENTRY_SASC="TEXTDISP2_JMPTBL_LOCAVAIL_GetFil"
TARGET="LOCAVAIL_GetFilterWindowHalfSpan"
mkdir -p "$OUT_DIR"
