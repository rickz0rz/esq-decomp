...

{
    ...
    if (u ~ /GROUP_AA_JMPTBL_STRING_COMPARENOCASE/ || u ~ /_GROUP_AA_JMPTBL_STRING_COMPARENOCASE/ || u ~ /GROUP_AA_JMPTBL_STRING_COMPARENO/ || u ~ /_GROUP_AA_JMPTBL_STRING_COMPARENO/ || u ~ /BSR\.[BWL]? _GROUP_AA_JMPTBL_STRING_COMPARENOCASE/ || u ~ /BSR\.[BWL]? _GROUP_AA_JMPTBL_STRING_COMPARENO/ || u ~ /JSR .*GROUP_AA_JMPTBL_STRING_COMPARENOCASE/ || u ~ /JSR .*GROUP_AA_JMPTBL_STRING_COMPARENO/) {
        has_compare_call = 1
    }
