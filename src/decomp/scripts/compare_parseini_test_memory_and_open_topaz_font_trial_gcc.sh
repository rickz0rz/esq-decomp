...
SRC_C="src/decomp/c/replacements/parseini_test_memory_and_open_topaz_font_gcc.c"
ORIG_ASM="src/modules/groups/b/a/parseini.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/parseini_test_memory_and_open_topaz_font.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/parseini_test_memory_and_open_topaz_font.original_slice.s"
GEN_SLICE="${OUT_DIR}/parseini_test_memory_and_open_topaz_font.generated_slice.s"
ORIG_NORM="${OUT_DIR}/parseini_test_memory_and_open_topaz_font.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/parseini_test_memory_and_open_topaz_font.generated_slice.norm.s"
...
awk -v start_label="PARSEINI_TestMemoryAndOpenTopazFont" -v next_label="PARSEINI_HandleFontCommand" '
...
awk '$0 ~ /^_?PARSEINI_TestMemoryAndOpenTopazFont:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_parseini_test_memory_and_open_topaz_font.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_parseini_test_memory_and_open_topaz_font.awk" "$GEN_NORM" > "$GEN_SEM"
