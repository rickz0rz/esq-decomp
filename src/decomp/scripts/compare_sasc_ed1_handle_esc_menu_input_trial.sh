...
BASE="ed1_handle_esc_menu_input"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_handle_esc_menu_input.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed1_handle_esc_menu_input.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
