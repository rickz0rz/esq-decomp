...
BASE="ed1_jmptbl_gcommand_seedbannerdefaults"
ENTRY_ORIG="ED1_JMPTBL_GCOMMAND_SeedBannerDefaults"
ENTRY_SASC="ED1_JMPTBL_GCOMMAND_SeedBannerDe"
TARGET="GCOMMAND_SeedBannerDefaults"
mkdir -p "$OUT_DIR"
