...
SASC_SRC="gcommand_load_ppv_template.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/s/gcommand.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_load_ppv_template"
ENTRY="GCOMMAND_LoadPPVTemplate"
ENTRY_SASC_REGEX="^GCOMMAND_LoadPPVTemplate[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_load_ppv_template.awk \
