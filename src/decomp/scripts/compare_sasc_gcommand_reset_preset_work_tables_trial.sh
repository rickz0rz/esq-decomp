...
SASC_SRC="gcommand_reset_preset_work_tables.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_reset_preset_work_tables"
ENTRY="GCOMMAND_ResetPresetWorkTables"
ENTRY_SASC_REGEX="^GCOMMAND_ResetPresetWorkTables[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_reset_preset_work_tables.awk \
