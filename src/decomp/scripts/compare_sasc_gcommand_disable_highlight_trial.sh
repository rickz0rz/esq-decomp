...
SASC_SRC="gcommand_disable_highlight.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_disable_highlight"
ENTRY="GCOMMAND_DisableHighlight"
ENTRY_SASC_REGEX="^GCOMMAND_DisableHigh[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_disable_highlight.awk \
