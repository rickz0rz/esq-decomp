...
SASC_SRC="gcommand_copy_image_data_to_bitmap.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_copy_image_data_to_bitmap"
ENTRY="GCOMMAND_CopyImageDataToBitmap"
ENTRY_SASC_REGEX="^GCOMMAND_CopyImageDataToBit[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_copy_image_data_to_bitmap.awk \
