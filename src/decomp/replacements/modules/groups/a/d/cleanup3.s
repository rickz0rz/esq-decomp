;------------------------------------------------------------------------------
; DECOMP TARGETS cleanup3 aligned-status screen/banner module boundary
; SOURCE: modules/groups/a/d/cleanup3.s
; PURPOSE:
;   Object-level hybrid replacement for the CLEANUP3 module now that the
;   restored SAS/C lane covers the aligned-status banner/screen helper cluster.
;   This replacement now carries the module body directly instead of
;   delegating back to the canonical asm include.
;------------------------------------------------------------------------------
