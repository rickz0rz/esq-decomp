...
cd "$ROOT_DIR"
SASC_SRC="newgrid2_jmptbl_bevel_draw_vertical_bevel_pair.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/newgrid2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="newgrid2_jmptbl_bevel_drawverticalbevelpair"
ENTRY_ORIG="NEWGRID2_JMPTBL_BEVEL_DrawVerticalBevelPair"
ENTRY_SASC="NEWGRID2_JMPTBL_BEVEL_DrawVertic"
TARGET="BEVEL_DrawVerticalBevelPair"
mkdir -p "$OUT_DIR"
