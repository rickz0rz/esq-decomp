...
cd "$ROOT_DIR"
SASC_SRC="newgrid_init_selection_window.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/newgrid1.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="newgrid_init_selection_window"
ENTRY="NEWGRID_InitSelectionWindow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_init_selection_window.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_init_selection_window.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
