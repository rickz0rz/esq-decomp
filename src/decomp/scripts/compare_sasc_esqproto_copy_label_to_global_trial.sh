...
SASC_SRC="esqproto_copy_label_to_global.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/submodules/unknown.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqproto_copy_label_to_global"
ENTRY_ORIG="ESQPROTO_CopyLabelToGlobal"
ENTRY_SASC_REGEX="^ESQPROTO_CopyLabelToGlobal[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqproto_copy_label_to_global.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqproto_copy_label_to_global.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
