...
SASC_SRC="gcommand_adjust_banner_copper_offset.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_adjust_banner_copper_offset"
ENTRY="GCOMMAND_AdjustBannerCopperOffset"
ENTRY_SASC_REGEX="^GCOMMAND_AdjustBannerCopperOffse[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_adjust_banner_copper_offset.awk \
