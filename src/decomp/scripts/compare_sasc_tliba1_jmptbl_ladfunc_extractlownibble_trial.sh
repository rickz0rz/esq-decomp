...
BASE="tliba1_jmptbl_ladfunc_extractlownibble"
ENTRY_ORIG="TLIBA1_JMPTBL_LADFUNC_ExtractLowNibble"
ENTRY_SASC="TLIBA1_JMPTBL_LADFUNC_ExtractLow"
TARGET="LADFUNC_GetPackedPenLowNibble"
mkdir -p "$OUT_DIR"
