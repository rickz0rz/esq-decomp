...
; SOURCE: modules/groups/a/c/xjump.s
; PURPOSE:
;   Carry the GROUP_AC wrapper module body directly now that the maintained
;   SAS/C compare lanes for its thirteen wrapper exports are green in this
;   checkout.
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; SYM: GROUP_AC_XJUMP_AlignmentPad   (AlignmentPadding??)
; TYPE: u8
; PURPOSE: Preserve the original wrapper-module trailing alignment byte.
; USED BY: Module layout only
; NOTES: Keep this byte sequence unchanged to match the original object tail.
;------------------------------------------------------------------------------
    MOVEQ   #97,D0
