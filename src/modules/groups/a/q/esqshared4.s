...
; READS:
;   GLOB_REF_WORD_HEX_CODE_8E, f5, f6
; WRITES:
...
; READS:
;   CIAB_PRA, GLOB_REF_WORD_HEX_CODE_8E
; WRITES:
...
; READS:
;   DATA_ESQPARS2_BSS_WORD_1F2F, DATA_ESQPARS2_BSS_LONG_1F38, DATA_ESQPARS2_BSS_LONG_1F49, DATA_ESQPARS2_BSS_WORD_1F4A, DATA_WDISP_BSS_LONG_2267, DATA_WDISP_BSS_LONG_2268, DATA_WDISP_BSS_LONG_2269
; WRITES:
...
ESQSHARED4_SetupBannerPlanePointerWords:
    ...
    LEA     DATA_WDISP_BSS_LONG_2267,A3
    MOVEA.L (A3),A2
    LEA     2992(A2),A2
    MOVE.L  A2,D0
    ...
    LEA     DATA_WDISP_BSS_LONG_2268,A3
    MOVEA.L (A3),A2
    LEA     2992(A2),A2
    MOVE.L  A2,D0
    ...
    LEA     DATA_WDISP_BSS_LONG_2269,A3
    MOVEA.L (A3),A2
    LEA     2992(A2),A2
    MOVE.L  A2,D0
...
;   (none)
; READS:
;   DATA_WDISP_BSS_LONG_2207, DATA_WDISP_BSS_LONG_2208, DATA_WDISP_BSS_LONG_2209
; WRITES:
...
ESQSHARED4_SnapshotDisplayBufferBases:
    MOVE.L  A1,-(A7)
    LEA     DATA_WDISP_BSS_LONG_2207,A1
    MOVE.L  (A1),DATA_ESQPARS2_BSS_LONG_1F35
    LEA     DATA_WDISP_BSS_LONG_2208,A1
    MOVE.L  (A1),DATA_ESQPARS2_BSS_LONG_1F36
    LEA     DATA_WDISP_BSS_LONG_2209,A1
...
;   (none)
; READS:
;   DATA_ESQPARS2_BSS_WORD_1F2F, DATA_WDISP_BSS_LONG_2207, DATA_WDISP_BSS_LONG_2208, DATA_WDISP_BSS_LONG_2209, lab_0C98, lab_0C99
; WRITES:
;   (none observed)
; DESC:
;   Entry-point routine; static scan captures calls and symbol accesses.
...
; READS:
;   ESQ_CopperListBannerA, ESQ_CopperListBannerB, DATA_ESQPARS2_BSS_LONG_1F4C, DATA_ESQPARS2_BSS_LONG_1F4D, DATA_ESQPARS2_BSS_LONG_1F51, DATA_WDISP_BSS_LONG_2267, DATA_WDISP_BSS_LONG_2268, DATA_WDISP_BSS_LONG_2269
; WRITES:
...
.lab_0CA0:
    ...
    LEA     DATA_WDISP_BSS_LONG_2267,A1
    MOVEA.L (A1),A0
    JSR     ESQSHARED4_CopyBannerRowsWithByteOffset(PC)

    LEA     DATA_WDISP_BSS_LONG_2268,A1
    MOVEA.L (A1),A0
    JSR     ESQSHARED4_CopyBannerRowsWithByteOffset(PC)

    LEA     DATA_WDISP_BSS_LONG_2269,A1
    MOVEA.L (A1),A0
    JSR     ESQSHARED4_CopyBannerRowsWithByteOffset(PC)
