...
SRC_C="src/decomp/c/replacements/esq_check_topaz_font_guard_gcc.c"
ORIG_ASM="src/modules/groups/_main/b/b.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/esq_check_topaz_font_guard.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/esq_check_topaz_font_guard.original_slice.s"
GEN_SLICE="${OUT_DIR}/esq_check_topaz_font_guard.generated_slice.s"
ORIG_NORM="${OUT_DIR}/esq_check_topaz_font_guard.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/esq_check_topaz_font_guard.generated_slice.norm.s"
ORIG_SEM="${OUT_DIR}/esq_check_topaz_font_guard.original_slice.semantic.txt"
GEN_SEM="${OUT_DIR}/esq_check_topaz_font_guard.generated_slice.semantic.txt"
...
awk '$0 ~ /^ESQ_CheckTopazFontGuard:?$/ {in_func=1} in_func { if ($0 ~ /^;!======/) exit; print }' "$ORIG_ASM" > "$ORIG_SLICE"
awk '$0 ~ /^_?ESQ_CheckTopazFontGuard:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_esq_check_topaz_font_guard.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_esq_check_topaz_font_guard.awk "$GEN_NORM" > "$GEN_SEM"
