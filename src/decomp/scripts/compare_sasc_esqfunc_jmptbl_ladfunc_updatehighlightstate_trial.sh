...
BASE="esqfunc_jmptbl_ladfunc_updatehighlightstate"
ENTRY_ORIG="ESQFUNC_JMPTBL_LADFUNC_UpdateHighlightState"
ENTRY_SASC="ESQFUNC_JMPTBL_LADFUNC_UpdateHig"
TARGET="LADFUNC_UpdateHighlightState"
mkdir -p "$OUT_DIR"
