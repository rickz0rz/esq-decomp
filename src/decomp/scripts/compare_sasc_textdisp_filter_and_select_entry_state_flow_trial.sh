...
SASC_SRC="textdisp_filter_and_select_entry.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_filter_and_select_entry_state_flow"
ENTRY="TEXTDISP_FilterAndSelectEntry"
ENTRY_SASC_REGEX="^TEXTDISP_FilterAndSelectEnt[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_filter_and_select_entry_state_flow.awk \
