...
SRC_C="src/decomp/c/replacements/script2_jmptbl_esq_capturectrlbit4streambufferbyte_gcc.c"
ORIG_ASM="src/modules/groups/b/a/script2.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/script2_jmptbl_esq_capturectrlbit4streambufferbyte.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/script2_jmptbl_esq_capturectrlbit4streambufferbyte.original_slice.s"
GEN_SLICE="${OUT_DIR}/script2_jmptbl_esq_capturectrlbit4streambufferbyte.generated_slice.s"
ORIG_NORM="${OUT_DIR}/script2_jmptbl_esq_capturectrlbit4streambufferbyte.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/script2_jmptbl_esq_capturectrlbit4streambufferbyte.generated_slice.norm.s"
...
awk -v start_label="SCRIPT2_JMPTBL_ESQ_CaptureCtrlBit4StreamBufferByte" -v next_label="SCRIPT2_JMPTBL_ESQ_ReadSerialRbfByte" '
...
awk '$0 ~ /^_?SCRIPT2_JMPTBL_ESQ_CaptureCtrlBit4StreamBufferByte:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_script2_jmptbl_esq_capturectrlbit4streambufferbyte.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_script2_jmptbl_esq_capturectrlbit4streambufferbyte.awk" "$GEN_NORM" > "$GEN_SEM"
