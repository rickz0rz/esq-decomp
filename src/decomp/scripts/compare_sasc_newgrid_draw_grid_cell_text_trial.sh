...
BASE="newgrid_draw_grid_cell_text"
ENTRY_ORIG="NEWGRID_DrawGridCellText"
...
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_draw_grid_cell_text.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_draw_grid_cell_text.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
