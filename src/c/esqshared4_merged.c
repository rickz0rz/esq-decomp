/* MERGED MODULE: modules/groups/a/q/esqshared4.s
 *
 ...
 *
 * RESTORES: ESQSHARED4_StartBannerSweepFromConfigHead, ESQSHARED4_StartBannerSweepGuarded
 */
#include "esqshared4_start_banner_sweep_from_config_head.c"
#include "esqshared4_start_banner_sweep_guarded.c"
