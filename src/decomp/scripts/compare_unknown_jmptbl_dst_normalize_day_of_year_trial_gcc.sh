...
SRC_C="src/decomp/c/replacements/unknown_jmptbl_dst_normalize_day_of_year_gcc.c"
ORIG_ASM="src/modules/submodules/unknown.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/unknown_jmptbl_dst_normalize_day_of_year.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/unknown_jmptbl_dst_normalize_day_of_year.original_slice.s"
GEN_SLICE="${OUT_DIR}/unknown_jmptbl_dst_normalize_day_of_year.generated_slice.s"
ORIG_NORM="${OUT_DIR}/unknown_jmptbl_dst_normalize_day_of_year.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/unknown_jmptbl_dst_normalize_day_of_year.generated_slice.norm.s"
...
awk -v start_label="UNKNOWN_JMPTBL_DST_NormalizeDayOfYear" -v next_label="UNKNOWN_JMPTBL_ESQ_GenerateXorChecksumByte" '
...
awk '$0 ~ /^_?UNKNOWN_JMPTBL_DST_NormalizeDayOfYear:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_unknown_jmptbl_dst_normalize_day_of_year.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_unknown_jmptbl_dst_normalize_day_of_year.awk" "$GEN_NORM" > "$GEN_SEM"
