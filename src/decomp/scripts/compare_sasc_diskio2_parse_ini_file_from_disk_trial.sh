...
SASC_SRC="diskio2_parse_ini_file_from_disk.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/h/diskio2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio2_parse_ini_file_from_disk"
ENTRY="DISKIO2_ParseIniFileFromDisk"
ENTRY_SASC_REGEX="^DISKIO2_ParseIniFileFromDis[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO2_PARSEINIFILEFROMDISK:"
ENTRY_ALT_SEM="DISKIO2_PARSEINIFILEFROMDIS"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio2_parse_ini_file_from_disk.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio2_parse_ini_file_from_disk.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
