...

{
    ...
    if (n ~ /SCRIPTESQCAPTURECTRLBIT4STREAMBUFFERBYTE/ || n ~ /SCRIPTESQCAPTURECTRLBIT4STREAMBUFF/ || n ~ /SCRIPTESQCAPTURECTRLBIT4STREAM/) has_capture_byte = 1
    ...
    if (n ~ /SCRIPT3JMPTBLESQDISPUPDATESTATUSMASKANDREFRESH/ || n ~ /SCRIPT3JMPTBLESQDISPUPDATESTATUSMAS/ || n ~ /SCRIPT3JMPTBLESQDISPUPDATESTA/) has_status_refresh = 1
    if (n ~ /WDISPJMPTBLESQSETCOPPEREFFECTONENABLEHIGHLIGHT/ || n ~ /WDISPJMPTBLESQSETCOPPEREFF/) has_set_copper = 1
