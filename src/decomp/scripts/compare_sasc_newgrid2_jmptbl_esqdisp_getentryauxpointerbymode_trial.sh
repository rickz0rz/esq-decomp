...
BASE="newgrid2_jmptbl_esqdisp_getentryauxpointerbymode"
ENTRY_ORIG="NEWGRID2_JMPTBL_ESQDISP_GetEntryAuxPointerByMode"
ENTRY_SASC="NEWGRID2_JMPTBL_ESQDISP_GetEntry"
