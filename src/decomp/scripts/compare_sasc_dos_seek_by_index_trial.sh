...
SASC_SRC="dos_seek_by_index.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/submodules/unknown11.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="dos_seek_by_index"
ENTRY="DOS_SeekByIndex"
ENTRY_SASC_REGEX="^DOS_SeekByIndex[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_dos_seek_idx.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_dos_seek_idx.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
