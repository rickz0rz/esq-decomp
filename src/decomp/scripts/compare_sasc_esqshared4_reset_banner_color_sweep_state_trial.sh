...
SASC_SRC="esqshared4_reset_banner_color_sweep_state.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_reset_banner_color_sweep_state"
ENTRY="ESQSHARED4_ResetBannerColorSweepState"
ENTRY_SASC_REGEX="^ESQSHARED4_ResetBannerColorSweep[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_reset_banner_color_sweep_state.awk \
