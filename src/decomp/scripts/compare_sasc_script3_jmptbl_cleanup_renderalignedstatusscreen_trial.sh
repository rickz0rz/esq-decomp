...
BASE="script3_jmptbl_cleanup_renderalignedstatusscreen"
ENTRY_ORIG="SCRIPT3_JMPTBL_CLEANUP_RenderAlignedStatusScreen"
ENTRY_SASC="SCRIPT3_JMPTBL_CLEANUP_RenderAli"
TARGET="CLEANUP_RenderAlignedStatusScreen"
mkdir -p "$OUT_DIR"
