...
SASC_SRC="esqshared4_blit_banner_rows_for_active_field.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_blit_banner_rows_for_active_field"
ENTRY="ESQSHARED4_BlitBannerRowsForActiveField"
ENTRY_SASC_REGEX="^ESQSHARED4_BlitBannerRowsForActi[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_blit_banner_rows_for_active_field.awk \
