...
BASE="group_ah_jmptbl_gcommand_load_ppv_template"
ENTRY_ORIG="GROUP_AH_JMPTBL_GCOMMAND_LoadPPVTemplate"
ENTRY_SASC="GROUP_AH_JMPTBL_GCOMMAND_LoadPPV"
TARGET="GCOMMAND_LoadPPVTemplate"
mkdir -p "$OUT_DIR"
