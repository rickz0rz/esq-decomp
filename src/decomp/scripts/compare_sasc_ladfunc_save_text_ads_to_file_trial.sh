...
SASC_SRC="ladfunc_save_text_ads_to_file.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_save_text_ads_to_file"
ENTRY="LADFUNC_SaveTextAdsToFile"
ENTRY_SASC_REGEX="^LADFUNC_SaveTextAdsToFil[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_save_text_ads_to_file.awk \
