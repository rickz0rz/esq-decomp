...
BASE="esqfunc_jmptbl_script_getctrllineflag"
ENTRY_ORIG="ESQFUNC_JMPTBL_SCRIPT_GetCtrlLineFlag"
ENTRY_SASC="ESQFUNC_JMPTBL_SCRIPT_GetCtrlLin"
TARGET="SCRIPT_GetCtrlLineFlag"
mkdir -p "$OUT_DIR"
