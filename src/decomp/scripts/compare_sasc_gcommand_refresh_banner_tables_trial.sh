...
SASC_SRC="gcommand_refresh_banner_tables.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_refresh_banner_tables"
ENTRY="GCOMMAND_RefreshBannerTables"
ENTRY_SASC_REGEX="^GCOMMAND_RefreshBannerTables[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_refresh_banner_tables.awk \
