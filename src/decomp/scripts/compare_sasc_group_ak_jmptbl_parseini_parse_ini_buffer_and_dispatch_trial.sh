...
BASE="group_ak_jmptbl_parseini_parse_ini_buffer_and_dispatch"
ENTRY_ORIG="GROUP_AK_JMPTBL_PARSEINI_ParseIniBufferAndDispatch"
ENTRY_SASC="GROUP_AK_JMPTBL_PARSEINI_ParseIn"
TARGET="PARSEINI_ParseIniBufferAndDispatch"
mkdir -p "$OUT_DIR"
