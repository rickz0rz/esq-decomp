...
BASE="esqfunc_jmptbl_diskio_probedrivesandassignpaths"
ENTRY_ORIG="ESQFUNC_JMPTBL_DISKIO_ProbeDrivesAndAssignPaths"
ENTRY_SASC="ESQFUNC_JMPTBL_DISKIO_ProbeDrive"
