...
SASC_SRC="gcommand_update_banner_row_pointers.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_update_banner_row_pointers"
ENTRY="GCOMMAND_UpdateBannerRowPointers"
ENTRY_SASC_REGEX="^GCOMMAND_UpdateBannerRowPointers[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_update_banner_row_pointers.awk \
