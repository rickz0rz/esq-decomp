...
SASC_SRC="esqdisp_allocate_highlight_bitmaps.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqdisp_allocate_highlight_bitmaps"
ENTRY="ESQDISP_AllocateHighlightBitmaps"
ENTRY_SASC_REGEX="^ESQDISP_AllocateHighlightBit[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQDISP_ALLOCATEHIGHLIGHTBITMAPS:"
ENTRY_ALT_SEM="ESQDISP_ALLOCATEHIGHLIGHTBIT"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_esqdisp_allocate_highlight_bitmaps.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_esqdisp_allocate_highlight_bitmaps.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
