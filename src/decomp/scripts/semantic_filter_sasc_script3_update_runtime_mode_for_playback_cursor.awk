...

{
    ...
    if (index(u, "WDISP_JMPTBL_ESQ_SETCOPPEREFFECT_ONENABLEHIGHLIGHT") > 0 || index(u, "WDISP_JMPTBL_ESQ_SETCOPPEREFF") > 0 || index(u, "WDISP_JMPTBL_ESQ_SETCOPPEREFFECT") > 0) has_enable_highlight = 1
