...
SRC_C="src/decomp/c/replacements/format_u32_to_decimal_string_gcc.c"
ORIG_ASM="src/modules/submodules/unknown8.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/format_u32_decimal.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/format_u32_decimal.original_slice.s"
GEN_SLICE="${OUT_DIR}/format_u32_decimal.generated_slice.s"
ORIG_NORM="${OUT_DIR}/format_u32_decimal.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/format_u32_decimal.generated_slice.norm.s"
...
awk '
$0 ~ /^_?FORMAT_U32ToDecimalString:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_u32dec.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_u32dec.awk "$GEN_NORM" > "$GEN_SEM"
