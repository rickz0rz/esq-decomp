...
SASC_SRC="esqshared4_setup_banner_plane_pointer_words.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_setup_banner_plane_pointer_words_state_flow"
ENTRY="ESQSHARED4_SetupBannerPlanePointerWords"
ENTRY_SASC_REGEX="^ESQSHARED4_SetupBannerPlanePoint[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_setup_banner_plane_pointer_words_state_flow.awk \
