...
SASC_SRC="diskio_force_ui_refresh_if_idle.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/g/diskio.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio_force_ui_refresh_if_idle"
ENTRY="DISKIO_ForceUiRefreshIfIdle"
ENTRY_SASC_REGEX="^DISKIO_ForceUiRefreshIfIdle[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_force_ui_refresh_if_idle.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_diskio_force_ui_refresh_if_idle.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
