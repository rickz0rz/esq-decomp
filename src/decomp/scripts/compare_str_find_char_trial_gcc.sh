...
SRC_C="src/decomp/c/replacements/str_find_char_gcc.c"
ORIG_ASM="src/modules/submodules/unknown7.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/str_find_char.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/str_find_char.original_slice.s"
GEN_SLICE="${OUT_DIR}/str_find_char.generated_slice.s"
ORIG_NORM="${OUT_DIR}/str_find_char.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/str_find_char.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_str_find_char.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_str_find_char.awk "$GEN_NORM" > "$GEN_SEM"
