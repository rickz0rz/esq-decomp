...
SRC_C="src/decomp/c/replacements/group_af_jmptbl_gcommand_save_brush_result_gcc.c"
ORIG_ASM="src/modules/groups/a/f/xjump.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/group_af_jmptbl_gcommand_save_brush_result.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/group_af_jmptbl_gcommand_save_brush_result.original_slice.s"
GEN_SLICE="${OUT_DIR}/group_af_jmptbl_gcommand_save_brush_result.generated_slice.s"
ORIG_NORM="${OUT_DIR}/group_af_jmptbl_gcommand_save_brush_result.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/group_af_jmptbl_gcommand_save_brush_result.generated_slice.norm.s"
...
awk '
$0 ~ /^GROUP_AF_JMPTBL_GCOMMAND_SaveBrushResult:?$/ {in_func=1}
in_func { print }
' "$ORIG_ASM" > "$ORIG_SLICE"

awk '
$0 ~ /^_?GROUP_AF_JMPTBL_GCOMMAND_SaveBrushResult:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_group_af_jmptbl_gcommand_save_brush_result.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_group_af_jmptbl_gcommand_save_brush_result.awk "$GEN_NORM" > "$GEN_SEM"
