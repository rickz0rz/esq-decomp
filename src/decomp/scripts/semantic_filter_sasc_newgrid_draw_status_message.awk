...

{
    ...
    if (n ~ /NEWGRID2JMPTBLCLEANUPFORMATCLOCKFORMATENTRY/ || n ~ /NEWGRID2JMPTBLCLEANUPFORMATCLOCKF/ || n ~ /NEWGRID2JMPTBLCLEANUPFORMATCL/ || n ~ /CLEANUPFORMATCLOCKFORMATENTRY/ || n ~ /CLEANUPFORMATCLOCKF/ || n ~ /CLEANUPFORMATCL/) has_fmt_clock=1
    ...
    if (n ~ /NEWGRID2JMPTBLBEVELDRAWBEVELFRAMEWITHTOPRIGHT/ || n ~ /NEWGRID2JMPTBLBEVELDRAWBEVELF/ || n ~ /BEVELDRAWBEVELFRAMEWITHTOPRIGHT/ || n ~ /BEVELDRAWBEVELF/) has_bevel=1
