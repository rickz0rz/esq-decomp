...
SASC_SRC="group_main_b_jmptbl_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/_main/b/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_main_b_jmptbl_stream_buffered_write_string"
ENTRY_ORIG="GROUP_MAIN_B_JMPTBL_STREAM_BufferedWriteString"
ENTRY_SASC="GROUP_MAIN_B_JMPTBL_STREAM_Buffe"
TARGET="STREAM_BufferedWriteString"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_MAIN_B_JMPTBL_MATH_Mulu32:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
