...
SASC_SRC="esqiff2_clear_line_head_tail_by_mode.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_clear_line_head_tail_by_mode"
ENTRY="ESQIFF2_ClearLineHeadTailByMode"
ENTRY_SASC_REGEX="^ESQIFF2_ClearLineHeadTailByM[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_clear_line_head_tail_by_mode.awk \
