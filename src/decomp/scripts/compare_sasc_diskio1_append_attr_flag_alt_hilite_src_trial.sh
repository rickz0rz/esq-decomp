...
BASE="diskio1_append_attr_flag_alt_hilite_src"
ENTRY="DISKIO1_AppendAttrFlagAltHiliteSrc"
ENTRY_SASC_REGEX="^DISKIO1_AppendAttrFlagAltHiliteS[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_APPENDATTRFLAGALTHILITESRC:"
ENTRY_ALT_SEM="DISKIO1_APPENDATTRFLAGALTHILITES"
TARGET_SEM="DISKIO1_APPENDATTRFLAGBIT7"
EXPECTED_BIT="6"
FORMAT_LABEL_PREFIX="DISKIO_STR_ALTHILITESRC_CompactS"
