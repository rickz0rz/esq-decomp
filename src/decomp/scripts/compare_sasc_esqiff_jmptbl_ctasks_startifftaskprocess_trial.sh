...
BASE="esqiff_jmptbl_ctasks_startifftaskprocess"
ENTRY_ORIG="ESQIFF_JMPTBL_CTASKS_StartIffTaskProcess"
ENTRY_SASC="ESQIFF_JMPTBL_CTASKS_StartIffTas"
TARGET="CTASKS_StartIffTaskProcess"
mkdir -p "$OUT_DIR"
