...
void PARSEINI_JMPTBL_ESQIFF_QueueIffBrushLoad(short mode){ESQIFF_QueueIffBrushLoad(mode);}
void PARSEINI_JMPTBL_ESQIFF_HandleBrushIniReloadHotkey(long hotkey){ESQIFF_HandleBrushIniReloadHotkey(hotkey);}
...
long PARSEINI_JMPTBL_WDISP_SPrintf(char *out, const char *fmt, long a, long b, long c, long d, long e, long f){return WDISP_SPrintf(out, fmt, a, b, c, d, e, f);}
