...
BASE="group_ad_jmptbl_script_update_serial_shadow_from_ctrl_byte"
ENTRY_ORIG="GROUP_AD_JMPTBL_SCRIPT_UpdateSerialShadowFromCtrlByte"
ENTRY_SASC="GROUP_AD_JMPTBL_SCRIPT_UpdateSer"
