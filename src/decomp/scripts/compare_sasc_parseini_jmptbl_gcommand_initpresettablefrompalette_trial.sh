...
BASE="parseini_jmptbl_gcommand_initpresettablefrompalette"
ENTRY_ORIG="PARSEINI_JMPTBL_GCOMMAND_InitPresetTableFromPalette"
ENTRY_SASC="PARSEINI_JMPTBL_GCOMMAND_InitPre"
TARGET="GCOMMAND_InitPresetTableFromPalette"
mkdir -p "$OUT_DIR"
