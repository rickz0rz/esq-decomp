...
BASE="group_ah_jmptbl_esqpars_clear_alias_string_pointers"
ENTRY_ORIG="GROUP_AH_JMPTBL_ESQPARS_ClearAliasStringPointers"
ENTRY_SASC="GROUP_AH_JMPTBL_ESQPARS_ClearAli"
TARGET="ESQPARS_ClearAliasStringPointers"
mkdir -p "$OUT_DIR"
