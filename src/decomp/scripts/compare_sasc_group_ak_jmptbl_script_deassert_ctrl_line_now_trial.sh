...
BASE="group_ak_jmptbl_script_deassert_ctrl_line_now"
ENTRY_ORIG="GROUP_AK_JMPTBL_SCRIPT_DeassertCtrlLineNow"
ENTRY_SASC="GROUP_AK_JMPTBL_SCRIPT_DeassertC"
TARGET="SCRIPT_DeassertCtrlLineNow"
mkdir -p "$OUT_DIR"
