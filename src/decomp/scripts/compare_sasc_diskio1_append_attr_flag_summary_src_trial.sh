...
BASE="diskio1_append_attr_flag_summary_src"
ENTRY="DISKIO1_AppendAttrFlagSummarySrc"
ENTRY_SASC_REGEX="^DISKIO1_AppendAttrFlagSummarySrc[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_APPENDATTRFLAGSUMMARYSRC:"
ENTRY_ALT_SEM="DISKIO1_APPENDATTRFLAGSUMMARYSRC:"
TARGET_SEM="DISKIO1_APPENDATTRFLAGVIDEOTAGDI"
EXPECTED_BIT="2"
FORMAT_LABEL_PREFIX="DISKIO_STR_SUM_SRC_CompactSource"
