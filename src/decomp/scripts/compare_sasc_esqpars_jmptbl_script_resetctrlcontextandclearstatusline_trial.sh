...
cd "$ROOT_DIR"
SASC_SRC="esqpars_jmptbl_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqpars.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqpars_jmptbl_script_resetctrlcontextandclearstatusline"
ENTRY_ORIG="ESQPARS_JMPTBL_SCRIPT_ResetCtrlContextAndClearStatusLine"
ENTRY_SASC="ESQPARS_JMPTBL_SCRIPT_ResetCtrlC"
TARGET="SCRIPT_ResetCtrlContextAndClearStatusLine"
mkdir -p "$OUT_DIR"
