...
SRC_C="src/decomp/c/replacements/esqshared4_clear_banner_work_raster_with_ones_gcc.c"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/esqshared4_clear_banner_work_raster_with_ones.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/esqshared4_clear_banner_work_raster_with_ones.original_slice.s"
GEN_SLICE="${OUT_DIR}/esqshared4_clear_banner_work_raster_with_ones.generated_slice.s"
ORIG_NORM="${OUT_DIR}/esqshared4_clear_banner_work_raster_with_ones.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/esqshared4_clear_banner_work_raster_with_ones.generated_slice.norm.s"
...
awk '
$0 ~ /^ESQSHARED4_ClearBannerWorkRasterWithOnes:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;!======/) exit
    print
}
...
awk '
$0 ~ /^_?ESQSHARED4_ClearBannerWorkRasterWithOnes:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_esqshared4_clear_banner_work_raster_with_ones.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_esqshared4_clear_banner_work_raster_with_ones.awk "$GEN_NORM" > "$GEN_SEM"
