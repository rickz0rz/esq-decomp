...
SASC_SRC="ed_draw_edit_help_text.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/l/ed3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed_draw_edit_help_text"
ENTRY_ORIG="ED_DrawEditHelpText"
ENTRY_SASC_REGEX="^ED_DrawEditHelpText[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed_draw_edit_help_text.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed_draw_edit_help_text.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
