...
SRC_C="src/decomp/c/replacements/tliba1_jmptbl_coi_getanimfieldpointerbymode_gcc.c"
ORIG_ASM="src/modules/groups/b/a/tliba1.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/tliba1_jmptbl_coi_getanimfieldpointerbymode.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/tliba1_jmptbl_coi_getanimfieldpointerbymode.original_slice.s"
GEN_SLICE="${OUT_DIR}/tliba1_jmptbl_coi_getanimfieldpointerbymode.generated_slice.s"
ORIG_NORM="${OUT_DIR}/tliba1_jmptbl_coi_getanimfieldpointerbymode.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/tliba1_jmptbl_coi_getanimfieldpointerbymode.generated_slice.norm.s"
...
awk -v start_label="TLIBA1_JMPTBL_COI_GetAnimFieldPointerByMode" -v next_label="TLIBA1_JMPTBL_ESQDISP_GetEntryAuxPointerByMode" '
...
awk '$0 ~ /^_?TLIBA1_JMPTBL_COI_GetAnimFieldPointerByMode:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_tliba1_jmptbl_coi_getanimfieldpointerbymode.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_tliba1_jmptbl_coi_getanimfieldpointerbymode.awk" "$GEN_NORM" > "$GEN_SEM"
