...
cd "$ROOT_DIR"
SASC_SRC="newgrid2_jmptbl_esqdisp_get_entry_pointer_by_mode.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/newgrid2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="newgrid2_jmptbl_esqdisp_getentrypointerbymode"
ENTRY_ORIG="NEWGRID2_JMPTBL_ESQDISP_GetEntryPointerByMode"
