...
SASC_SRC="gcommand_enable_highlight.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_enable_highlight"
ENTRY="GCOMMAND_EnableHighlight"
ENTRY_SASC_REGEX="^GCOMMAND_EnableHigh[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_enable_highlight.awk \
