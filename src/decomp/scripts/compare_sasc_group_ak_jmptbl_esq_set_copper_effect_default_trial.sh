...
cd "$ROOT_DIR"
SASC_SRC="group_ak_jmptbl_esq_set_copper_effect_default.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/k/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_ak_jmptbl_esq_set_copper_effect_default"
ENTRY_ORIG="GROUP_AK_JMPTBL_ESQ_SetCopperEffect_Default"
ENTRY_SASC="GROUP_AK_JMPTBL_ESQ_SetCopperEff"
TARGET="ESQ_SetCopperEffect_Default"
mkdir -p "$OUT_DIR"
