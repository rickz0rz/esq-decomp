...
BASE="parseini_jmptbl_esqfunc_drawescmenuversion"
ENTRY_ORIG="PARSEINI_JMPTBL_ESQFUNC_DrawEscMenuVersion"
ENTRY_SASC="PARSEINI_JMPTBL_ESQFUNC_DrawEscM"
TARGET="ESQFUNC_DrawEscMenuVersion"
mkdir -p "$OUT_DIR"
