...
SASC_SRC="ladfunc_draw_entry_line_with_attrs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_draw_entry_line_with_attrs"
ENTRY="LADFUNC_DrawEntryLineWithAttrs"
ENTRY_SASC_REGEX="^LADFUNC_DrawEntryLineWithAt[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_draw_entry_line_with_attrs.awk \
