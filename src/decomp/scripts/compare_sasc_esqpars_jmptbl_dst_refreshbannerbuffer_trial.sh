...
BASE="esqpars_jmptbl_dst_refreshbannerbuffer"
ENTRY_ORIG="ESQPARS_JMPTBL_DST_RefreshBannerBuffer"
ENTRY_SASC="ESQPARS_JMPTBL_DST_RefreshBanner"
TARGET="DST_RefreshBannerBuffer"
mkdir -p "$OUT_DIR"
