...
function trim(s,t){t=s; sub(/;.*/,"",t); sub(/^[ \t]+/,"",t); sub(/[ \t]+$/,"",t); return t}
{
 ...
 if (n ~ /PARSEINIJMPTBLSTRFINDCHARPTR/ || n ~ /STRFINDCHARPTR/ || u ~ /PEA 61\.W/) has_findeq=1
 if (n ~ /PARSEINIJMPTBLSTRINGCOMPARENOCASEN/ || n ~ /STRINGCOMPARENOCASEN/ || n ~ /PARSEINITAGTABLE/ || n ~ /PARSEINITAGCOLOR/ || n ~ /PARSEINITAGDONE/) has_compare=1
 if (n ~ /SCRIPT3JMPTBLPARSEREADSIGNEDLONGSKIPCLASS3ALT/ || n ~ /SCRIPT3JMPTBLPARSEREADSIGNEDLONGSKIPCLASS3AL/ || n ~ /SCRIPT3JMPTBLPARSEREADSIGNEDL/ || n ~ /PARSEREADSIGNEDLONGSKIPCLASS3ALT/ || n ~ /PARSEREADSIGNEDLONGSKIPCLASS3A/) has_parse_signed=1
