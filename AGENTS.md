...
`src/c/replacements-all.txt` is the one to grow. It stands at **814 entries**,
...
**At 814 it is PROVEN END TO END** (2026-08-03), on the same sequence that
proved 440: `check_pcrel_range` 0 truncated of 50 calls, `a6_audit` 0 of 813,
...
**The maximum-C build is 96.1% C by CODE byte.** 225,076 bytes of 234,264 come
from compiled C. 9,188 bytes are assembly.
