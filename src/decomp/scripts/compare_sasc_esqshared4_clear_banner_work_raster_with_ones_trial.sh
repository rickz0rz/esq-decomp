...
SASC_SRC="esqshared4_clear_banner_work_raster_with_ones.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_clear_banner_work_raster_with_ones"
ENTRY="ESQSHARED4_ClearBannerWorkRasterWithOnes"
ENTRY_SASC_REGEX="^ESQSHARED4_ClearBannerWorkRaster[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_clear_banner_work_raster_with_ones.awk \
