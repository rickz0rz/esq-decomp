...
SASC_SRC="gcommand_save_brush_result.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_save_brush_result"
ENTRY="GCOMMAND_SaveBrushResult"
ENTRY_SASC_REGEX="^GCOMMAND_SaveBrushResult[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_save_brush_result.awk \
