...
BASE="ed1_jmptbl_newgrid_drawtopborderline"
ENTRY_ORIG="ED1_JMPTBL_NEWGRID_DrawTopBorderLine"
ENTRY_SASC="ED1_JMPTBL_NEWGRID_DrawTopBorder"
TARGET="NEWGRID_DrawTopBorderLine"
mkdir -p "$OUT_DIR"
