...
cd "$ROOT_DIR"
SASC_SRC="esqiff_jmptbl_stubs_b.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqiff.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff_jmptbl_textdisp_findentryindexbywildcard"
ENTRY_ORIG="ESQIFF_JMPTBL_TEXTDISP_FindEntryIndexByWildcard"
ENTRY_SASC="ESQIFF_JMPTBL_TEXTDISP_FindEntry"
TARGET="TEXTDISP_FindEntryIndexByWildcard"
mkdir -p "$OUT_DIR"
