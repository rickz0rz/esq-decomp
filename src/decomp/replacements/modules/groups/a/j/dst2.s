;------------------------------------------------------------------------------
; DECOMP TARGETS DST2 banner-time helper cluster
; SOURCE: modules/groups/a/j/dst2.s
; PURPOSE:
;   Hybrid replacement boundary for the DST banner queue/date formatting module.
;   The direct non-JMPTBL SAS/C compare lanes for this module already resolve
;   cleanly in the current checkout, so it is safe to map as a whole module.
;------------------------------------------------------------------------------
