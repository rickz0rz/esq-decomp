...
BASE="esqiff2_parse_group_record_and_refresh_return"
ENTRY="ESQIFF2_ParseGroupRecordAndRefresh_Return"
ENTRY_SASC_REGEX="^ESQIFF2_ParseGroupRecordAndRefre[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_PARSEGROUPRECORDANDREFRESH_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_PARSEGROUPRECORDANDREFRE"
