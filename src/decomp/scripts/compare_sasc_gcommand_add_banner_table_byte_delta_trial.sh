...
SASC_SRC="gcommand_add_banner_table_byte_delta.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_add_banner_table_byte_delta"
ENTRY="GCOMMAND_AddBannerTableByteDelta"
ENTRY_SASC_REGEX="^GCOMMAND_AddBannerTable[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_add_banner_table_byte_delta.awk \
