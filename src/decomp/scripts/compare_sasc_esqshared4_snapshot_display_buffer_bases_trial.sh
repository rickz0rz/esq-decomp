...
SASC_SRC="esqshared4_snapshot_display_buffer_bases.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_snapshot_display_buffer_bases"
ENTRY="ESQSHARED4_SnapshotDisplayBufferBases"
ENTRY_SASC_REGEX="^ESQSHARED4_SnapshotDisplayBuffer[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_snapshot_display_buffer_bases.awk \
