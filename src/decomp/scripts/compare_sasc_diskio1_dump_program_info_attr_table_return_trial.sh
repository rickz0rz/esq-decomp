...
BASE="diskio1_dump_program_info_attr_table_return"
ENTRY="DISKIO1_DumpProgramInfoAttrTable_Return"
ENTRY_SASC_REGEX="^DISKIO1_DumpProgramInfoAttrTable[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_DUMPPROGRAMINFOATTRTABLE_RETURN:"
ENTRY_ALT_SEM="DISKIO1_DUMPPROGRAMINFOATTRTABLE:"
