...
; PURPOSE:
;   Object-level hybrid replacement for the PARSEINI2 module now that the
;   restored SAS/C lane covers PARSEINI_AdjustHoursTo24HrFormat,
;   PARSEINI_NormalizeClockData, PARSEINI_UpdateClockFromRtc, and
;   PARSEINI_WriteRtcFromGlobals. This replacement now carries the module body
;   directly instead of delegating back to the canonical asm include, while
;   keeping the module's PARSEINI2_JMPTBL_* wrappers as build glue.
;------------------------------------------------------------------------------
