...
; PURPOSE:
;   Object-level hybrid replacement for the GCOMMAND2 module now that the
;   restored SAS/C lane covers GCOMMAND_CopyGfxToWorkIfAvailable and
;   GCOMMAND_FindPathSeparator. This replacement now carries the module body
...
; READS:
;   GCOMMAND_PATH_GFX_COLON, GCOMMAND_STR_WORK_COLON, GCOMMAND_CMD_COPY_NIL_COLON_GFX_COLON_LOGO_DOT_LS, GCOMMAND_CMD_COPY_NIL_COLON_GFX_COLON_WORK_COLON_
; WRITES:
...
GCOMMAND_CopyGfxToWorkIfAvailable:
    ...
    MOVEQ   #0,D7
    MOVEQ   #0,D6
    LEA     GCOMMAND_PATH_GFX_COLON,A0
    MOVE.L  A0,D1
    MOVEQ   #-2,D2
    ...
    MOVEQ   #0,D7
    LEA     GCOMMAND_STR_WORK_COLON,A0
    MOVE.L  A0,D1
    JSR     _LVOLock(A6)
    ...
    MOVEQ   #0,D7
    CLR.L   -(A7)
    PEA     GCOMMAND_CMD_COPY_NIL_COLON_GFX_COLON_LOGO_DOT_LS
    JSR     GROUP_AT_JMPTBL_DOS_SystemTagList(PC)

    MOVE.L  D0,D6
    CLR.L   (A7)
    PEA     GCOMMAND_CMD_COPY_NIL_COLON_GFX_COLON_WORK_COLON_
    JSR     GROUP_AT_JMPTBL_DOS_SystemTagList(PC)
