...

{
    ...
    if (n ~ /ESQFUNCJMPTBLLOCAVAILREBUILDFILTERSTATEFROMCURRENTGROUP/ || n ~ /ESQFUNCJMPTBLLOCAVAILREBUILDF/ || n ~ /LOCAVAILREBUILDFILTERSTATEFROMCURRENTGROUP/ || n ~ /LOCAVAILREBUILDFILTERSTATEFROMCURR/ || n ~ /LOCAVAILREBUILDFILTERSTATEFROMC/) has_rebuild_filter=1
    ...
    if (n ~ /ESQPARSJMPTBLDISKIO2FLUSHDATAFILESIFNEEDED/ || n ~ /ESQPARSJMPTBLDISKIO2FLUSHDATA/ || n ~ /DISKIO2FLUSHDATAFILESIFNEEDED/ || n ~ /DISKIO2FLUSHDATAFILESIFNE/) has_flush=1
    if (n ~ /ESQPARSJMPTBLLADFUNCSAVETEXTADSTOFILE/ || n ~ /ESQPARSJMPTBLLADFUNCSAVETEXTA/ || n ~ /LADFUNCSAVETEXTADSTOFILE/ || n ~ /LADFUNCSAVETEXTADSTOF/) has_save_textads=1
    if (n ~ /ESQPARSJMPTBLLOCAVAILSAVEAVAILABILITYDATAFILE/ || n ~ /ESQPARSJMPTBLLOCAVAILSAVEAVAI/ || n ~ /LOCAVAILSAVEAVAILABILITYDATAFILE/ || n ~ /LOCAVAILSAVEAVAILABILITYDATA/) has_save_locavail=1
    if (n ~ /DATETIMESAVEPAIRTOFILE/) has_save_datetime=1
    if (n ~ /ESQFUNCJMPTBLPTYPEPROMOTESECONDARYLIST/ || n ~ /ESQFUNCJMPTBLPTYPEPROMOTESEC/ || n ~ /PTYPEPROMOTESECONDARYLIST/ || n ~ /PTYPEPROMOTESECONDARYLIS/) has_promote_ptype=1
    if (n ~ /ESQPARSJMPTBLPTYPEWRITEPROMOIDDATAFILE/ || n ~ /ESQPARSJMPTBLPTYPEWRITEPROMO/ || n ~ /PTYPEWRITEPROMOIDDATAFILE/ || n ~ /PTYPEWRITEPROMOIDDATAF/) has_write_promoid=1
