...
BASE="group_ay_jmptbl_string_compare_nocase_n"
ENTRY_ORIG="GROUP_AY_JMPTBL_STRING_CompareNoCaseN"
ENTRY_SASC="GROUP_AY_JMPTBL_STRING_CompareNo"
TARGET="STRING_CompareNoCaseN"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AY_JMPTBL_MATH_Mulu32:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
