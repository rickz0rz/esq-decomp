...
BASE="wdisp_jmptbl_esq_setcoppereffect_onenablehighlight"
ENTRY_ORIG="WDISP_JMPTBL_ESQ_SetCopperEffect_OnEnableHighlight"
ENTRY_SASC="WDISP_JMPTBL_ESQ_SetCopperEffect"
TARGET="ESQ_SetCopperEffect_OnEnableHighlight"
mkdir -p "$OUT_DIR"
