...
BASE="newgrid2_jmptbl_esqdisp_testentrybits0and2"
ENTRY_ORIG="NEWGRID2_JMPTBL_ESQDISP_TestEntryBits0And2"
ENTRY_SASC="NEWGRID2_JMPTBL_ESQDISP_TestEntr"
TARGET="ESQDISP_TestEntryBits0And2"
mkdir -p "$OUT_DIR"
