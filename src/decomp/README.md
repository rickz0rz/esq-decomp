...
- Newly promoted GCC targets: `148` (`GROUP_AD_JMPTBL_TLIBA3_GetViewModeHeight`), `149` (`GROUP_AD_JMPTBL_TLIBA3_GetViewModeRastPort`), `150` (`GROUP_AD_JMPTBL_DATETIME_NormalizeMonthRange`), `151` (`GROUP_AD_JMPTBL_DATETIME_AdjustMonthIndex`).
...
- Targets 148/149/150/151: `-O1 -m68000 -ffreestanding -fno-builtin -fno-inline -fomit-frame-pointer`
