...
BASE="parseini_jmptbl_str_findanycharptr"
ENTRY_ORIG="PARSEINI_JMPTBL_STR_FindAnyCharPtr"
ENTRY_SASC="PARSEINI_JMPTBL_STR_FindAnyCharP"
TARGET="STR_FindAnyCharPtr"
mkdir -p "$OUT_DIR"
