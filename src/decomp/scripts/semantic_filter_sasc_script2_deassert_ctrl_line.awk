...

{
    ...
    if (u ~ /^SCRIPT_DEASSERTCTRLLINE:/ || u ~ /^SCRIPT_DEASSERTCTRLLIN[A-Z0-9_]*:/) has_entry = 1
    ...
    if (u ~ /\$FFDF/ || u ~ /65503/ || u ~ /[^0-9]223[^0-9]/ || u ~ /BCLR[[:space:]]+#\$?5/) has_clear_bit20 = 1
...
END {
    ...
    print "HAS_CLEAR_BIT20=" has_clear_bit20
