...
SASC_SRC="script3_reset_ctrl_context.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/script3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="script3_reset_ctrl_context"
ENTRY="SCRIPT_ResetCtrlContext"
ENTRY_SASC_REGEX="^SCRIPT_ResetCtrlContext[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_script3_reset_ctrl_context.awk \
