...
BASE="tliba1_jmptbl_displib_findpreviousvalidentryindex"
ENTRY_ORIG="TLIBA1_JMPTBL_DISPLIB_FindPreviousValidEntryIndex"
ENTRY_SASC="TLIBA1_JMPTBL_DISPLIB_FindPrevio"
TARGET="DISPLIB_FindPreviousValidEntryIndex"
mkdir -p "$OUT_DIR"
