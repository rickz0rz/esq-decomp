...

{
    ...
    if (n ~ /NEWGRID2JMPTBLESQDISPGETENTRYPOINTERBYMODE/ || n ~ /NEWGRID2JMPTBLESQDISPGETENTRYP/ || n ~ /NEWGRID2JMPTBLESQDISPGETENTRY/ || n ~ /ESQDISPGETENTRYPOINTERBYMODE/) has_get_entry_call=1
    if (n ~ /NEWGRID2JMPTBLESQDISPGETENTRYAUXPOINTERBYMODE/ || n ~ /NEWGRID2JMPTBLESQDISPGETENTRYA/ || n ~ /NEWGRID2JMPTBLESQDISPGETENTRY/ || n ~ /ESQDISPGETENTRYAUXPOINTERBYMODE/) has_get_aux_call=1
