...
BASE="script3_jmptbl_esqdisp_updatestatusmaskandrefresh"
ENTRY_ORIG="SCRIPT3_JMPTBL_ESQDISP_UpdateStatusMaskAndRefresh"
ENTRY_SASC="SCRIPT3_JMPTBL_ESQDISP_UpdateSta"
TARGET="ESQDISP_UpdateStatusMaskAndRefresh"
mkdir -p "$OUT_DIR"
