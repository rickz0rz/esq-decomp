...
; CALLS:
;   _ESQIFF_JMPTBL_MEMORY_DeallocateMemory, _ESQPARS_JMPTBL_COI_FreeEntryResources, _ESQPARS_JMPTBL_SCRIPT_ResetCtrlContextAndClearStatusLine, _ESQIFF2_ClearLineHeadTailByMode
; READS:
...
;   _TEXTDISP_PrimaryTitlePtrTable, _TEXTDISP_SecondaryTitlePtrTable, _Global_STR_ESQPARS_C_2, _Global_STR_ESQPARS_C_3, _Global_STR_ESQPARS_C_4
; WRITES:
...
_ESQPARS_RemoveGroupEntryAndReleaseStrings:
    ...
    MOVEM.L D5-D7/A2,-(A7)
    MOVE.W  10(A5),D7
    JSR     _ESQPARS_JMPTBL_SCRIPT_ResetCtrlContextAndClearStatusLine(PC)
...
.free_entry_record:
    MOVE.L  -4(A5),-(A7)
    JSR     _ESQPARS_JMPTBL_COI_FreeEntryResources(PC)
