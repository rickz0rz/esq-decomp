...
BASE="esqiff_jmptbl_diskio_getfilesizefromhandle"
ENTRY_ORIG="ESQIFF_JMPTBL_DISKIO_GetFilesizeFromHandle"
ENTRY_SASC="ESQIFF_JMPTBL_DISKIO_GetFilesize"
TARGET="DISKIO_GetFilesizeFromHandle"
mkdir -p "$OUT_DIR"
