...
BASE="esqfunc_jmptbl_p_type_ensuresecondarylist"
ENTRY_ORIG="ESQFUNC_JMPTBL_P_TYPE_EnsureSecondaryList"
ENTRY_SASC="ESQFUNC_JMPTBL_P_TYPE_EnsureSeco"
TARGET="P_TYPE_EnsureSecondaryList"
mkdir -p "$OUT_DIR"
