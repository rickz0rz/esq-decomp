...
SRC_C="src/decomp/c/replacements/list_init_header_gcc.c"
ORIG_ASM="src/modules/submodules/unknown34.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/list_init_header.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/list_init_header.original_slice.s"
GEN_SLICE="${OUT_DIR}/list_init_header.generated_slice.s"
ORIG_NORM="${OUT_DIR}/list_init_header.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/list_init_header.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_list_init.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_list_init.awk "$GEN_NORM" > "$GEN_SEM"
