...
BASE="esqfunc_jmptbl_parseini_updatectrlhdeltamax"
ENTRY_ORIG="ESQFUNC_JMPTBL_PARSEINI_UpdateCtrlHDeltaMax"
ENTRY_SASC="ESQFUNC_JMPTBL_PARSEINI_UpdateCt"
TARGET="PARSEINI_UpdateCtrlHDeltaMax"
mkdir -p "$OUT_DIR"
