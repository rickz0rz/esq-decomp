...
BASE="parseini2_jmptbl_battclock_writesecondstobatterybackedclock"
ENTRY_ORIG="PARSEINI2_JMPTBL_BATTCLOCK_WriteSecondsToBatteryBackedClock"
ENTRY_SASC="PARSEINI2_JMPTBL_BATTCLOCK_Write"
TARGET="BATTCLOCK_WriteSecondsToBatteryBackedClock"
mkdir -p "$OUT_DIR"
