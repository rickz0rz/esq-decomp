...
BASE="cleanup_shutdown_input_devices"
...
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_shutdown_input_devices.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_shutdown_input_devices.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
