...
SASC_SRC="gcommand_init_preset_work_entry.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_init_preset_work_entry"
ENTRY="GCOMMAND_InitPresetWorkEntry"
ENTRY_SASC_REGEX="^GCOMMAND_InitPresetWorkEntry[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_init_preset_work_entry.awk \
