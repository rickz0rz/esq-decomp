...
SASC_SRC="esqshared_replace_movie_rating_token.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/p/esqshared.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared_replace_movie_rating_token"
ENTRY_ORIG="ESQSHARED_ReplaceMovieRatingToken"
ENTRY_SASC_REGEX="^ESQSHARED_ReplaceMovieRatingToke[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared_replace_movie_rating_token.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared_replace_movie_rating_token.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
