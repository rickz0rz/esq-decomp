...
BASE="clock_convert"
ENTRY="CLOCK_ConvertAmigaSecondsToClockData"
ENTRY_SASC_REGEX="^CLOCK_ConvertAmigaSecondsToClock[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_clock_convert_amiga_seconds_to_clock_data.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_clock_convert_amiga_seconds_to_clock_data.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
