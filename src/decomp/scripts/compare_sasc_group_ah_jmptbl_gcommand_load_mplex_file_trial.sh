...
BASE="group_ah_jmptbl_gcommand_load_mplex_file"
ENTRY_ORIG="GROUP_AH_JMPTBL_GCOMMAND_LoadMplexFile"
ENTRY_SASC="GROUP_AH_JMPTBL_GCOMMAND_LoadMpl"
TARGET="GCOMMAND_LoadMplexFile"
mkdir -p "$OUT_DIR"
