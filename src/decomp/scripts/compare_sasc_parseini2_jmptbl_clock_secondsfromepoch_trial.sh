...
BASE="parseini2_jmptbl_clock_secondsfromepoch"
ENTRY_ORIG="PARSEINI2_JMPTBL_CLOCK_SecondsFromEpoch"
ENTRY_SASC="PARSEINI2_JMPTBL_CLOCK_SecondsFr"
TARGET="CLOCK_SecondsFromEpoch"
mkdir -p "$OUT_DIR"
