...

{
    ...
    if (u ~ /^SCRIPT_RESETBANNERCHARDEFAULTS:/ || u ~ /^SCRIPT_RESETBANNERCHARDEFAUL[A-Z0-9_]*:/) has_entry = 1
    ...
    if (n ~ /TEXTDISPCURRENTMATCHINDEX/ || n ~ /TEXTDISPCURRENTMATCHINDE/) has_match_index = 1
