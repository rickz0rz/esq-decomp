...
SRC_C="src/decomp/c/replacements/str_find_char_ptr_gcc.c"
ORIG_ASM="src/modules/submodules/unknown7.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/str_find_char_ptr.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/str_find_char_ptr.original_slice.s"
GEN_SLICE="${OUT_DIR}/str_find_char_ptr.generated_slice.s"
ORIG_NORM="${OUT_DIR}/str_find_char_ptr.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/str_find_char_ptr.generated_slice.norm.s"
