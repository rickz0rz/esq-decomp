...
cd "$ROOT_DIR"
SASC_SRC="group_am_jmptbl_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/m/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_am_jmptbl_script_primebannertransitionfromhexcode"
ENTRY_ORIG="GROUP_AM_JMPTBL_SCRIPT_PrimeBannerTransitionFromHexCode"
ENTRY_SASC="GROUP_AM_JMPTBL_SCRIPT_PrimeBann"
TARGET="SCRIPT_PrimeBannerTransitionFromHexCode"
mkdir -p "$OUT_DIR"
