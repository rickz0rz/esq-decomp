...
BASE="group_am_jmptbl_flib2_resetandloadlistingtemplates"
ENTRY_ORIG="GROUP_AM_JMPTBL_FLIB2_ResetAndLoadListingTemplates"
ENTRY_SASC="GROUP_AM_JMPTBL_FLIB2_ResetAndLo"
TARGET="FLIB2_ResetAndLoadListingTemplates"
mkdir -p "$OUT_DIR"
