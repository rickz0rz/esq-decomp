...
BASE="diskio1_append_attr_flag_ditto"
ENTRY="DISKIO1_AppendAttrFlagDitto"
ENTRY_SASC_REGEX="^DISKIO1_AppendAttrFlagDitto[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_APPENDATTRFLAGDITTO:"
ENTRY_ALT_SEM="DISKIO1_APPENDATTRFLAGDITTO:"
TARGET_SEM="DISKIO1_APPENDATTRFLAGALTHILITES"
EXPECTED_BIT="5"
FORMAT_LABEL_PREFIX="DISKIO_STR_DITTO_CompactSourceAt"
