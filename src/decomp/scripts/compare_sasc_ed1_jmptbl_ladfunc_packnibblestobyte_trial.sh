...
BASE="ed1_jmptbl_ladfunc_packnibblestobyte"
ENTRY_ORIG="ED1_JMPTBL_LADFUNC_PackNibblesToByte"
ENTRY_SASC="ED1_JMPTBL_LADFUNC_PackNibblesTo"
TARGET="LADFUNC_SetPackedPenHighNibble"
mkdir -p "$OUT_DIR"
