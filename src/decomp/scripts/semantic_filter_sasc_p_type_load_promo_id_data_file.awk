...

{
    ...
    if (n ~ /PTYPEJMPTBLSTRINGFINDSUBSTRING/ || n ~ /PTYPEJMPTBLSTRINGFINDSUBSTRI/) find=1
    if (n ~ /SCRIPT3JMPTBLPARSEREADSIGNEDLONGSKIPCLASS3ALT/ || n ~ /SCRIPT3JMPTBLPARSEREADSIGNEDL/) parse=1
