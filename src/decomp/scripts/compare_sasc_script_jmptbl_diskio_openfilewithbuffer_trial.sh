...
BASE="script_jmptbl_diskio_openfilewithbuffer"
ENTRY_ORIG="SCRIPT_JMPTBL_DISKIO_OpenFileWithBuffer"
ENTRY_SASC="SCRIPT_JMPTBL_DISKIO_OpenFileWit"
TARGET="DISKIO_OpenFileWithBuffer"
mkdir -p "$OUT_DIR"
