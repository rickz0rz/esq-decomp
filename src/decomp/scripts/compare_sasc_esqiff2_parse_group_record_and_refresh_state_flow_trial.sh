...
SASC_SRC="esqiff2_parse_group_record_and_refresh.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_parse_group_record_and_refresh_state_flow"
ENTRY_ORIG="ESQIFF2_ParseGroupRecordAndRefresh"
ENTRY_SASC_REGEX="^ESQIFF2_ParseGroupRecordAndRef[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_parse_group_record_and_refresh_state_flow.awk \
