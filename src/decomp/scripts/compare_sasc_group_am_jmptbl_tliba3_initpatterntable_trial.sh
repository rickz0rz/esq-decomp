...
BASE="group_am_jmptbl_tliba3_initpatterntable"
ENTRY_ORIG="GROUP_AM_JMPTBL_TLIBA3_InitPatternTable"
ENTRY_SASC="GROUP_AM_JMPTBL_TLIBA3_InitPatte"
TARGET="TLIBA3_InitPatternTable"
mkdir -p "$OUT_DIR"
