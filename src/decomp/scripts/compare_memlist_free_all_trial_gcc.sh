...
SRC_C="src/decomp/c/replacements/memlist_free_all_gcc.c"
ORIG_ASM="src/modules/submodules/unknown24.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/memlist_free_all.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/memlist_free_all.original_slice.s"
GEN_SLICE="${OUT_DIR}/memlist_free_all.generated_slice.s"
ORIG_NORM="${OUT_DIR}/memlist_free_all.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/memlist_free_all.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_memlist_free_all.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_memlist_free_all.awk "$GEN_NORM" > "$GEN_SEM"
