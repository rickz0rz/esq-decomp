...
SRC_C="src/decomp/c/replacements/string_append_n_gcc.c"
ORIG_ASM="src/modules/submodules/unknown5.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/string_append_n.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/string_append_n.original_slice.s"
GEN_SLICE="${OUT_DIR}/string_append_n.generated_slice.s"
ORIG_NORM="${OUT_DIR}/string_append_n.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/string_append_n.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_str_append_n.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_str_append_n.awk "$GEN_NORM" > "$GEN_SEM"
