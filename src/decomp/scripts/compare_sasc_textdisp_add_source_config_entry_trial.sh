...
SASC_SRC="textdisp_add_source_config_entry.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp_add_source_config_entry"
ENTRY="TEXTDISP_AddSourceConfigEntry"
ENTRY_SASC_REGEX="^TEXTDISP_AddSourceConfigEntry[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp_add_source_config_entry.awk \
