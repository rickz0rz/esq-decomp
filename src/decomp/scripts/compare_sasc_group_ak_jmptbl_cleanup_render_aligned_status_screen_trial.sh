...
BASE="group_ak_jmptbl_cleanup_render_aligned_status_screen"
ENTRY_ORIG="GROUP_AK_JMPTBL_CLEANUP_RenderAlignedStatusScreen"
ENTRY_SASC="GROUP_AK_JMPTBL_CLEANUP_RenderAl"
