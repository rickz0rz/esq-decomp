...
SASC_SRC="ladfunc_build_entry_buffers_or_default.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_build_entry_buffers_or_default"
ENTRY="LADFUNC_BuildEntryBuffersOrDefault"
ENTRY_SASC_REGEX="^LADFUNC_BuildEntryBuffersOrD[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_build_entry_buffers_or_default.awk \
