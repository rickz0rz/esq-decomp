...
BASE="parse_readsignedlong_parse_loop"
ENTRY="PARSE_ReadSignedLong_ParseLoop"
ENTRY_SASC_REGEX="^PARSE_ReadSignedLong_ParseLoop[A-Za-z0-9_]*:$"
...
awk -v ENTRY="$ENTRY" -f src/decomp/scripts/semantic_filter_parse_readsignedlong_parse_loop.awk \
