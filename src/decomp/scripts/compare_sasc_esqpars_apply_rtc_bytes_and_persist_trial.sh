...
SASC_SRC="esqpars_apply_rtc_bytes_and_persist.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqpars.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqpars_apply_rtc_bytes_and_persist"
ENTRY_ORIG="ESQPARS_ApplyRtcBytesAndPersist"
ENTRY_SASC_REGEX="^ESQPARS_ApplyRtcBytesAndPersist[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqpars_apply_rtc_bytes_and_persist.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqpars_apply_rtc_bytes_and_persist.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
