;------------------------------------------------------------------------------
; DECOMP TARGETS ED main editor / ESC-state helper module boundary
; SOURCE: modules/groups/a/k/ed.s
; PURPOSE:
;   Direct object-level hybrid replacement for the ED module now that the
;   restored SAS/C lane covers the module's full non-JMPTBL editor, ESC-menu,
;   diagnostics, and save/reboot helper export set. This replacement carries
;   the module body directly instead of delegating back to the canonical asm
;   include.
;------------------------------------------------------------------------------
