...
SASC_SRC="esqiff2_pad_entries_to_max_title_width.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_pad_entries_to_max_title_width"
ENTRY="ESQIFF2_PadEntriesToMaxTitleWidth"
ENTRY_SASC_REGEX="^ESQIFF2_PadEntriesToMaxTitleW[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_pad_entries_to_max_title_width.awk \
