...
BASE="esqfunc_jmptbl_esq_clampbannercharrange"
ENTRY_ORIG="ESQFUNC_JMPTBL_ESQ_ClampBannerCharRange"
ENTRY_SASC="ESQFUNC_JMPTBL_ESQ_ClampBannerCh"
TARGET="ESQ_ClampBannerCharRange"
mkdir -p "$OUT_DIR"
