...
BASE="group_am_jmptbl_textdisp_loadsourceconfig"
ENTRY_ORIG="GROUP_AM_JMPTBL_TEXTDISP_LoadSourceConfig"
ENTRY_SASC="GROUP_AM_JMPTBL_TEXTDISP_LoadSou"
TARGET="TEXTDISP_LoadSourceConfig"
mkdir -p "$OUT_DIR"
