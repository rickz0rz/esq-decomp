...
SASC_SRC="diskio2_flush_reload_helpers.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/h/diskio2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio2_reload_data_files_and_rebuild_index"
ENTRY="DISKIO2_ReloadDataFilesAndRebuildIndex"
ENTRY_SASC_REGEX="^DISKIO2_ReloadDataFilesAndRe[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO2_RELOADDATAFILESANDREB"
ENTRY_ALT_SEM="DISKIO2_RELOADDATAFILESANDRE"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio2_reload_helper.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio2_reload_helper.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
