...
; PURPOSE:
;   Object-level hybrid replacement for the PARSEINI module now that the
;   restored SAS/C lane covers the module's full non-JMPTBL config, weather,
;   and font-loading helper export set. This replacement now carries the
;   module body directly instead of delegating back to the canonical asm
;   include, while keeping the module's PARSEINI_JMPTBL_* wrappers as build
;   glue.
;------------------------------------------------------------------------------
