...
; PURPOSE:
;   Object-level hybrid replacement for UNKNOWN11 now that the restored SAS/C
;   lane covers DOS_SeekByIndex. This replacement now carries the module body
...
;   D0-D7/A3
; CALLS:
;   HANDLE_GetEntryByIndex, DOS_SeekWithErrorState
; READS:
;   Global_DosIoErr
; WRITES:
;   none
; DESC:
;   Resolves a buffered-handle table index, then seeks the underlying DOS
;   handle and reports -1 when the lookup or DOS call leaves IoErr set.
;------------------------------------------------------------------------------
DOS_SeekByIndex:
    MOVEM.L D4-D7/A3,-(A7)
    MOVE.L  24(A7),D7
