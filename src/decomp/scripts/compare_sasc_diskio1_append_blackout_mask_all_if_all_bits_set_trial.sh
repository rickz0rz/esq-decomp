...
BASE="diskio1_append_blackout_mask_all_if_all_bits_set"
ENTRY="DISKIO1_AppendBlackoutMaskAllIfAllBitsSet"
ENTRY_SASC_REGEX="^DISKIO1_AppendBlackoutMaskAllIfA[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_APPENDBLACKOUTMASKALLIFALLBITSSET:"
ENTRY_ALT_SEM="DISKIO1_APPENDBLACKOUTMASKALLIFA"
TARGET_SEM="DISKIO1_APPENDBLACKOUTMASKVALUEH"
