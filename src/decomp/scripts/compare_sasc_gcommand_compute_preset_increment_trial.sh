...
SASC_SRC="gcommand_compute_preset_increment.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_compute_preset_increment"
ENTRY="GCOMMAND_ComputePresetIncrement"
ENTRY_SASC_REGEX="^GCOMMAND_ComputePresetIncrement[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_compute_preset_increment.awk \
