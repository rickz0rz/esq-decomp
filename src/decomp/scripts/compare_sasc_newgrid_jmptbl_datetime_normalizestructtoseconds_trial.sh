...
BASE="newgrid_jmptbl_datetime_normalizestructtoseconds"
ENTRY_ORIG="NEWGRID_JMPTBL_DATETIME_NormalizeStructToSeconds"
ENTRY_SASC="NEWGRID_JMPTBL_DATETIME_Normaliz"
TARGET="DATETIME_NormalizeStructToSeconds"
mkdir -p "$OUT_DIR"
