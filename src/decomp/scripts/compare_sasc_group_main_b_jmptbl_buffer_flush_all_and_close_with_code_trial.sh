...
BASE="group_main_b_jmptbl_buffer_flush_all_and_close_with_code"
ENTRY_ORIG="GROUP_MAIN_B_JMPTBL_BUFFER_FlushAllAndCloseWithCode"
ENTRY_SASC="GROUP_MAIN_B_JMPTBL_BUFFER_Flush"
