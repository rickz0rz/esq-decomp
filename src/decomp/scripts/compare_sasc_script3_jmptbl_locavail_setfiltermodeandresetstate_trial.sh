...
BASE="script3_jmptbl_locavail_setfiltermodeandresetstate"
ENTRY_ORIG="SCRIPT3_JMPTBL_LOCAVAIL_SetFilterModeAndResetState"
ENTRY_SASC="SCRIPT3_JMPTBL_LOCAVAIL_SetFilte"
TARGET="LOCAVAIL_SetFilterModeAndResetState"
mkdir -p "$OUT_DIR"
