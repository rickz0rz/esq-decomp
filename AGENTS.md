...
`src/c/replacements-all.txt` is the one to grow. It stands at **795 entries**,
...
**At 795 it is PROVEN END TO END** (2026-08-03), on the same sequence that
proved 440: `check_pcrel_range` 0 truncated of 50 calls, `a6_audit` 0 of 794,
...
**The maximum-C build is 95.3% C by CODE byte.** 220,300 bytes of 231,108 come
from compiled C. 10,808 bytes are assembly.
