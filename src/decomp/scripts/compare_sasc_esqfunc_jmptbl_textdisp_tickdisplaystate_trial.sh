...
BASE="esqfunc_jmptbl_textdisp_tickdisplaystate"
ENTRY_ORIG="ESQFUNC_JMPTBL_TEXTDISP_TickDisplayState"
ENTRY_SASC="ESQFUNC_JMPTBL_TEXTDISP_TickDisp"
TARGET="TEXTDISP_TickDisplayState"
mkdir -p "$OUT_DIR"
