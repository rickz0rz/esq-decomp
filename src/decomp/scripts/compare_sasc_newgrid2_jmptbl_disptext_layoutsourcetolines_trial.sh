...
BASE="newgrid2_jmptbl_disptext_layoutsourcetolines"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_LayoutSourceToLines"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_LayoutS"
TARGET="DISPTEXT_LayoutSourceToLines"
mkdir -p "$OUT_DIR"
