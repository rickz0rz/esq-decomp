...
BASE="script3_jmptbl_esqpars_applyrtcbytesandpersist"
ENTRY_ORIG="SCRIPT3_JMPTBL_ESQPARS_ApplyRtcBytesAndPersist"
ENTRY_SASC="SCRIPT3_JMPTBL_ESQPARS_ApplyRtcB"
TARGET="ESQPARS_ApplyRtcBytesAndPersist"
mkdir -p "$OUT_DIR"
