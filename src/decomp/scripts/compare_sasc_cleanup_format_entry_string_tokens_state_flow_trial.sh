...
BASE="cleanup_format_entry_string_tokens_state_flow"
...
awk -v e="^${ENTRY}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^;!======/) exit; print }' \
...
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_format_entry_string_tokens_state_flow.awk \
