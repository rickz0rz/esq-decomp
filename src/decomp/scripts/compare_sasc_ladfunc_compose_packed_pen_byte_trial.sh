...
SASC_SRC="ladfunc_compose_packed_pen_byte.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_compose_packed_pen_byte"
ENTRY="LADFUNC_ComposePackedPenByte"
ENTRY_SASC_REGEX="^LADFUNC_ComposePackedPenBy[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_compose_packed_pen_byte.awk \
