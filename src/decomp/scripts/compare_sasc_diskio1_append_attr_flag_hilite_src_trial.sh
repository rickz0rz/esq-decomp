...
BASE="diskio1_append_attr_flag_hilite_src"
ENTRY="DISKIO1_AppendAttrFlagHiliteSrc"
ENTRY_SASC_REGEX="^DISKIO1_AppendAttrFlagHiliteSrc[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_APPENDATTRFLAGHILITESRC:"
ENTRY_ALT_SEM="DISKIO1_APPENDATTRFLAGHILITESRC:"
TARGET_SEM="DISKIO1_APPENDATTRFLAGSUMMARYSRC"
EXPECTED_BIT="1"
FORMAT_LABEL_PREFIX="DISKIO_STR_HILITE_SRC_CompactSou"
