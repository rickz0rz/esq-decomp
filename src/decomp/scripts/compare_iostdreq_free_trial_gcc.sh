...
SRC_C="src/decomp/c/replacements/iostdreq_free_gcc.c"
ORIG_ASM="src/modules/submodules/unknown21.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/iostdreq_free.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/iostdreq_free.original_slice.s"
GEN_SLICE="${OUT_DIR}/iostdreq_free.generated_slice.s"
ORIG_NORM="${OUT_DIR}/iostdreq_free.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/iostdreq_free.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_iostdreq_free.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_iostdreq_free.awk "$GEN_NORM" > "$GEN_SEM"
