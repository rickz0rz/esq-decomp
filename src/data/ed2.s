    ...
    XDEF    _ED2_STR_LOCAL_EDIT_NOT_AVAILABLE
    ...
    XDEF    _ESQ_STR_SATELLITE_DELIVERED_SCROLL_SPEED_PCT_C
    XDEF    _Global_STR_SPEED_ZERO_NOT_AVAILABLE
    XDEF    _Global_STR_SPEED_ONE_NOT_AVAILABLE
    XDEF    _Global_STR_SCROLL_SPEED_2
    XDEF    _Global_STR_SCROLL_SPEED_3
    XDEF    _Global_STR_SCROLL_SPEED_4
    XDEF    _Global_STR_SCROLL_SPEED_5
    XDEF    _Global_STR_SCROLL_SPEED_6
    XDEF    _Global_STR_SCROLL_SPEED_7
    ...
    XDEF    _Global_STR_ENTER_AD_NUMBER_ONE_HYPHEN
    XDEF    _Global_STR_LEFT_PARENTHESIS_THEN
    XDEF    _Global_STR_PUSH_RETURN_TO_ENTER_SELECTION_2
    XDEF    _Global_STR_SINGLE_SPACE_4
    XDEF    _Global_STR_AD_NUMBER_QUESTIONMARK
    ...
    XDEF    _Global_STR_PUSH_ESC_TO_MAKE_ANOTHER_SELECTION
    XDEF    _Global_STR_PUSH_HELP_FOR_OTHER_EDIT_FUNCTIONS
    XDEF    _Global_STR_LINE_MODE_ON_TEXT_COLOR_MODE
    XDEF    _Global_STR_EDITING_AD_NUMBER_FORMATTED_1
    XDEF    _Global_STR_EDITING_AD_NUMBER_FORMATTED_2
    XDEF    _ED2_STR_PUSH_ANY_KEY_TO_CONTINUE_DOT
    XDEF    _ED2_STR_STAR_STAR_LINE_SLASH_PAGE_COMMANDS_S
    XDEF    _ED2_STR_F1_COLON_HOME_F6_COLON_CLEAR
    XDEF    _ED2_STR_F2_COLON_LINE_SLASH_PAGE_MODE_F7_COL
    XDEF    _ED2_CMD_F3_COLON_CENTER_F8_COLON_DELETE_LINE
    XDEF    _ED2_STR_F4_COLON_LEFT_JUSTIFY_F9_COLON_APPLY
    XDEF    _ED2_STR_F5_COLON_RIGHT_JUSTIFY_F10_COLON_INS
    XDEF    _Global_STR_SHIFT_RIGHT_NEXT_AD_DEL_DELETE_CHAR
    XDEF    _Global_STR_SHIFT_LEFT_PREV_AD_CTRLC_COLOR_MODE
    XDEF    _Global_STR_CTRLF_FOREGROUND_CTRLB_BACKGROUND
; ========== ED2.c ==========
...
_ED2_STR_LOCAL_EDIT_NOT_AVAILABLE:
...
; USED BY: _GCOMMAND_BuildBannerTables, _ESQSHARED4_TickCopperAndBannerTransitions
...
_ESQ_STR_SATELLITE_DELIVERED_SCROLL_SPEED_PCT_C:
    NStr    "Satellite Delivered scroll speed (%c)"
_Global_STR_SPEED_ZERO_NOT_AVAILABLE:
    NStr    "Speed 0 not available"
_Global_STR_SPEED_ONE_NOT_AVAILABLE:
    NStr    "Speed 1 not available"
_Global_STR_SCROLL_SPEED_2:
    NStr    "Scroll speed = 2 (fastest)"
_Global_STR_SCROLL_SPEED_3:
    NStr    "Scroll speed = 3 (default)"
_Global_STR_SCROLL_SPEED_4:
    NStr    "Scroll speed = 4"
_Global_STR_SCROLL_SPEED_5:
    NStr    "Scroll speed = 5"
_Global_STR_SCROLL_SPEED_6:
    NStr    "Scroll speed = 6"
_Global_STR_SCROLL_SPEED_7:
...
_Global_STR_ENTER_AD_NUMBER_ONE_HYPHEN:
    NStr    " Enter ad number (1-"
_Global_STR_LEFT_PARENTHESIS_THEN:
    NStr    ") then"
_Global_STR_PUSH_RETURN_TO_ENTER_SELECTION_2:
    NStr    " push RETURN to enter selection"
_Global_STR_SINGLE_SPACE_4:
    NStr    " "
_Global_STR_AD_NUMBER_QUESTIONMARK:
    NStr    "Ad Number? "
...
_Global_STR_PUSH_ESC_TO_MAKE_ANOTHER_SELECTION:
    NStr    " Push ESC to make another selection."
_Global_STR_PUSH_HELP_FOR_OTHER_EDIT_FUNCTIONS:
    NStr    " Push HELP for other edit functions."
_Global_STR_LINE_MODE_ON_TEXT_COLOR_MODE:
    NStr    " Line mode on       Text color mode "
_Global_STR_EDITING_AD_NUMBER_FORMATTED_1:
    NStr    "Editing Ad Number %2ld"
_Global_STR_EDITING_AD_NUMBER_FORMATTED_2:
    NStr    "Editing Ad Number %2ld"
_ED2_STR_PUSH_ANY_KEY_TO_CONTINUE_DOT:
    NStr    "Push any key to continue."
_ED2_STR_STAR_STAR_LINE_SLASH_PAGE_COMMANDS_S:
    NStr    "     ** Line/Page Commands **"
_ED2_STR_F1_COLON_HOME_F6_COLON_CLEAR:
    NStr    "F1: Home               F6: Clear"
_ED2_STR_F2_COLON_LINE_SLASH_PAGE_MODE_F7_COL:
    NStr    "F2: Line/Page mode     F7: Insert Line"
_ED2_CMD_F3_COLON_CENTER_F8_COLON_DELETE_LINE:
    NStr    "F3: Center             F8: Delete Line"
_ED2_STR_F4_COLON_LEFT_JUSTIFY_F9_COLON_APPLY:
    NStr    "F4: Left Justify       F9: Apply Color"
_ED2_STR_F5_COLON_RIGHT_JUSTIFY_F10_COLON_INS:
    NStr    "F5: Right Justify     F10: Insert char"
_Global_STR_SHIFT_RIGHT_NEXT_AD_DEL_DELETE_CHAR:
    NStr    "Shift ->: next Ad     DEL: Delete char"
_Global_STR_SHIFT_LEFT_PREV_AD_CTRLC_COLOR_MODE:
    NStr    "Shift <-: prev Ad   CTRLC: Color Mode"
_Global_STR_CTRLF_FOREGROUND_CTRLB_BACKGROUND:
