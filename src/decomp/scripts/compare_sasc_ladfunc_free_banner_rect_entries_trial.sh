...
SASC_SRC="ladfunc_free_banner_rect_entries.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_free_banner_rect_entries"
ENTRY="LADFUNC_FreeBannerRectEntries"
ENTRY_SASC_REGEX="^LADFUNC_FreeBannerRectEntr[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_free_banner_rect_entries.awk \
