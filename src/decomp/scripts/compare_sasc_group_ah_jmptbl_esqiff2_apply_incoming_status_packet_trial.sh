...
BASE="group_ah_jmptbl_esqiff2_apply_incoming_status_packet"
ENTRY_ORIG="GROUP_AH_JMPTBL_ESQIFF2_ApplyIncomingStatusPacket"
ENTRY_SASC="GROUP_AH_JMPTBL_ESQIFF2_ApplyInc"
TARGET="ESQIFF2_ApplyIncomingStatusPacket"
mkdir -p "$OUT_DIR"
