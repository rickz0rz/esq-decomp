...
SASC_SRC="gcommand_consume_banner_queue_entry.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_consume_banner_queue_entry"
ENTRY="GCOMMAND_ConsumeBannerQueueEntry"
ENTRY_SASC_REGEX="^GCOMMAND_ConsumeBannerQueueEntry[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_consume_banner_queue_entry.awk \
