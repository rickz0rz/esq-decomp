...
SRC_C="src/decomp/c/replacements/exec_call_vector_48_gcc.c"
ORIG_ASM="src/modules/submodules/unknown40.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/exec_call_vector_48.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/exec_call_vector_48.original_slice.s"
GEN_SLICE="${OUT_DIR}/exec_call_vector_48.generated_slice.s"
ORIG_NORM="${OUT_DIR}/exec_call_vector_48.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/exec_call_vector_48.generated_slice.norm.s"
...
awk '
$0 ~ /^EXEC_CallVector_48:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;!======/) exit
    print
}
...
awk '
$0 ~ /^_?EXEC_CallVector_48:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_exec_call_vector_48.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_exec_call_vector_48.awk "$GEN_NORM" > "$GEN_SEM"
