...
BASE="dos_system_taglist"
ENTRY="DOS_SystemTagList"
ENTRY_SASC_REGEX="^DOS_SystemTagList[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_dos_system_tag_list.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_dos_system_tag_list.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
