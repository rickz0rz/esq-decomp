...

{
    ...
    if (n ~ /ESQFUNCJMPTBLLOCAVAILREBUILDFILTERSTATEFROMCURRENTGROUP/ || n ~ /ESQFUNCJMPTBLLOCAVAILREBUILDF/ || n ~ /LOCAVAILREBUILDFILTERSTATEFROMCURRENTGROUP/ || n ~ /LOCAVAILREBUILDFILTERSTATEFROMCURR/) has_rebuild_filter=1
