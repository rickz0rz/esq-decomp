...
cd "$ROOT_DIR"
SASC_SRC="newgrid2_jmptbl_bevel_draw_bevel_frame_with_top.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/newgrid2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="newgrid2_jmptbl_bevel_drawbevelframewithtop"
ENTRY_ORIG="NEWGRID2_JMPTBL_BEVEL_DrawBevelFrameWithTop"
ENTRY_SASC="NEWGRID2_JMPTBL_BEVEL_DrawBevelF"
TARGET="BEVEL_DrawBevelFrameWithTop"
mkdir -p "$OUT_DIR"
