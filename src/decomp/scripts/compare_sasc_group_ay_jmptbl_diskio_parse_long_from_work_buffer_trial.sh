...
BASE="group_ay_jmptbl_diskio_parse_long_from_work_buffer"
ENTRY_ORIG="GROUP_AY_JMPTBL_DISKIO_ParseLongFromWorkBuffer"
ENTRY_SASC="GROUP_AY_JMPTBL_DISKIO_ParseLong"
TARGET="DISKIO_ParseLongFromWorkBuffer"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AY_JMPTBL_DISKIO_WriteDeci:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
