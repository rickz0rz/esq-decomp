...
BASE="parseini_jmptbl_esqiff_handlebrushinireloadhotkey"
ENTRY_ORIG="PARSEINI_JMPTBL_ESQIFF_HandleBrushIniReloadHotkey"
ENTRY_SASC="PARSEINI_JMPTBL_ESQIFF_HandleBru"
TARGET="ESQIFF_HandleBrushIniReloadHotkey"
mkdir -p "$OUT_DIR"
