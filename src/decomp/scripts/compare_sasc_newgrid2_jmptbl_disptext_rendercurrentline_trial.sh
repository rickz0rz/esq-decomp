...
BASE="newgrid2_jmptbl_disptext_rendercurrentline"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_RenderCurrentLine"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_RenderC"
TARGET="DISPTEXT_RenderCurrentLine"
mkdir -p "$OUT_DIR"
