...
SASC_SRC="esqdisp_fill_program_info_header_fields_return.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqdisp_fill_program_info_header_fields_return"
ENTRY_ORIG="ESQDISP_FillProgramInfoHeaderFields_Return"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_fill_program_info_header_fields_return.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_fill_program_info_header_fields_return.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
