...
SASC_SRC="diskio2_load_oinfo_data_file.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/h/diskio2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="diskio2_load_oinfo_data_file"
ENTRY="DISKIO2_LoadOinfoDataFile"
ENTRY_SASC_REGEX="^DISKIO2_LoadOinfoDataFile[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO2_LOADOINFODATAFILE:"
ENTRY_ALT_SEM="DISKIO2_LOADOINFODATAFILE"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio2_load_oinfo_data_file.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_diskio2_load_oinfo_data_file.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
