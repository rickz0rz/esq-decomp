...
BASE="wdisp_jmptbl_brush_planemaskforindex"
ENTRY_ORIG="WDISP_JMPTBL_BRUSH_PlaneMaskForIndex"
ENTRY_SASC="WDISP_JMPTBL_BRUSH_PlaneMaskForI"
TARGET="BRUSH_PlaneMaskForIndex"
mkdir -p "$OUT_DIR"
