...
BASE="esqdisp_jmptbl_graphics_allocraster"
ENTRY_ORIG="ESQDISP_JMPTBL_GRAPHICS_AllocRaster"
ENTRY_SASC="ESQDISP_JMPTBL_GRAPHICS_AllocRas"
TARGET="GRAPHICS_AllocRaster"
mkdir -p "$OUT_DIR"
