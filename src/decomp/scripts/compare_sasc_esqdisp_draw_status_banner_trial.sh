...
BASE="esqdisp_draw_status_banner"
ENTRY="ESQDISP_DrawStatusBanner"
ENTRY_SASC_REGEX="^ESQDISP_DrawStatusBanner[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_draw_status_banner.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_draw_status_banner.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
