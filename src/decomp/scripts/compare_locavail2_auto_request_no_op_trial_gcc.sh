...
SRC_C="src/decomp/c/replacements/locavail2_auto_request_no_op_gcc.c"
ORIG_ASM="src/modules/groups/a/z/locavail2.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/locavail2_auto_request_no_op.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/locavail2_auto_request_no_op.original_slice.s"
GEN_SLICE="${OUT_DIR}/locavail2_auto_request_no_op.generated_slice.s"
ORIG_NORM="${OUT_DIR}/locavail2_auto_request_no_op.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/locavail2_auto_request_no_op.generated_slice.norm.s"
...
awk '
$0 ~ /^LOCAVAIL2_AutoRequestNoOp:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;!======/) exit
    print
}
...
awk '
$0 ~ /^_?LOCAVAIL2_AutoRequestNoOp:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_locavail2_auto_request_no_op.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_locavail2_auto_request_no_op.awk "$GEN_NORM" > "$GEN_SEM"
