...
; 5) Payload readers:
;      _ESQIFF2_ReadRbfBytesToBuffer / _ESQIFF2_ReadRbfBytesWithXor /
...
; CALLS:
;   _ESQIFF_JMPTBL_MATH_Mulu32, _ESQPARS_JMPTBL_CLEANUP_ParseAlignedListingBlock, _ESQPARS_JMPTBL_DISPLIB_DisplayTextAtPosition, _ESQPARS_JMPTBL_DST_HandleBannerCommand32_33, _ESQPARS_JMPTBL_ESQ_GenerateXorChecksumByte, _ESQPARS_JMPTBL_DISKIO_ParseConfigBuffer, _ESQPARS_JMPTBL_DISKIO_SaveConfigToFileHandle, _ESQPARS_JMPTBL_DISKIO2_HandleInteractiveFileTransfer, _ESQPARS_JMPTBL_P_TYPE_ParseAndStoreTypeRecord, _ESQPARS_JMPTBL_PARSEINI_HandleFontCommand, _ESQPARS_JMPTBL_SCRIPT_ReadSerialRbfByte, _ESQPARS_JMPTBL_ESQPROTO_CopyLabelToGlobal, _ESQPARS_JMPTBL_ESQPROTO_ParseDigitLabelAndDisplay, _ESQPARS_JMPTBL_ESQPROTO_VerifyChecksumAndParseList, _ESQPARS_JMPTBL_ESQPROTO_VerifyChecksumAndParseRecord, _ESQSHARED_JMPTBL_ESQ_ReverseBitsIn6Bytes, _ESQSHARED_JMPTBL_ESQ_TestBit1Based, _ESQ_PollCtrlInput, _GCOMMAND_ParseCommandOptions, _GCOMMAND_ParseCommandString, _GCOMMAND_ParsePPVCommand, _GROUP_AM_JMPTBL_WDISP_SPrintf, _GROUP_AS_JMPTBL_STR_FindCharPtr, _GROUP_AW_JMPTBL_DISPLIB_DisplayTextAtPosition, _ESQDISP_UpdateStatusMaskAndRefresh, _ESQDISP_ParseProgramInfoCommandRecord, _ESQDISP_GetEntryPointerByMode, _ESQDISP_GetEntryAuxPointerByMode, _ESQFUNC_WaitForClockChangeAndServiceUi, _ESQIFF2_ApplyIncomingStatusPacket, _ESQIFF2_ParseLineHeadTailRecord, _ESQIFF2_ParseGroupRecordAndRefresh, _ESQIFF2_ReadRbfBytesToBuffer, _ESQIFF2_ReadRbfBytesWithXor, _ESQIFF2_ReadSerialRecordIntoBuffer, _ESQIFF2_ReadSerialSizedTextRecord, _ESQIFF2_ShowVersionMismatchOverlay, _ESQIFF2_ClearPrimaryEntryFlags34To39, _ESQPARS_ReplaceOwnedString, _ESQPARS_ApplyRtcBytesAndPersist, _ESQPARS_ReadLengthWordWithChecksumXor, _ESQPARS_PersistStateDataAfterCommand, _ESQSHARED_ParseCompactEntryRecord, _ESQSHARED_MatchSelectionCodeWithOptionalSuffix, _LOCAVAIL_ParseFilterStateFromBuffer, _LADFUNC_ParseBannerEntryData
; READS:
;   _CTRL_BUFFER, _CTRL_H, _DATACErrs, _Global_REF_696_400_BITMAP, _Global_REF_RASTPORT_1, _ESQPARS_BannerSubcommandSet, _Global_STR_RESET_COMMAND_RECEIVED, _CTASKS_STR_1, _ESQPARS_PersistOnNextBoxOffFlag, _DISKIO2_InteractiveTransferArmedFlag, _ESQPARS_SelectionSuffixBuffer, _ESQIFF_StatusPacketReadyFlag, _ESQPARS_SelectionMatchCode, _ED_DiagnosticsViewMode, _ESQIFF_RecordBufferPtr, _ESQIFF_RecordChecksumByte, _ESQIFF_RecordLength, _ESQIFF_ParseAttemptCount, _ESQIFF_LineErrorCount, _ESQPARS_Preamble55SeenFlag, _ESQPARS_CommandPreambleArmedFlag, _ESQPARS_ResetArmedFlag, _LOCAVAIL_PrimaryFilterState, _LOCAVAIL_SecondaryFilterState, _SCRIPT_CTRL_CHECKSUM, _SCRIPT_CTRL_READ_INDEX, _SCRIPT_CTRL_STATE, _TEXTDISP_PrimaryGroupCode, _TEXTDISP_PrimaryGroupEntryCount, _TEXTDISP_PrimaryEntryPtrTable, _TEXTDISP_PrimaryTitlePtrTable, _TEXTDISP_SecondaryGroupCode, _TEXTDISP_SecondaryGroupPresentFlag, _TEXTDISP_SecondaryGroupEntryCount, _TEXTDISP_SecondaryEntryPtrTable, _TEXTDISP_SecondaryTitlePtrTable
; WRITES:
;   _DATACErrs, _ESQPARS_PersistOnNextBoxOffFlag, _DISKIO2_InteractiveTransferArmedFlag, _ESQIFF_RecordLength, _ESQIFF_RecordChecksumByte, _ESQIFF_ParseAttemptCount, _ESQIFF_LineErrorCount, _ESQPARS_Preamble55SeenFlag, _ESQPARS_CommandPreambleArmedFlag, _ESQPARS_SelectionMatchCode, _ESQPARS_ResetArmedFlag, _ESQ_GlobalTickCounter
; DESC:
...
.preamble_dispatch_command_byte:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    MOVE.L  D0,-(A7)
    JSR     _ESQPARS_JMPTBL_ESQ_GenerateXorChecksumByte(PC)
...
.cmd_initial_w_upper:
    ...
    MOVE.B  D0,D1
    MOVE.L  D1,-(A7)
    JSR     _ESQPARS_JMPTBL_ESQPROTO_VerifyChecksumAndParseRecord(PC)
...
.cmd_initial_w_lower:
    ...
    JSR     _ESQPARS_JMPTBL_ESQPROTO_VerifyChecksumAndParseList(PC)    ; Jump to _ESQPARS_JMPTBL_ESQPROTO_VerifyChecksumAndParseList(PC)
...
.cmd_bang_begin:
    ...
    PEA     1.W
    PEA     -61(A5)
    BSR.W   _ESQIFF2_ReadRbfBytesWithXor
...
.cmd_bang_verify_xor:
    PEA     1.W
    PEA     -31(A5)
    BSR.W   _ESQIFF2_ReadRbfBytesToBuffer
...
.cmd_l_or_t_banner_entry:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    MOVE.L  D0,-(A7)
    JSR     _LADFUNC_ParseBannerEntryData(PC)
...
.processCommand_xBB_BoxOff:
    ...
    TST.W   _ESQPARS_PersistOnNextBoxOffFlag
    BEQ.S   .cmd_boxoff_apply

    BSR.W   _ESQPARS_PersistStateDataAfterCommand

    MOVEQ   #0,D0
    MOVE.W  D0,_ESQPARS_PersistOnNextBoxOffFlag
...
.cmd_c_group_record:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    BSR.W   _ESQIFF2_ParseGroupRecordAndRefresh
...
.cmd_c_lower_program_info:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    JSR     _ESQDISP_ParseProgramInfoCommandRecord(PC)
...
.cmd_v_lower_aligned_listing:
    ...
    MOVE.L  A0,-(A7)
    JSR     _ESQPARS_JMPTBL_CLEANUP_ParseAlignedListingBlock(PC)
...
.cmd_f_validate_packet_header:
    ...
    MOVE.L  A0,-(A7)
    BSR.W   _ESQIFF2_ApplyIncomingStatusPacket
...
.processCommand_K_Clock:
    ...
    BSR.W   _ESQPARS_ApplyRtcBytesAndPersist
...
.cmd_j_line_head_tail:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    BSR.W   _ESQIFF2_ParseLineHeadTailRecord
...
.cmd_i_parse_digit_label:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    JSR     _ESQPARS_JMPTBL_ESQPROTO_ParseDigitLabelAndDisplay(PC)
...
.cmd_i_lower_copy_label:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    JSR     _ESQPARS_JMPTBL_ESQPROTO_CopyLabelToGlobal(PC)
...
.cmd_r_reset_overlay_center_adjust:
    ...
    MOVEQ   #29,D0
    ADD.L   D0,D1
    PEA     _Global_STR_RESET_COMMAND_RECEIVED
    MOVE.L  D1,-(A7)
    PEA     40.W
    MOVE.L  A1,-(A7)
...
.cmd_o_clear_primary_flags:
    ...
    BSR.W   _ESQIFF2_ClearPrimaryEntryFlags34To39
...
.cmdDATABinaryDL:
    ...
    MOVE.B  D0,D1
    MOVE.L  D1,-(A7)
    JSR     _ESQPARS_JMPTBL_DISKIO2_HandleInteractiveFileTransfer(PC)
...
.cmd_lower_w_verify_list:
    ...
    MOVE.B  -5(A5),D0
    MOVE.L  D0,-(A7)
    JSR     _ESQPARS_JMPTBL_ESQPROTO_VerifyChecksumAndParseList(PC)
...
.processCommand_V_Version:
    ...
    BSR.W   _ESQIFF2_ShowVersionMismatchOverlay
...
.cmd_x_font_command:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    JSR     _ESQPARS_JMPTBL_PARSEINI_HandleFontCommand(PC)
...
.cmd_f_lower_read_config_payload:
    ...
    MOVE.L  D0,-(A7)
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    JSR     _ESQPARS_JMPTBL_DISKIO_ParseConfigBuffer(PC)

    JSR     _ESQPARS_JMPTBL_DISKIO_SaveConfigToFileHandle(PC)
...
.cmd_g_filter_or_banner:
    ...
    MOVE.L  A0,-(A7)
    JSR     _LOCAVAIL_ParseFilterStateFromBuffer(PC)
...
.cmd_g_dispatch_banner_subcommand:
    ...
    MOVE.B  D6,D0
    MOVE.L  D0,-(A7)
    PEA     _ESQPARS_BannerSubcommandSet
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    MOVE.L  D0,-(A7)
    JSR     _ESQPARS_JMPTBL_DST_HandleBannerCommand32_33(PC)
...
.cmd_g_maybe_type_or_options:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    JSR     _ESQPARS_JMPTBL_P_TYPE_ParseAndStoreTypeRecord(PC)
...
.cmd_g_maybe_cmd_options:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    JSR     _GCOMMAND_ParseCommandOptions(PC)
...
.cmd_g_maybe_cmd_string:
    ...
    MOVE.L  _ESQIFF_RecordBufferPtr,-(A7)
    JSR     _GCOMMAND_ParseCommandString(PC)
