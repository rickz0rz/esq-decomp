...
BASE="esqpars_jmptbl_coi_freeentryresources"
ENTRY_ORIG="ESQPARS_JMPTBL_COI_FreeEntryResources"
ENTRY_SASC="ESQPARS_JMPTBL_COI_FreeEntryReso"
TARGET="COI_FreeEntryResources"
mkdir -p "$OUT_DIR"
