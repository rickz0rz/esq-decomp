    XDEF    _DISKIO2_FlushDataFilesIfNeeded


;------------------------------------------------------------------------------
; FUNC: _DISKIO2_FlushDataFilesIfNeeded   (Flush disk data files if needed.)
; ARGS:
;   (none observed)
; RET:
;   D0: none
...
; READS:
;   _DISKIO2_FlushDataFilesGuardFlag, _TEXTDISP_PrimaryGroupEntryCount, _CTASKS_PrimaryOiWritePendingFlag/1B90
; WRITES:
...
_DISKIO2_FlushDataFilesIfNeeded:
    TST.W   _DISKIO2_FlushDataFilesGuardFlag
    BNE.S   .loc_0538

    MOVE.W  #1,_DISKIO2_FlushDataFilesGuardFlag
...
.loc_0537:
    CLR.W   _DISKIO2_FlushDataFilesGuardFlag
