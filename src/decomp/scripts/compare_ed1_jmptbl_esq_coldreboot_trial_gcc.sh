...
SRC_C="src/decomp/c/replacements/ed1_jmptbl_esq_coldreboot_gcc.c"
ORIG_ASM="src/modules/groups/a/k/ed1.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/ed1_jmptbl_esq_coldreboot.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/ed1_jmptbl_esq_coldreboot.original_slice.s"
GEN_SLICE="${OUT_DIR}/ed1_jmptbl_esq_coldreboot.generated_slice.s"
ORIG_NORM="${OUT_DIR}/ed1_jmptbl_esq_coldreboot.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/ed1_jmptbl_esq_coldreboot.generated_slice.norm.s"
ORIG_SEM="${OUT_DIR}/ed1_jmptbl_esq_coldreboot.original_slice.semantic.txt"
GEN_SEM="${OUT_DIR}/ed1_jmptbl_esq_coldreboot.generated_slice.semantic.txt"
...
awk -v start_label="ED1_JMPTBL_ESQ_ColdReboot" -v next_label="ED1_JMPTBL_ESQSHARED4_LoadDefaultPaletteToCopper_NoOp" '
...
awk '$0 ~ /^_?ED1_JMPTBL_ESQ_ColdReboot:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_ed1_jmptbl_esq_coldreboot.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_ed1_jmptbl_esq_coldreboot.awk" "$GEN_NORM" > "$GEN_SEM"
