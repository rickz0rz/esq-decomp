...
BASE="esqiff_jmptbl_esq_deccopperlistsprimary"
ENTRY_ORIG="ESQIFF_JMPTBL_ESQ_DecCopperListsPrimary"
ENTRY_SASC="ESQIFF_JMPTBL_ESQ_DecCopperLists"
TARGET="ESQ_DecCopperListsPrimary"
mkdir -p "$OUT_DIR"
