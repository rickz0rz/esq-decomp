...
function trim(s, t){ t=s; sub(/;.*/,"",t); sub(/^[ \t]+/,"",t); sub(/[ \t]+$/,"",t); return t }
{
    ...
    if (u ~ /GROUP_AE_JMPTBL_TEXTDISP_COMPUTETIMEOFF/ || u ~ /GROUP_AE_JMPTBL_TEXTDISP_COMPUTETIMEOFFSET/ || u ~ /GROUP_AE_JMPTBL_TEXTDISP_COMPUTE$/ || u ~ /GROUP_AE_JMPTBL_TEXTDISP_COMPUTE[A-Z0-9_]*/) has_offset_call = 1
    if (u ~ /GROUP_AG_JMPTBL_MATH_MULU32/) has_mulu_call = 1
