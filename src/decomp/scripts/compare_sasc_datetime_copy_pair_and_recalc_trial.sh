...
SASC_SRC="datetime_copy_pair_and_recalc.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/j/disptext2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="datetime_copy_pair_and_recalc"
ENTRY_ORIG="DATETIME_CopyPairAndRecalc"
ENTRY_SASC_REGEX="^DATETIME_CopyPairAndRecalc[A-Za-z0-9_]*:$"
NEXT_ENTRY_ORIG="DATETIME_ParseString"
...
awk -f src/decomp/scripts/semantic_filter_sasc_datetime_copy_pair_and_recalc.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_datetime_copy_pair_and_recalc.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
