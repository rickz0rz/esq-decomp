...
SASC_SRC="ladfunc_reset_entry_text_buffers.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_reset_entry_text_buffers"
ENTRY="LADFUNC_ResetEntryTextBuffers"
ENTRY_SASC_REGEX="^LADFUNC_ResetEntryTextBuff[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_reset_entry_text_buffers.awk \
