...
BASE="parseini2_jmptbl_clock_convertamigasecondstoclockdata"
ENTRY_ORIG="PARSEINI2_JMPTBL_CLOCK_ConvertAmigaSecondsToClockData"
ENTRY_SASC="PARSEINI2_JMPTBL_CLOCK_ConvertAm"
TARGET="CLOCK_ConvertAmigaSecondsToClockData"
mkdir -p "$OUT_DIR"
