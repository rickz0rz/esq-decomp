...
BASE="newgrid_process_schedule_state_state_flow"
ENTRY="NEWGRID_ProcessScheduleState"
...
awk -f src/decomp/scripts/semantic_filter_sasc_newgrid_process_schedule_state_state_flow.awk \
