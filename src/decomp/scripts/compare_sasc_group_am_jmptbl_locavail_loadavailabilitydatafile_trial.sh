...
BASE="group_am_jmptbl_locavail_loadavailabilitydatafile"
ENTRY_ORIG="GROUP_AM_JMPTBL_LOCAVAIL_LoadAvailabilityDataFile"
ENTRY_SASC="GROUP_AM_JMPTBL_LOCAVAIL_LoadAva"
TARGET="LOCAVAIL_LoadAvailabilityDataFile"
mkdir -p "$OUT_DIR"
