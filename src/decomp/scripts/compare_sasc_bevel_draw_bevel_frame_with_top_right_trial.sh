...
SASC_SRC="bevel_draw_bevel_frame_with_top_right.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/a/bevel.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="bevel_draw_bevel_frame_with_top_right"
ENTRY="BEVEL_DrawBevelFrameWithTopRight"
ENTRY_SASC_REGEX="^BEVEL_DrawBevelFrameWithTopRight[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_bevel_draw_bevel_frame_with_top_right.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_bevel_draw_bevel_frame_with_top_right.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
