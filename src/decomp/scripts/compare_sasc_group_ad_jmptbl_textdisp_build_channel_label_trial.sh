...
BASE="group_ad_jmptbl_textdisp_build_channel_label"
ENTRY_ORIG="GROUP_AD_JMPTBL_TEXTDISP_BuildChannelLabel"
ENTRY_SASC="GROUP_AD_JMPTBL_TEXTDISP_BuildCh"
TARGET="TEXTDISP_BuildChannelLabel"
mkdir -p "$OUT_DIR"
