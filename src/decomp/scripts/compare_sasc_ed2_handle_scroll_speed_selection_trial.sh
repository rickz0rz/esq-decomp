...
SASC_SRC="ed2_handle_scroll_speed_selection.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/k/ed2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed2_handle_scroll_speed_selection"
ENTRY_ORIG="ED2_HandleScrollSpeedSelection"
ENTRY_SASC_REGEX="^ED2_HandleScrollSpeedSelection[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed2_handle_scroll_speed_selection.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed2_handle_scroll_speed_selection.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
