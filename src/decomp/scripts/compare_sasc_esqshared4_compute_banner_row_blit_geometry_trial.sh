...
SASC_SRC="esqshared4_compute_banner_row_blit_geometry.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_compute_banner_row_blit_geometry"
ENTRY="ESQSHARED4_ComputeBannerRowBlitGeometry"
ENTRY_SASC_REGEX="^ESQSHARED4_ComputeBannerRowBlitG[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_compute_banner_row_blit_geometry.awk \
