...

{
    ...
    if (index(u, "TEXTDISP_JMPTBL_ESQDISP_TESTENTRYGRIDELIGIBILITY") > 0 || index(u, "TEXTDISP_JMPTBL_ESQDISP_TESTENTRYGR") > 0 || index(u, "TEXTDISP_JMPTBL_ESQDISP_TESTENTR") > 0 || index(u, "TEXTDISP_SHOULDOPENEDITORFORENTR") > 0 || index(u, "TEXTDISP_SHOULDOPENEDITORFORENTRY") > 0) has_grid = 1
