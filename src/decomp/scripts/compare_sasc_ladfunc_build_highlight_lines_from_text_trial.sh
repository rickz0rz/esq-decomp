...
SASC_SRC="ladfunc_build_highlight_lines_from_text.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/w/ladfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ladfunc_build_highlight_lines_from_text"
ENTRY="LADFUNC_BuildHighlightLinesFromText"
ENTRY_SASC_REGEX="^LADFUNC_BuildHighlightLinesFr[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ladfunc_build_highlight_lines_from_text.awk \
