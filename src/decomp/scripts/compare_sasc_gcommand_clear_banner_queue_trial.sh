...
SASC_SRC="gcommand_clear_banner_queue.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_clear_banner_queue"
ENTRY="GCOMMAND_ClearBannerQueue"
ENTRY_SASC_REGEX="^GCOMMAND_ClearBannerQueue[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_clear_banner_queue.awk \
