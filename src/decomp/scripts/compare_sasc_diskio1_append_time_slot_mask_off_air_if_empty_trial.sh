...
BASE="diskio1_append_time_slot_mask_off_air_if_empty"
ENTRY="DISKIO1_AppendTimeSlotMaskOffAirIfEmpty"
ENTRY_SASC_REGEX="^DISKIO1_AppendTimeSlotMaskOffAir[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_APPENDTIMESLOTMASKOFFAIRIFEMPTY:"
ENTRY_ALT_SEM="DISKIO1_APPENDTIMESLOTMASKOFFAIR"
TARGET_SEM="DISKIO1_APPENDTIMESLOTMASKVALUEH"
