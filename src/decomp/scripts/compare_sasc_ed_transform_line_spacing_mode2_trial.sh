...
SASC_SRC="ed_transform_line_spacing_mode2.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/l/ed3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="ed_transform_line_spacing_mode2"
ENTRY_ORIG="ED_TransformLineSpacing_Mode2"
ENTRY_SASC_REGEX="^ED_TransformLineSpacing_Mode2[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_ed_transform_line_spacing_mode2.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_ed_transform_line_spacing_mode2.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
