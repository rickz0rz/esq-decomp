...
extern const char Global_STR_NEWGRID2_C_3[];
extern const char Global_STR_NEWGRID2_C_4[];
extern const char Global_STR_NEWGRID2_C_5[];
extern const char Global_STR_NEWGRID2_C_6[];
