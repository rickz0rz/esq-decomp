...
SASC_SRC="esqdisp_test_entry_grid_eligibility_return.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqdisp.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqdisp_test_entry_grid_eligibility_return"
ENTRY_ORIG="ESQDISP_TestEntryGridEligibility_Return"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_test_entry_grid_eligibility_return.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_test_entry_grid_eligibility_return.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
