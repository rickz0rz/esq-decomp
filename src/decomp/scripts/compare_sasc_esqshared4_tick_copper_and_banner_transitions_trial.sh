...
SASC_SRC="esqshared4_tick_copper_and_banner_transitions.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_tick_copper_and_banner_transitions"
ENTRY="ESQSHARED4_TickCopperAndBannerTransitions"
ENTRY_SASC_REGEX="^ESQSHARED4_TickCopperAndBannerT[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_tick_copper_and_banner_transitions.awk \
