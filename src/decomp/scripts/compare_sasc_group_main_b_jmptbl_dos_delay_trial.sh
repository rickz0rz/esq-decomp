...
BASE="group_main_b_jmptbl_dos_delay"
ENTRY_ORIG="GROUP_MAIN_B_JMPTBL_DOS_Delay"
ENTRY_SASC="GROUP_MAIN_B_JMPTBL_DOS_Delay"
TARGET="DOS_Delay"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_MAIN_B_JMPTBL_STREAM_Buffe:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
