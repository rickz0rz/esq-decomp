...
BASE="esqiff2_read_serial_bytes_to_buffer_return"
ENTRY="ESQIFF2_ReadSerialBytesToBuffer_Return"
ENTRY_SASC_REGEX="^ESQIFF2_ReadSerialBytesToBuffer_[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_READSERIALBYTESTOBUFFER_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_READSERIALBYTESTOBUFFER_"
