...

{
    ...
    if (index(u, "WDISP_JMPTBL_ESQIFF_RUNCOPPERDROPTRANSITION") > 0 ||
        index(u, "WDISP_JMPTBL_ESQIFF_RUNCOPPERDRO") > 0 ||
        index(u, "ESQIFF_RUNCOPPERDROPTRANSITION") > 0 ||
        index(u, "ESQIFF_RUNCOPPERDRO") > 0) has_drop = 1
