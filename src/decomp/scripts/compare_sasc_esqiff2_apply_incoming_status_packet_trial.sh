...
SASC_SRC="esqiff2_apply_incoming_status_packet.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_apply_incoming_status_packet"
ENTRY="ESQIFF2_ApplyIncomingStatusPacket"
ENTRY_SASC_REGEX="^ESQIFF2_ApplyIncomingStatusP[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_apply_incoming_status_packet.awk \
