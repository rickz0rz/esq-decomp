...
BASE="group_am_jmptbl_buffer_flushallandclosewithcode"
ENTRY_ORIG="GROUP_AM_JMPTBL_BUFFER_FlushAllAndCloseWithCode"
ENTRY_SASC="GROUP_AM_JMPTBL_BUFFER_FlushAllA"
TARGET="BUFFER_FlushAllAndCloseWithCode"
mkdir -p "$OUT_DIR"
