...

{
    ...
    if (n ~ /NEWGRID2JMPTBLDISPTEXTSETLAYOUTPARAMS/ || n ~ /NEWGRID2JMPTBLDISPTEXTSETLAYOUT/ || n ~ /NEWGRID2JMPTBLDISPTEXTSETLAYO/ || n ~ /DISPTEXTSETLAYOUTPARAMS/ || n ~ /DISPTEXTSETLAYOUT/) has_set_layout=1
    if (n ~ /NEWGRIDDRAWGRIDENTRY/) has_draw_entry=1
    if (n ~ /NEWGRID2JMPTBLDISPTEXTSETCURRENTLINEINDEX/ || n ~ /NEWGRID2JMPTBLDISPTEXTSETCURRENT/ || n ~ /NEWGRID2JMPTBLDISPTEXTSETCURR/ || n ~ /DISPTEXTSETCURRENTLINEINDEX/ || n ~ /DISPTEXTSETCURRENT/) has_set_line_index=1
    if (n ~ /PARSEINIJMPTBLWDISPSPRINTF/ || n ~ /WDISPSPRINTF/) has_sprintf=1
    if (n ~ /NEWGRID2JMPTBLDISPTEXTLAYOUTANDAPPENDTOBUFFER/ || n ~ /NEWGRID2JMPTBLDISPTEXTLAYOUTANDAPPEND/ || n ~ /NEWGRID2JMPTBLDISPTEXTLAYOUTA/ || n ~ /DISPTEXTLAYOUTANDAPPENDTOBUFFER/ || n ~ /DISPTEXTLAYOUTANDAPPEND/) has_layout_append=1
    if (n ~ /NEWGRIDDRAWGRIDFRAMEVARIANT2/) has_draw_frame_variant2=1
    if (n ~ /NEWGRID2JMPTBLDISPTEXTCOMPUTEVISIBLELINECOUNT/ || n ~ /NEWGRID2JMPTBLDISPTEXTCOMPUTEVISIBLE/ || n ~ /NEWGRID2JMPTBLDISPTEXTCOMPUTE/ || n ~ /DISPTEXTCOMPUTEVISIBLELINECOUNT/ || n ~ /DISPTEXTCOMPUTEVISIBLE/) has_visible_count=1
