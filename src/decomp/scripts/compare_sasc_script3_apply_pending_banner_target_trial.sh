...
SASC_SRC="script3_apply_pending_banner_target.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/script3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="script3_apply_pending_banner_target"
ENTRY="SCRIPT_ApplyPendingBannerTarget"
ENTRY_SASC_REGEX="^SCRIPT_ApplyPendingBannerTarget[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_script3_apply_pending_banner_target.awk \
