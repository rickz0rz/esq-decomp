...
SRC_C="src/decomp/c/replacements/wdisp_sprintf_gcc.c"
ORIG_ASM="src/modules/submodules/unknown10.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/wdisp_sprintf.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/wdisp_sprintf.original_slice.s"
GEN_SLICE="${OUT_DIR}/wdisp_sprintf.generated_slice.s"
ORIG_NORM="${OUT_DIR}/wdisp_sprintf.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/wdisp_sprintf.generated_slice.norm.s"
...
awk -f src/decomp/scripts/semantic_filter_wdisp_sprintf.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_wdisp_sprintf.awk "$GEN_NORM" > "$GEN_SEM"
