...
BASE="group_al_jmptbl_ladfunc_update_entry_buffers_for_ad_index"
ENTRY_ORIG="GROUP_AL_JMPTBL_LADFUNC_UpdateEntryBuffersForAdIndex"
ENTRY_SASC="GROUP_AL_JMPTBL_LADFUNC_UpdateEn"
TARGET="LADFUNC_UpdateEntryFromTextAndAt"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AL_JMPTBL_ESQ_WriteDecFixe:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
