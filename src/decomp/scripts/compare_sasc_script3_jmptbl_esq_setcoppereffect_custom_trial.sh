...
BASE="script3_jmptbl_esq_setcoppereffect_custom"
ENTRY_ORIG="SCRIPT3_JMPTBL_ESQ_SetCopperEffect_Custom"
ENTRY_SASC="SCRIPT3_JMPTBL_ESQ_SetCopperEffe"
TARGET="ESQ_SetCopperEffect_Custom"
mkdir -p "$OUT_DIR"
