...
BASE="tliba1_jmptbl_esqdisp_getentryauxpointerbymode"
ENTRY_ORIG="TLIBA1_JMPTBL_ESQDISP_GetEntryAuxPointerByMode"
ENTRY_SASC="TLIBA1_JMPTBL_ESQDISP_GetEntryAu"
