...
BASE="group_am_jmptbl_locavail_resetfilterstatestruct"
ENTRY_ORIG="GROUP_AM_JMPTBL_LOCAVAIL_ResetFilterStateStruct"
ENTRY_SASC="GROUP_AM_JMPTBL_LOCAVAIL_ResetFi"
TARGET="LOCAVAIL_ResetFilterStateStruct"
mkdir -p "$OUT_DIR"
