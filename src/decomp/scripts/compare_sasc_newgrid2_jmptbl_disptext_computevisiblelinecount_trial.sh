...
BASE="newgrid2_jmptbl_disptext_computevisiblelinecount"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_ComputeVisibleLineCount"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_Compute"
TARGET="DISPTEXT_ComputeVisibleLineCount"
mkdir -p "$OUT_DIR"
