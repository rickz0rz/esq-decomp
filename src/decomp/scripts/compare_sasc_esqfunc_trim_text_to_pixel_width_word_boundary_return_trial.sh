...
SASC_SRC="esqfunc_trim_text_to_pixel_width_word_boundary_return.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/n/esqfunc.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqfunc_trim_text_to_pixel_width_word_boundary_return"
ENTRY_ORIG="ESQFUNC_TrimTextToPixelWidthWordBoundary_Return"
ENTRY_SASC_REGEX="^ESQFUNC_TrimTextToPixelWidthWord[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqfunc_trim_text_to_pixel_width_word_boundary_return.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_esqfunc_trim_text_to_pixel_width_word_boundary_return.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
