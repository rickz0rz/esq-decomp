...
function trim(s,t){t=s; sub(/;.*/,"",t); sub(/^[ \t]+/,"",t); sub(/[ \t]+$/,"",t); return t}
{
 ...
 if (n ~ /SCRIPTJMPTBLMEMORYDEALLOCATEMEMORY/ || n ~ /SCRIPTJMPTBLMEMORYDEALLOCATEMEMOR/ || n ~ /SCRIPTJMPTBLMEMORYDEALLOCATEM/ || n ~ /MEMORYDEALLOCATEMEMORY/ || n ~ /MEMORYDEALLOCATEMEMOR/ || n ~ /MEMORYDEALLOCATEM/) has_free=1
