...
BASE="diskio2_receive_transfer_blocks_to_file_state_flow"
...
awk -f src/decomp/scripts/semantic_filter_sasc_diskio2_receive_transfer_blocks_to_file_state_flow.awk \
