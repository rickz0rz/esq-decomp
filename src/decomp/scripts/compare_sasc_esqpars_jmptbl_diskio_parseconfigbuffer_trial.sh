...
BASE="esqpars_jmptbl_diskio_parseconfigbuffer"
ENTRY_ORIG="ESQPARS_JMPTBL_DISKIO_ParseConfigBuffer"
ENTRY_SASC="ESQPARS_JMPTBL_DISKIO_ParseConfi"
TARGET="DISKIO_ParseConfigBuffer"
mkdir -p "$OUT_DIR"
