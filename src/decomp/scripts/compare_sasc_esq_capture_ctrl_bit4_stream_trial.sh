...
SASC_SRC="esq_capture_ctrl_bit4_stream.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/a/app.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esq_capture_ctrl_bit4_stream"
ENTRY="ESQ_CaptureCtrlBit4Stream"
ENTRY_SASC_REGEX="^ESQ_CaptureCtrlBit4Stream[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQ_CAPTURECTRLBIT4STREAM:"
ENTRY_ALT_SEM="ESQ_CAPTURECTRLBIT4STREAM"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_esq_capture_ctrl_bit4_stream.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_esq_capture_ctrl_bit4_stream.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
