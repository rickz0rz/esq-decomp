...
SASC_SRC="get_bit_3_of_ciab_pra_into_d1.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/a/app.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="get_bit_3_of_ciab_pra_into_d1"
ENTRY="GET_BIT_3_OF_CIAB_PRA_INTO_D1"
ENTRY_SASC_REGEX="^GET_BIT_3_OF_CIAB_PRA_INTO_D1[A-Za-z0-9_]*:$"
ENTRY_SEM="GET_BIT_3_OF_CIAB_PRA_INTO_D1:"
ENTRY_ALT_SEM="GET_BIT_3_OF_CIAB_PRA_INTO_D1"
...
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_get_bit_3_of_ciab_pra_into_d1.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -v ENTRY_PREFIX="$ENTRY_SEM" -v ENTRY_ALT_PREFIX="$ENTRY_ALT_SEM" -f src/decomp/scripts/semantic_filter_sasc_get_bit_3_of_ciab_pra_into_d1.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
