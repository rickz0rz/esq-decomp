...
cd "$ROOT_DIR"
SASC_SRC="newgrid2_jmptbl_disptext_compute_marker_widths.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/newgrid2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="newgrid2_jmptbl_disptext_computemarkerwidths"
ENTRY_ORIG="NEWGRID2_JMPTBL_DISPTEXT_ComputeMarkerWidths"
ENTRY_SASC="NEWGRID2_JMPTBL_DISPTEXT_Compute"
TARGET="DISPTEXT_ComputeMarkerWidths"
mkdir -p "$OUT_DIR"
