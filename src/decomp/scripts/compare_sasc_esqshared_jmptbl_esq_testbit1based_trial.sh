...
BASE="esqshared_jmptbl_esq_testbit1based"
ENTRY_ORIG="ESQSHARED_JMPTBL_ESQ_TestBit1Based"
ENTRY_SASC="ESQSHARED_JMPTBL_ESQ_TestBit1Bas"
TARGET="ESQ_TestBit1Based"
mkdir -p "$OUT_DIR"
