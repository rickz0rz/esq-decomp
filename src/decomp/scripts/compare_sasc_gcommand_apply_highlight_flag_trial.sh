...
SASC_SRC="gcommand_apply_highlight_flag.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_apply_highlight_flag"
ENTRY="GCOMMAND_ApplyHighlightFlag"
ENTRY_SASC_REGEX="^GCOMMAND_ApplyHighlightFlag[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_apply_highlight_flag.awk \
