...

{
    ...
    if (n ~ /ESQFUNCJMPTBLDISKIOPROBEDRIVESANDASSIGNPATHS/ || n ~ /ESQFUNCJMPTBLDISKIOPROBEDRIVE/ || n ~ /DISKIOPROBEDRIVESANDASSIGNPATHS/ || n ~ /DISKIOPROBEDRIVESANDASSIGN/) has_probe_call=1
    ...
    if (n ~ /ESQFUNCJMPTBLTLIBA3DRAWCENTEREDWRAPPEDTEXTLINES/ || n ~ /ESQFUNCJMPTBLTLIBA3DRAWCENTER/ || n ~ /TLIBA3DRAWCENTEREDWRAPPEDTEXTLINES/ || n ~ /TLIBA3DRAWCENTEREDWRAPPEDTEXTLI/) has_draw_call=1
