...

{
    ...
    if (n ~ /NEWGRID2JMPTBLESQGETHALFHOURSLOTINDEX/ || n ~ /NEWGRID2JMPTBLESQGETHALFHOURS/ || n ~ /ESQGETHALFHOURSLOTINDEX/ || n ~ /ESQGETHALFHOURS/) has_halfhour=1
    if (n ~ /NEWGRID2JMPTBLTLIBAFINDFIRSTWILDCARDMATCHINDEX/ || n ~ /NEWGRID2JMPTBLTLIBAFINDFIRSTW/ || n ~ /TLIBAFINDFIRSTWILDCARDMATCHINDEX/ || n ~ /TLIBAFINDFIRSTWILDCARDMATCHINDE/) has_wildcard=1
