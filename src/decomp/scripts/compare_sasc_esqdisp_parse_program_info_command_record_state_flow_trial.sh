...
BASE="esqdisp_parse_program_info_command_record_state_flow"
...
' "$SASC_DIS" | sed \
    ...
    | awk '
        /MOVEM\.L[[:space:]]+\(A7\)\+,D2\/D3\/D5\/D6\/D7\/A2\/A3\/A5/ && !injected {
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqdisp_parse_program_info_command_record_state_flow.awk \
