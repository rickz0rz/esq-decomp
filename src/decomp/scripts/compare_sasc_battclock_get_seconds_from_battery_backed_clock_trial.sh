...
BASE="battclock_get_seconds_from_battery_backed_clock"
ENTRY="BATTCLOCK_GetSecondsFromBatteryBackedClock"
ENTRY_SASC_REGEX="^BATTCLOCK_GetSecondsFromBatteryB[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_battclock_get_seconds_from_battery_backed_clock.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_battclock_get_seconds_from_battery_backed_clock.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
