...
SASC_SRC="group_ay_jmptbl_stubs.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/y/xjump.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="group_ay_jmptbl_diskio_consume_cstring_from_work_buffer"
ENTRY_ORIG="GROUP_AY_JMPTBL_DISKIO_ConsumeCStringFromWorkBuffer"
ENTRY_SASC="GROUP_AY_JMPTBL_DISKIO_ConsumeCS"
TARGET="DISKIO_ConsumeCStringFromWorkBuf"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AY_JMPTBL_DISKIO_ParseLong:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
