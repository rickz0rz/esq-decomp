...
SASC_SRC="esqshared4_set_banner_copper_color_and_threshold.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_set_banner_copper_color_and_threshold"
ENTRY="ESQSHARED4_SetBannerCopperColorAndThreshold"
ENTRY_SASC_REGEX="^ESQSHARED4_SetBannerCopperColor[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_set_banner_copper_color_and_threshold.awk \
