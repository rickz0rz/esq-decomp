...
BASE="wdisp_jmptbl_esqiff_queueiffbrushload"
ENTRY_ORIG="WDISP_JMPTBL_ESQIFF_QueueIffBrushLoad"
ENTRY_SASC="WDISP_JMPTBL_ESQIFF_QueueIffBrus"
TARGET="ESQIFF_QueueIffBrushLoad"
mkdir -p "$OUT_DIR"
