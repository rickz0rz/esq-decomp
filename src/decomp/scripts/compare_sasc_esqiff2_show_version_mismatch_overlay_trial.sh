...
SASC_SRC="esqiff2_show_version_mismatch_overlay.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_show_version_mismatch_overlay"
ENTRY="ESQIFF2_ShowVersionMismatchOverlay"
ENTRY_SASC_REGEX="^ESQIFF2_ShowVersionMismatchO[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_show_version_mismatch_overlay.awk \
