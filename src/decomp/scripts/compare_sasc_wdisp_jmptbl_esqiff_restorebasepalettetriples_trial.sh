...
BASE="wdisp_jmptbl_esqiff_restorebasepalettetriples"
ENTRY_ORIG="WDISP_JMPTBL_ESQIFF_RestoreBasePaletteTriples"
ENTRY_SASC="WDISP_JMPTBL_ESQIFF_RestoreBaseP"
TARGET="ESQIFF_RestoreBasePaletteTriples"
mkdir -p "$OUT_DIR"
