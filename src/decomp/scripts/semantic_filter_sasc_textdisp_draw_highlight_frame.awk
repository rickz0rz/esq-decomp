...

{
    ...
    if (index(u, "WDISP_JMPTBL_ESQ_SETCOPPEREFFECT_ONENABLEHIGHLIGHT") > 0 || index(u, "WDISP_JMPTBL_ESQ_SETCOPPEREFF") > 0 || index(u, "ESQ_SETCOPPEREFFECT_ONENABLEHIGHLIGHT") > 0 || index(u, "ESQ_SETCOPPEREFF") > 0) has_copper_on = 1
    if (index(u, "MATH_MULU32") > 0) has_mulu = 1
    if (index(u, "WDISP_JMPTBL_ESQIFF_RUNCOPPERDROPTRANSITION") > 0 || index(u, "WDISP_JMPTBL_ESQIFF_RUNCOPPERDRO") > 0 || index(u, "ESQIFF_RUNCOPPERDROPTRANSITION") > 0 || index(u, "ESQIFF_RUNCOPPERDRO") > 0) has_drop = 1
    if (index(u, "WDISP_JMPTBL_ESQIFF_RESTOREBASEPALETTETRIPLES") > 0 || index(u, "WDISP_JMPTBL_ESQIFF_RESTOREBASEPA") > 0 || index(u, "WDISP_JMPTBL_ESQIFF_RESTOREBASEP") > 0 || index(u, "ESQIFF_RESTOREBASEPALETTETRIPLES") > 0 || index(u, "ESQIFF_RESTOREBASEPA") > 0 || index(u, "ESQIFF_RESTOREBASEP") > 0) has_restore = 1
    ...
    if (index(u, "TEXTDISP_JMPTBL_ESQIFF_RUNCOPPERRISETRANSITION") > 0 || index(u, "TEXTDISP_JMPTBL_ESQIFF_RUNCOPPERRI") > 0 || index(u, "TEXTDISP_JMPTBL_ESQIFF_RUNCOPPER") > 0 || index(u, "ESQIFF_RUNCOPPERRISETRANSITION") > 0 || index(u, "ESQIFF_RUNCOPPERRI") > 0 || index(u, "ESQIFF_RUNCOPPER") > 0) has_rise = 1
