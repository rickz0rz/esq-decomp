...
SASC_SRC="gcommand_map_keycode_to_preset.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_map_keycode_to_preset"
ENTRY="GCOMMAND_MapKeycodeToPreset"
ENTRY_SASC_REGEX="^GCOMMAND_MapKeycodeToPreset[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_map_keycode_to_preset.awk \
