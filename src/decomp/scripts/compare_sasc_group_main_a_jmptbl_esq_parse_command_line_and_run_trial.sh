...
BASE="group_main_a_jmptbl_esq_parse_command_line_and_run"
ENTRY_ORIG="GROUP_MAIN_A_JMPTBL_ESQ_ParseCommandLineAndRun"
ENTRY_SASC="GROUP_MAIN_A_JMPTBL_ESQ_ParseCom"
TARGET="ESQ_ParseCommandLineAndRun"
