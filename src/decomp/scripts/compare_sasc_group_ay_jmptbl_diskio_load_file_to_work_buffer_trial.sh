...
BASE="group_ay_jmptbl_diskio_load_file_to_work_buffer"
ENTRY_ORIG="GROUP_AY_JMPTBL_DISKIO_LoadFileToWorkBuffer"
ENTRY_SASC="GROUP_AY_JMPTBL_DISKIO_LoadFileT"
TARGET="DISKIO_LoadFileToWorkBuffer"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AY_JMPTBL_SCRIPT_ReadCiaBB:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
