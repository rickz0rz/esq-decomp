...
SASC_SRC="gcommand_build_banner_row.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_build_banner_row"
ENTRY="GCOMMAND_BuildBannerRow"
ENTRY_SASC_REGEX="^GCOMMAND_BuildBannerRow[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_build_banner_row.awk \
