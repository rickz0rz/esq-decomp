...
BASE="group_ac_jmptbl_esqfunc_draw_memory_status_screen"
ENTRY_ORIG="GROUP_AC_JMPTBL_ESQFUNC_DrawMemoryStatusScreen"
ENTRY_SASC="GROUP_AC_JMPTBL_ESQFUNC_DrawMemo"
TARGET="ESQFUNC_DrawMemoryStatusScreen"
mkdir -p "$OUT_DIR"
