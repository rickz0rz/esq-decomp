...
BASE="esqiff2_parse_line_head_tail_record_return"
ENTRY="ESQIFF2_ParseLineHeadTailRecord_Return"
ENTRY_SASC_REGEX="^ESQIFF2_ParseLineHeadTailRecord_[A-Za-z0-9_]*:$"
ENTRY_SEM="ESQIFF2_PARSELINEHEADTAILRECORD_RETURN:"
ENTRY_ALT_SEM="ESQIFF2_PARSELINEHEADTAILRECORD_"
