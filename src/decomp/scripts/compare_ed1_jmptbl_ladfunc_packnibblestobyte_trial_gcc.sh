...
SRC_C="src/decomp/c/replacements/ed1_jmptbl_ladfunc_packnibblestobyte_gcc.c"
ORIG_ASM="src/modules/groups/a/k/ed1.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/ed1_jmptbl_ladfunc_packnibblestobyte.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/ed1_jmptbl_ladfunc_packnibblestobyte.original_slice.s"
GEN_SLICE="${OUT_DIR}/ed1_jmptbl_ladfunc_packnibblestobyte.generated_slice.s"
ORIG_NORM="${OUT_DIR}/ed1_jmptbl_ladfunc_packnibblestobyte.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/ed1_jmptbl_ladfunc_packnibblestobyte.generated_slice.norm.s"
...
awk -v start_label="ED1_JMPTBL_LADFUNC_PackNibblesToByte" -v next_label="" '
...
awk '$0 ~ /^_?ED1_JMPTBL_LADFUNC_PackNibblesToByte:?$/ {in_func=1} in_func { print }' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f "src/decomp/scripts/semantic_filter_ed1_jmptbl_ladfunc_packnibblestobyte.awk" "$ORIG_NORM" > "$ORIG_SEM"
awk -f "src/decomp/scripts/semantic_filter_ed1_jmptbl_ladfunc_packnibblestobyte.awk" "$GEN_NORM" > "$GEN_SEM"
