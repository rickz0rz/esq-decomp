...
cd "$ROOT_DIR"
SASC_SRC="cleanup_test_entry_flag_y_and_bit1.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/e/cleanup4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="cleanup_test_entry_flag_y_and_bit1"
ENTRY="CLEANUP_TestEntryFlagYAndBit1"
ENTRY_SASC_REGEX="^CLEANUP_TestEntryFlagYAndBit1[A-Za-z0-9_]*:$"
mkdir -p "$OUT_DIR"
...
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_test_entry_flag_y_and_bit1.awk "${OUT_DIR}/${BASE}.original.norm.s" >"${OUT_DIR}/${BASE}.original.semantic.txt"
awk -f src/decomp/scripts/semantic_filter_sasc_cleanup_test_entry_flag_y_and_bit1.awk "${OUT_DIR}/${BASE}.sasc.norm.s" >"${OUT_DIR}/${BASE}.sasc.semantic.txt"
