...
SRC_C="src/decomp/c/replacements/script_write_ctrl_shadow_to_serdat_gcc.c"
ORIG_ASM="src/modules/groups/b/a/script2.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/script_write_ctrl_shadow_to_serdat.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/script_write_ctrl_shadow_to_serdat.original_slice.s"
GEN_SLICE="${OUT_DIR}/script_write_ctrl_shadow_to_serdat.generated_slice.s"
ORIG_NORM="${OUT_DIR}/script_write_ctrl_shadow_to_serdat.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/script_write_ctrl_shadow_to_serdat.generated_slice.norm.s"
...
awk '
$0 ~ /^SCRIPT_WriteCtrlShadowToSerdat:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;!======/) {
        exit
    }
...
awk '
$0 ~ /^_?SCRIPT_WriteCtrlShadowToSerdat:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_script_write_ctrl_shadow_to_serdat.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_script_write_ctrl_shadow_to_serdat.awk "$GEN_NORM" > "$GEN_SEM"
