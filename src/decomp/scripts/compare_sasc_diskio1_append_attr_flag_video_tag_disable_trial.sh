...
BASE="diskio1_append_attr_flag_video_tag_disable"
ENTRY="DISKIO1_AppendAttrFlagVideoTagDisable"
ENTRY_SASC_REGEX="^DISKIO1_AppendAttrFlagVideoTagDi[A-Za-z0-9_]*:$"
ENTRY_SEM="DISKIO1_APPENDATTRFLAGVIDEOTAGDISABLE:"
ENTRY_ALT_SEM="DISKIO1_APPENDATTRFLAGVIDEOTAGDI"
TARGET_SEM="DISKIO1_APPENDATTRFLAGPPVSRC"
EXPECTED_BIT="3"
FORMAT_LABEL_PREFIX="DISKIO_STR_VIDEO_TAG_DISABLE_Com"
