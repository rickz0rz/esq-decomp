...
void KYBD_InitializeInputDevices(void)
{
    ...
    *(UWORD *)((UBYTE *)Global_REF_IOSTDREQ_STRUCT_INPUT_DEVICE + (LONG)&Struct_IOStdReq__io_Command) = IOREQ_CMD_ADDHANDLER;
    *(LONG *)((UBYTE *)Global_REF_IOSTDREQ_STRUCT_INPUT_DEVICE + (LONG)&Struct_IOStdReq__io_Data) = (LONG)Global_REF_DATA_INPUT_BUFFER;
