...
SASC_SRC="esqshared4_copy_planes_from_context_to_snapshot.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_copy_planes_from_context_to_snapshot"
ENTRY="ESQSHARED4_CopyPlanesFromContextToSnapshot"
ENTRY_SASC_REGEX="^ESQSHARED4_CopyPlanesFromContext[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_copy_planes_from_context_to_snapshot.awk \
