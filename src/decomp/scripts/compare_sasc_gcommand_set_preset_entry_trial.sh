...
SASC_SRC="gcommand_set_preset_entry.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/u/gcommand3.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="gcommand_set_preset_entry"
ENTRY="GCOMMAND_SetPresetEntry"
...
awk -f src/decomp/scripts/semantic_filter_sasc_gcommand_set_preset_entry.awk \
