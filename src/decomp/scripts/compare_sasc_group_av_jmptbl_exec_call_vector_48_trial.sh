...
BASE="group_av_jmptbl_exec_call_vector_48"
ENTRY_ORIG="GROUP_AV_JMPTBL_EXEC_CallVector_48"
ENTRY_SASC="GROUP_AV_JMPTBL_EXEC_CallVector_"
TARGET="EXEC_CallVector_48"
mkdir -p "$OUT_DIR"
