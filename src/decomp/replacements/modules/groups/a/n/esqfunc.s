...
; PURPOSE:
;   Object-level hybrid replacement for the ESQFUNC module now that the
;   restored SAS/C lane covers the module's full non-JMPTBL status, clock,
;   and UI-service helper export set. This replacement now carries the module
