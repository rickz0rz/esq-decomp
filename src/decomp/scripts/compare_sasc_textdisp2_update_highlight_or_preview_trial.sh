...
SASC_SRC="textdisp2_update_highlight_or_preview.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/textdisp2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="textdisp2_update_highlight_or_preview"
ENTRY="TEXTDISP_UpdateHighlightOrPreview"
ENTRY_SASC_REGEX="^TEXTDISP_UpdateHighlightOrPre[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_textdisp2_update_highlight_or_preview.awk \
