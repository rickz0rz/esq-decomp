...
BASE="tliba1_jmptbl_ladfunc_extracthighnibble"
ENTRY_ORIG="TLIBA1_JMPTBL_LADFUNC_ExtractHighNibble"
ENTRY_SASC="TLIBA1_JMPTBL_LADFUNC_ExtractHig"
TARGET="LADFUNC_GetPackedPenHighNibble"
mkdir -p "$OUT_DIR"
