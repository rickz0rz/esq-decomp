...
BASE="group_al_jmptbl_ladfunc_build_entry_buffers_or_default"
ENTRY_ORIG="GROUP_AL_JMPTBL_LADFUNC_BuildEntryBuffersOrDefault"
ENTRY_SASC="GROUP_AL_JMPTBL_LADFUNC_BuildEnt"
TARGET="LADFUNC_BuildEntryBuffersOrDefau"
...
awk -v e="^${ENTRY_SASC}:$" '$0 ~ e {inf=1} inf { if ($0 ~ /^GROUP_AL_JMPTBL_LADFUNC_ExtractH:$/) exit; print }' "$SASC_DIS" >"${OUT_DIR}/${BASE}.sasc.dis.s"
