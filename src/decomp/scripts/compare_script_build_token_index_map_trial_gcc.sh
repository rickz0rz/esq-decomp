...
SRC_C="src/decomp/c/replacements/script_build_token_index_map_gcc.c"
ORIG_ASM="src/modules/groups/b/a/script.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/script_build_token_index_map.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/script_build_token_index_map.original_slice.s"
GEN_SLICE="${OUT_DIR}/script_build_token_index_map.generated_slice.s"
ORIG_NORM="${OUT_DIR}/script_build_token_index_map.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/script_build_token_index_map.generated_slice.norm.s"
...
awk '
$0 ~ /^SCRIPT_BuildTokenIndexMap:?$/ {in_func=1}
in_func {
    if ($0 ~ /^;!======/) {
        exit
    }
...
awk '
$0 ~ /^_?SCRIPT_BuildTokenIndexMap:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_script_build_token_index_map.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_script_build_token_index_map.awk "$GEN_NORM" > "$GEN_SEM"
