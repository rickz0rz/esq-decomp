...
cd "$ROOT_DIR"
SASC_SRC="newgrid_jmptbl_cleanup_draw_clock_format_list.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/b/a/newgrid.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="newgrid_jmptbl_cleanup_drawclockformatlist"
ENTRY_ORIG="NEWGRID_JMPTBL_CLEANUP_DrawClockFormatList"
ENTRY_SASC="NEWGRID_JMPTBL_CLEANUP_DrawClock"
TARGET="CLEANUP_DrawClockFormatList"
mkdir -p "$OUT_DIR"
