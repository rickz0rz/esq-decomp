...
SASC_SRC="esqiff2_read_serial_sized_text_record.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/o/esqiff2.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqiff2_read_serial_sized_text_record"
ENTRY="ESQIFF2_ReadSerialSizedTextRecord"
ENTRY_SASC_REGEX="^ESQIFF2_ReadSerialSizedTextR[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqiff2_read_serial_sized_text_record.awk \
