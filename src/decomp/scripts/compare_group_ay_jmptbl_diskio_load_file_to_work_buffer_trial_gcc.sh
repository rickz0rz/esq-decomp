...
SRC_C="src/decomp/c/replacements/group_ay_jmptbl_diskio_load_file_to_work_buffer_gcc.c"
ORIG_ASM="src/modules/groups/a/y/xjump.s"
OUT_DIR="build/decomp/c_trial_gcc"
GEN_ASM="${OUT_DIR}/group_ay_jmptbl_diskio_load_file_to_work_buffer.generated.gcc.s"
ORIG_SLICE="${OUT_DIR}/group_ay_jmptbl_diskio_load_file_to_work_buffer.original_slice.s"
GEN_SLICE="${OUT_DIR}/group_ay_jmptbl_diskio_load_file_to_work_buffer.generated_slice.s"
ORIG_NORM="${OUT_DIR}/group_ay_jmptbl_diskio_load_file_to_work_buffer.original_slice.norm.s"
GEN_NORM="${OUT_DIR}/group_ay_jmptbl_diskio_load_file_to_work_buffer.generated_slice.norm.s"
...
awk -v start_label="GROUP_AY_JMPTBL_DISKIO_LoadFileToWorkBuffer" -v next_label="GROUP_AY_JMPTBL_SCRIPT_ReadCiaBBit5Mask" '
...
awk '
$0 ~ /^_?GROUP_AY_JMPTBL_DISKIO_LoadFileToWorkBuffer:?$/ {in_func=1}
in_func { print }
' "$GEN_ASM" > "$GEN_SLICE"
...
awk -f src/decomp/scripts/semantic_filter_group_ay_jmptbl_diskio_load_file_to_work_buffer.awk "$ORIG_NORM" > "$ORIG_SEM"
awk -f src/decomp/scripts/semantic_filter_group_ay_jmptbl_diskio_load_file_to_work_buffer.awk "$GEN_NORM" > "$GEN_SEM"
