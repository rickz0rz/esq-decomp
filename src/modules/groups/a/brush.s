...
; Rewrite the brush filename strings in-place using LAB_01A7 (path normaliser).
...
.LAB_0169:
    ...
    MOVE.L  D0,52(A7)
    MOVE.L  D0,48(A7)
    JSR     JMP_TBL_UNKNOWN2B_AllocRaster_1(PC)
...
JMP_TBL_UNKNOWN2B_AllocRaster_1:
