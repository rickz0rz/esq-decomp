...
SASC_SRC="esqshared4_initialize_banner_copper_system.c"
SASC_DIS="src/decomp/sas_c/${SASC_SRC}.dis"
ORIG_ASM="src/modules/groups/a/q/esqshared4.s"
OUT_DIR="build/decomp/sasc_trial"
BASE="esqshared4_initialize_banner_copper_system"
ENTRY="ESQSHARED4_InitializeBannerCopperSystem"
ENTRY_SASC_REGEX="^ESQSHARED4_InitializeBannerCoppe[A-Za-z0-9_]*:$"
...
awk -f src/decomp/scripts/semantic_filter_sasc_esqshared4_initialize_banner_copper_system.awk \
